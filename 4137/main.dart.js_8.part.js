...
bUV(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x){return new B.Ns(f,x,l,h,g,v,k,q,s,t,d,u,j,i,o,m,n,r,w,e,p)},
Ns:function Ns(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x){var _=this
_.c=d
_.d=e
_.e=f
_.f=g
...
this.c=f},
bbd:function bbd(){},
dWa(d){var x,w,v,u,t,s,r,q,p="text/html"
...
v=w.querySelectorAll(".quote-toggle-container"+C.d.b5(" > div",s)+" > blockquote")
v.toString
t=new A.a53(v,u);++s}r=t.$ti.c.a(C.uS.gX(t.a))
...
v=w.documentElement
v=v==null?null:J.dOo(v)
return v==null?d:v},
dxz(){if(!C.d.q(window.navigator.userAgent.toLowerCase(),"iphone"))var x=C.d.q(window.navigator.userAgent.toLowerCase(),"android")&&C.d.q(window.navigator.userAgent.toLowerCase(),"mobile")
else x=!0
return x},
dxA(){if(!C.d.q(window.navigator.userAgent.toLowerCase(),"ipad"))var x=C.d.q(window.navigator.userAgent.toLowerCase(),"android")&&!C.d.q(window.navigator.userAgent.toLowerCase(),"mobile")
else x=!0
return x}},D
J=c[1]
A=c[0]
...
x=window
x.toString
x=A.ie(x,"message",w.gbfe(),!1,y.B)
w.z!==$&&A.cN()
w.z=x},
bff(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{x=C.as.ff(0,new A.pK([],[]).qs(d.data,!0))
w=J.ah(x,"view")
t=n.d
t===$&&A.d()
if(!J.u(w,t))return
...
p=C.c.gbq(q).at
p.toString
t.iQ(C.j.fE(p+r,C.c.gbq(q).geU(),C.c.gbq(q).geg()),C.fq,C.hH)
return}else{t=v
...
if(!n.Q)return
t=v
if((t==null?m:C.d.q(t,"toDart: htmlHeight"))===!0)n.bcY(J.ah(x,"height"))
else{t=v
t=(t==null?m:C.d.q(t,"toDart: htmlWidth"))===!0
if(t)n.a.toString
if(t)n.bcZ(J.ah(x,"width"))
else{t=v
if((t==null?m:C.d.q(t,"toDart: OpenLink"))===!0){t=J.ah(x,"url")
if(t!=null&&n.c!=null&&typeof t=="string"&&C.d.bb(t,"mailto:")){q=n.a.y
...
if(q!=null)q.$1(A.jd(t))}}}}}}catch(o){u=A.O(o)
A.x(A.J(n).l(0)+"::_handleMessageEvent:Exception = "+A.e(u),C.w)}},
gaun(){var x=this.a.ax
if(x!=null)x=x.f.length!==0===!0
else x=!1
return x},
beM(d,e){var x,w,v,u,t,s,r,q
try{t=J.ah(d,"deltaY")
x=t==null?0:t
s=e.f
r=C.c.gbq(s).at
...
w=r+x
r=B.dxz()||B.dxA()
if(r){v=J.dpQ(w,C.c.gbq(s).geU(),C.c.gbq(s).geg())
e.iQ(v,C.ae,C.oe)}else if(w<C.c.gbq(s).geU())e.im(C.c.gbq(s).geU())
else if(w>C.c.gbq(s).geg())e.im(C.c.gbq(s).geg())
else e.im(w)}catch(q){u=A.O(q)
A.x(A.J(this).l(0)+"::_handleIframeOnScrollChangedListener:Exception = "+A.e(u),C.w)}},
bcY(d){var x,w,v,u,t,s,r=this
if(d==null){x=r.e
x===$&&A.d()
w=x}else w=d
x=r.c
if(x!=null){v=J.axZ(w,r.a.db)
A.x(A.J(r).l(0)+"::_handleContentHeightEvent: ScrollHeightWithBuffer = "+A.e(v),C.h)
x=r.a.dy
u=J.ax9(v)
t=r.y
if(x){t===$&&A.d()
s=u.q1(v,t)}else{t===$&&A.d()
s=u.nu(v,t)}if(s)r.U(new B.cX7(r,v))}if(r.c!=null&&r.x)r.U(new B.cX8(r))},
bcZ(d){var x,w,v=this
if(d==null){x=v.f
x===$&&A.d()
w=x}else w=d
if(v.c!=null&&J.dpK(w,v.a.cy)&&v.a.as)v.U(new B.cX9(v,w))},
bfU(d){var x,w,v,u
try{v=J.ao(d)
x=new B.Zo(A.aN(v.j(d,"key")),A.aN(v.j(d,"code")),J.u(v.j(d,"shift"),!0))
A.x(A.J(this).l(0)+"::_handleOnIFrameKeyboardEvent:\ud83d\udce5 Shortcut pressed: "+A.e(x),C.h)
v=this.a.Q
if(v!=null)v.$1(x)}catch(u){w=A.O(u)
A.x(A.J(this).l(0)+"::_handleOnIFrameKeyboardEvent: Exception = "+A.e(w),C.w)}},
ba(d){var x,w,v=this
v.bp(d)
x=d.f
A.x(A.J(v).l(0)+"::didUpdateWidget():Old-Direction: "+x.l(0)+" | Current-Direction: "+v.a.f.l(0),C.h)
w=v.a
if(w.c!==d.c||w.f!==x)v.atG()
x=v.a
w=x.e
if(w!==d.e)v.e=w
x=x.d
if(x!==d.d)v.f=x},
bbr(d){var x,w=$.boC(),v=J.rE(d,y.D)
for(x=0;x<d;++x)v[x]=w.uC(255)
return C.qm.ghF().bB(v)},
atG(){var x,w,v,u=this,t="\n          \n          ",s=u.d=u.bbr(10),r=u.a,q=r.c,p=!r.dy,o=p?'          const resizeObserver = new ResizeObserver((entries) => {\n            var height = document.body.scrollHeight;\n            window.parent.postMessage(JSON.stringify({"view": "'+s+'", "type": "toDart: htmlHeight", "height": height}), "*");\n          });\n        ':"",n=r.y!=null,m=n?'                function handleOnClickEmailLink(e) {\n                   var href = this.href;\n                   window.parent.postMessage(JSON.stringify({"view": "'+s+'", "type": "toDart: OpenLink", "url": "" + href}), "*");\n                   e.preventDefault();\n                }\n              ':"",l=r.z!=null,k=l?'                function onClickHyperLink(e) {\n                   var href = this.href;\n                   window.parent.postMessage(JSON.stringify({"view": "'+s+'", "type": "toDart: onClickHyperLink", "url": "" + href}), "*");\n                   e.preventDefault();\n                }\n              ':""
...
t(d){var x=this
x.wx(d)
if(x.a.dy)return x.aoy()
else return A.fb(new B.cXa(x))},
aoy(){var x,w=this,v=null,u=A.J(w).l(0),t=w.e
t===$&&A.d()
A.x(u+"::_buildHtmlElementView: ActualHeight: "+A.e(t),C.h)
t=A.c([],y.u)
u=w.w
if((u==null?v:C.d.aK(u).length!==0)===!0)t.push(A.XD(new B.cX6(w),w.r,y.e))
if(w.x)t.push(D.a3K)
...
x.ao(0)
this.aG()},
gt8(){return this.a.CW}}
B.awg.prototype={
aA(){this.aM()
if(this.a.CW)this.vh()},
iI(){var x=this.iJ$
if(x!=null){x.aV()
x.ia()
this.iJ$=null}this.pe()}}
B.Zo.prototype={
aID(d,e,f){return this.a.toLowerCase()===e.toLowerCase()&&this.c===f},
Ao(d,e){return this.aID(0,e,!1)},
gB(){return[this.a,this.b,this.c]}}
B.bbd.prototype={}
var z=a.updateTypes(["~(qs)"])
B.cX7.prototype={
$0(){var x=this.a
x.e=this.b
x.x=!1},
...
w=A.du_(!0,new A.b6(A.e(x.w)+"-"+A.e(x.a.a),y.q),new B.cX5(x),"iframe")
v=x.a.dx
u=x.e
x=x.f
if(v!=null){u===$&&A.d()
...
x=d.style
x.height="100%"},
$S:468};(function aliases(){var x=B.awg.prototype
x.b_2=x.aA})();(function installTearOffs(){var x=a._instance_1u
x(B.aru.prototype,"gbfe","bff",0)})();(function inheritance(){var x=a.mixinHard,w=a.mixin,v=a.inherit,u=a.inheritMany
v(B.Ns,A.ag)
v(B.awg,A.af)
v(B.aru,B.awg)
u(A.vr,[B.cX7,B.cX8,B.cX9])
u(A.vs,[B.cXa,B.cX6])
v(B.cX5,A.oU)
v(B.bbd,A.a3)
v(B.Zo,B.bbd)
x(B.awg,A.r8)
w(B.bbd,A.q)})()
A.Eg(b.typeUniverse,JSON.parse('{"Ns":{"ag":[],"j":[],"k":[]},"aru":{"af":["Ns"]},"Zo":{"q":[]}}'))
var y={C:A.aq("yz"),x:A.aq("P<f>"),u:A.aq("P<j>"),B:A.aq("qs"),q:A.aq("b6<f>"),f:A.aq("a53<i7>"),e:A.aq("C"),D:A.aq("D")};(function constants(){D.aSI=new A.b1(30,30,C.rq,null)
D.aKF=new A.Z(C.cv,D.aSI,null)
D.a3K=new A.dH(C.db,null,null,D.aKF,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_8",e:"endPart",h:b})})($__dart_deferred_initializers__,"X2Hw9m2EOT9KF3uo76ZiRWgJ+zA=");