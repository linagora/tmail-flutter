...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C = {
    ...
    ThemeUtils_textStyleBodyBody2(backgroundColor, color) {
      var _null = null;
      return A.TextStyle$(_null, backgroundColor, color, _null, _null, _null, _null, _null, "Inter", _null, _null, 15, _null, _null, B.FontWeight_3_400, _null, 1.3333333333333333, true, _null, 0, _null, _null, _null, _null, _null, _null);
    },
    ThemeUtils_textStyleInter600() {
      var _null = null;
      return A.TextStyle$(_null, _null, A.Color$fromARGB(B.JSNumber_methods.round$0(229.5), 66, 66, 68), _null, _null, _null, _null, _null, "Inter", _null, _null, 24, _null, _null, B.FontWeight_5_600, _null, 1.1670833333333335, true, _null, 0, _null, _null, _null, _null, _null, _null);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.StatelessWidget, [C._ElevatedButtonWithIconChild, C.CircleLoadingWidget0, C.LinkBrowserWidget, C.MaterialTextButton, C.PopupMenuItemActionWidget, C._AppGridDashboardItem_StatelessWidget_LauncherApplicationMixin, C.AppDashboardOverlay, C.NavigationBarWidget, C.ProfileLabelWidget, C.ProfileSettingMenuOverlay, C.VacationNotificationMessageWidget, C.Link, C.DefaultLinkDelegate]);
...
})($__dart_deferred_initializers__, "/E3unY9TOxZViSE9uA8fdJYEsy8=");
;