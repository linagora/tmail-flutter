...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var C = {
    IdentityCreatorView$() {
      ...
      t3 = t3.find$1$1$tag(0, _null, type$.IdentityCreatorController);
      t3.$arguments = $.$get$GetNavigation__getxController().routing.args;
      return new A.IdentityCreatorView(t1, t2, t3, _null);
    }
  },
  A, B;
  C = hunkHelpers.updateHolder(holdersList[13], C);
  A = holdersList[0];
  B = holdersList[2];
  var typesOffset = hunkHelpers.updateTypes([]);
  var type$ = {
    IdentityCreatorController: A.findType("IdentityCreatorController"),
    ImagePaths: A.findType("ImagePaths0"),
    ResponsiveUtils: A.findType("ResponsiveUtils0")
  };
};

$__dart_deferred_initializers__["JywMpqKXDMV8Xb9hztIH6M9avtw="] = $__dart_deferred_initializers__.current
