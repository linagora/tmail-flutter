...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, B, C,
  A = {
    HtmlContentViewerOnWeb$(allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, key, mailtoDelegate, onClickHyperLinkAction, useDefaultFont, widthContent) {
      return new A.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, mailtoDelegate, onClickHyperLinkAction, allowResizeToDocumentSize, key);
    },
  ...
  A._HtmlContentViewerOnWebState_build__closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (snapshot.data != null) {
        ...
        t1 === $ && B.throwUnnamedLateFieldNI();
        return new B.SizedBox(t3, t2, new B.HtmlElementView(t1, _null, _null, _null), _null);
      } else
  ...
  (function inheritance() {
    ...
    _inheritMany(B.Closure, [A._HtmlContentViewerOnWebState_initState_closure, A._HtmlContentViewerOnWebState__setUpWeb_closure]);
  ...
  B._Universe_addRules(init.typeUniverse, JSON.parse('{"HtmlContentViewerOnWeb":{"StatefulWidget":[],"Widget":[],"DiagnosticableTree":[]},"_HtmlContentViewerOnWebState":{"State0":["HtmlContentViewerOnWeb"]}}'));
  var type$ = {
    JSArray_Widget: B.findType("JSArray<Widget>"),
    MessageEvent: B.findType("MessageEvent"),
...
})($__dart_deferred_initializers__, "pKUnAsTQAU5fdBcn7R91jqIE/ug=");
;