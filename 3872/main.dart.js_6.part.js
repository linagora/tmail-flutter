...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ProfileSettingMenuOverlay.prototype = {
    build$1(context) {
      ...
      t4 = A._setArrayType([D.SizedBox_null_32_null_null, new C.ProfileLabelWidget(_this.ownEmailAddress, "assets/images/ic_copy.svg", _this.onCopyButtonAction, _null), B.SizedBox_null_4_null_null, A.Divider$(A.Color$fromARGB(31, 29, 25, 43), _null, 1, _null)], t3);
  ...
  (function constants() {
    ...
    D.SizedBox_null_32_null_null = new A.SizedBox(null, 32, null, null);
...
})($__dart_deferred_initializers__, "RJ1cmdyynUDAWUNEyKwKMgdJwVo=");
;