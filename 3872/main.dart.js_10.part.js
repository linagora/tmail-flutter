...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      ...
      t2 = t2.name;
      if ((t2 == null ? "" : t2).length !== 0)
        t8.push(new A.Padding(B.EdgeInsets_0_2_0_0, A.Text$(t4 ? "" : t3, _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, H.TextStyle_8aB4, _null, _null, _null, _null, _null), _null));
  ...
  C.UserInformationWidget.prototype = {
    build$1(context) {
      ...
      t2 = A._setArrayType([A.SelectableText$(t2, 1, D.TextStyle_69t17, _null)], t3);
  ...
  C.LanguageAndRegionView.prototype = {
    build$1(context) {
      ...
      return A.Portal$(new C.SettingDetailViewBuilder(t3, A.Column$(t5, B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1), _null, B.Color_4294967295, _null, _null));
    }
  };
  ...
  C.ManageAccountMenuView.prototype = {
    build$1(context) {
      ...
      if (!(t7.size._dx >= 1200))
        t6.push(new A.Padding(D.EdgeInsetsDirectional_16_16_0_16, A.Row$(A._setArrayType([I.ApplicationLogoWidthTextWidget$(_null, _null), H.ApplicationVersionWidget_Rm0], t5), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), _null));
      A.Expando__checkType(_this);
      t2._as(t1.get(_this)).toString;
      t7 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, t3).data;
      if (!(t7.size._dx >= 1200))
  ...
  C.IdentitiesHeaderWidget.prototype = {
    build$1(context) {
      ...
      t1 = type$.AppLocalizations;
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
      t2 = A.Text$(A.Intl__message("Identities", _null, "identities", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_69t18, _null, _null, _null, _null, _null);
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
  ...
  C.SettingsView__buildAppbar_closure.prototype = {
    call$0() {
      ...
      if (t3._as(t2.get(t1)).manageAccountDashboardController.settingsPageLevel.get$value(0) === B.SettingsPageLevel_0)
        ...
        t5 = A.Material$(B.Duration_200000, true, _null, A.InkWell$(false, _null, true, A.Tooltip$(A.Container$(_null, A.Row$(A._setArrayType([t8, A.Container$(_null, A.Text$(A.Intl__message("Settings", _null, "settings", _null, _null), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_OkG0, _null, _null, _null, _null, _null), B.Clip_0, _null, D.BoxConstraints_oA84, _null, _null, _null, _null, B.EdgeInsetsDirectional_4_0_0_0, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_0, _null), B.Clip_0, B.Color_0, _null, _null, _null, 40, _null, _null, B.EdgeInsets_4_0_4_0, _null, _null, _null), _null, t7), D.RoundedRectangleBorder_NYu13, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t5, _null, _null, _null, _null, _null, _null, _null), B.Clip_0, B.Color_0, 0, _null, _null, _null, _null, _null, B.MaterialType_0);
        A.Expando__checkType(t1);
        ...
        t6.toString;
        return A.Row$(A._setArrayType([t5, A.Expanded$(A.Text$(t1.getName$1(t6), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_69t0, B.TextAlign_2, _null, _null, _null, _null), 1), A.Container$(_null, _null, B.Clip_0, _null, D.BoxConstraints_oA84, _null, _null, _null, _null, _null, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
      }
    },
    $signature: 4
  };
  ...
  (function constants() {
    ...
    D.BoxConstraints_oA84 = new A.BoxConstraints(0, 80, 0, 1 / 0);
    ...
    D.TextStyle_69t18 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 17, B.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t17 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 17, B.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "sFcrfLVJPAt0meXnLAR7LsyWN8o=");
;