...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B.LoginView.prototype = {
    ...
    _buildMobileForm$1(context) {
      ...
      t1 = A.Column$(A._setArrayType([new A.Padding(D.EdgeInsets_0_67_0_0, t1, _null), new A.Padding(D.EdgeInsets_0_67_0_0, A.Text$(A.Intl__message("Sign In", _null, "signIn", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_69t25, _null, _null, _null, _null, _null), _null), new A.Obx(new B.LoginView__buildMobileForm_closure(_this), _null), new A.Obx(new B.LoginView__buildMobileForm_closure0(_this, context), _null), _this._buildLoadingProgress$1(context), D.Padding_HfL, E.ApplicationVersionWidget_Rm0], t2), C.CrossAxisAlignment_2, C.MainAxisAlignment_0, C.MainAxisSize_1, C.VerticalDirection_1);
      t3 = $.$get$GetWidget__cache();
      A.Expando__checkType(_this);
      A._instanceType(_this)._eval$1("GetWidget.S")._as(t3._jsWeakMap.get(_this)).toString;
      return new A.Stack(C.AlignmentDirectional_m1_m1, _null, C.StackFit_0, C.Clip_1, A._setArrayType([new A.ConstrainedBox(D.BoxConstraints_oA89, t1, _null), A.Positioned$fill(24, new A.Align(C.Alignment_0_1, _null, _null, A.SvgPicture$asset("assets/images/power_by_linagora.svg", C.Alignment_0_0, _null, C.BoxFit_0, 44, _null, _null, 97), _null))], t2), _null);
    },
    _buildWebForm$1(context) {
      ...
      t2 = A.Text$(A.Intl__message("JMAP-based\ncollaborative team mail solution", _null, "jmapBasedMailSolution", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_69t23, _null, _null, _null, _null, _null);
      t3 = $.$get$GetWidget__cache();
      A.Expando__checkType(_this);
      t3 = t3._jsWeakMap;
      ...
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t5 = B.SloganBuilder$(true, "assets/images/ic_jmap_standard.svg", C.EdgeInsets_12_0_0_0, 48, A.Intl__message("JMAP standard", _null, "jmapStandard", _null, _null), D.TextStyle_69t24);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t6 = B.SloganBuilder$(true, "assets/images/ic_encrypted.svg", C.EdgeInsets_12_0_0_0, 48, A.Intl__message("Encrypted mailbox", _null, "encryptedMailbox", _null, _null), D.TextStyle_69t24);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t7 = B.SloganBuilder$(true, "assets/images/ic_team.svg", C.EdgeInsets_12_0_0_0, 48, A.Intl__message("Manage email as a team", _null, "manageEmailAsATeam", _null, _null), D.TextStyle_69t24);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t8 = B.SloganBuilder$(true, "assets/images/ic_integration.svg", C.EdgeInsets_12_0_0_0, 48, A.Intl__message("Multiple integrations", _null, "multipleIntegrations", _null, _null), D.TextStyle_69t24);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      ...
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t7 = A.Container$(_null, A.Column$(A._setArrayType([new A.Padding(D.EdgeInsets_0_66_0_0, t7, _null), new A.Padding(D.EdgeInsets_0_67_0_0, A.Text$(A.Intl__message("Sign In", _null, "signIn", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_69t25, _null, _null, _null, _null, _null), _null), new A.Obx(new B.LoginView__buildWebForm_closure(_this), _null), new A.Obx(new B.LoginView__buildWebForm_closure0(_this, context), _null), _this._buildLoadingProgress$1(context), D.Padding_HfL, E.ApplicationVersionWidget_Rm0], t9), C.CrossAxisAlignment_2, C.MainAxisAlignment_0, C.MainAxisSize_1, C.VerticalDirection_1), C.Clip_2, _null, _null, D.ShapeDecoration_OJ5, _null, 684, _null, _null, D.EdgeInsets_31_0_31_0, _null, _null, 458);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
  ...
  B.PrivacyLinkWidget.prototype = {
    build$1(context) {
      var t2, t3, _null = null,
        t1 = type$.AppLocalizations;
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
      t2 = A.Text$(A.Intl__message("By continuing, you're agreeing to our", _null, "byContinuingYouAreAgreeingToOur", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, E.TextStyle_8aB4, _null, _null, _null, _null, _null);
      A.Localizations_of(context, C.Type_AppLocalizations_CTL, t1).toString;
  ...
  B.LoginInputDecorationBuilder.prototype = {
    build$0() {
      ...
      return A.InputDecoration$(_null, _null, _null, t7 == null ? D.EdgeInsetsDirectional_25_15_25_15 : t7, _null, _null, _null, _null, true, t1, _null, C.OutlineInputBorder_en2, _null, _null, _null, C.Color_4294112245, true, _null, C.FloatingLabelBehavior_0, _null, _null, t2, _null, _null, _null, _null, _null, _null, _null, t6, t5, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_2bL0, t4, _null, _null, _null, _null, _null, t3, _null, _null, _null, _null, _null, _null, _null);
    }
  };
  ...
  B._LoginTextInputBuilderState.prototype = {
    ...
    build$1(context) {
      ...
      t9.hintStyle = C.TextStyle_8aB3;
      t9.errorTextStyle = D.TextStyle_8eb1;
      t9.focusBorder = C.OutlineInputBorder_ieL;
      t9.enabledBorder = D.OutlineInputBorder_AuK;
      t9.errorBorder = C.OutlineInputBorder_en2;
      t5 = A._setArrayType([A.TextFormFieldBuilder$(false, t6, t7, t9.build$0(), t8, _null, t4, t3, t2, t5, C.TextStyle_8aB3)], type$.JSArray_Widget);
  ...
  (function constants() {
    ...
    D.BoxConstraints_oA89 = new A.BoxConstraints(200, 720, 720, 1 / 0);
    ...
    D.RoundedRectangleBorder_NYu17 = new A.RoundedRectangleBorder(C.BorderRadius_ww811, C.BorderSide_Q1M);
    ...
    D.TextStyle_69t24 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 24, C.FontWeight_3_400, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t25 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 32, C.FontWeight_8_900, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t23 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 36, C.FontWeight_8_900, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "nVcRzHDH/A6YFbr6gdCnDPG0dbc=");
;