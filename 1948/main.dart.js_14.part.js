...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var C = {
    ContactView$() {
      ...
      t3 = t3.find$1$1$tag(0, _null, type$.ContactController);
      t3.$arguments = $.$get$GetNavigation__getxController().routing.args;
      return new A.ContactView(t1, t2, t3, _null);
    }
  },
  A, B;
  ...
  var type$ = {
    ContactController: A.findType("ContactController"),
    ImagePaths: A.findType("ImagePaths0"),
    ResponsiveUtils: A.findType("ResponsiveUtils0")
  };
};

$__dart_deferred_initializers__["LxBQah3u+X/DhlWofkou0g7uD7E="] = $__dart_deferred_initializers__.current
