...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B._Universe_addRules(init.typeUniverse, JSON.parse('{"GradientCircleAvatarIcon":{"StatelessWidget":[],"Widget":[],"DiagnosticableTree":[]},"SuggestionEmailAddress":{"EquatableMixin":[]}}'));
  (function constants() {
...
})($__dart_deferred_initializers__, "b3PdQqj9OhrYoyYTVpADWPSMcvE=");
;