...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, B,
  C = {_AutofillScopeTextInputConfiguration: function _AutofillScopeTextInputConfiguration(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16) {
      var _ = this;
  ...
  C.BaseLoginView.prototype = {
    buildLoginButton$1(context) {
      ...
      t4 = A.ElevatedButton_styleFrom(_null, _null, B.Color_4278221567, _null, _null, _null, _null, _null, _null, B.Color_4294967295, _null, _null, _null, _null, new A.RoundedRectangleBorder(A.BorderRadius$circular(10), B.BorderSide_PLF0), _null, _null, _null, _null);
      A.Expando__checkType(_this);
  ...
  C.LoginView.prototype = {
    ...
    _buildWebForm$1(context) {
      ...
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
      t5 = A.SloganBuilder$(true, _null, _null, "assets/images/ic_jmap_standard.svg", _null, _null, B.EdgeInsets_12_0_0_0, 48, A.Intl__message("JMAP standard", _null, "jmapStandard", _null, _null), _null, D.TextStyle_oHY22);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
      t6 = A.SloganBuilder$(true, _null, _null, "assets/images/ic_encrypted.svg", _null, _null, B.EdgeInsets_12_0_0_0, 48, A.Intl__message("Encrypted mailbox", _null, "encryptedMailbox", _null, _null), _null, D.TextStyle_oHY22);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
      t7 = A.SloganBuilder$(true, _null, _null, "assets/images/ic_team.svg", _null, _null, B.EdgeInsets_12_0_0_0, 48, A.Intl__message("Manage email as a team", _null, "manageEmailAsATeam", _null, _null), _null, D.TextStyle_oHY22);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
      t8 = A.SloganBuilder$(true, _null, _null, "assets/images/ic_integration.svg", _null, _null, B.EdgeInsets_12_0_0_0, 48, A.Intl__message("Multiple integrations", _null, "multipleIntegrations", _null, _null), _null, D.TextStyle_oHY22);
      A.Expando__checkType(_this);
      t4._as(t3.get(_this)).toString;
  ...
  C.PrivacyLinkWidget.prototype = {
    build$1(context) {
      var t2, t3, _null = null,
        t1 = type$.AppLocalizations;
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
      t2 = A.Text$(A.Intl__message("By continuing, you're agreeing to our", _null, "byContinuingYouAreAgreeingToOur", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_chs, _null, _null, _null, _null, _null);
      A.Localizations_of(context, B.Type_AppLocalizations_swi, t1).toString;
  ...
  C.LoginInputDecorationBuilder.prototype = {
    build$0() {
      ...
      return A.InputDecoration$(_null, _null, _null, t6 == null ? D.EdgeInsetsDirectional_25_15_25_15 : t6, _null, _null, _null, _null, true, t1, _null, B.OutlineInputBorder_0Qn, _null, _null, _null, B.Color_4294112245, true, _null, B.FloatingLabelBehavior_0, _null, _null, D.OutlineInputBorder_EjN1, _null, _null, _null, _null, _null, _null, t5, t4, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_oIa0, t3, _null, _null, _null, _null, _null, t2, _null, _null, _null, _null, _null, _null, _null);
    }
  };
      ...
      if (failure instanceof A.GetOIDCConfigurationFailure) {
        ...
        if (failure instanceof A.FeatureFailure) {
          ...
          if (errorMessage == null) {
            A.Localizations_of(t1, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
  ...
  (function constants() {
    ...
    D.OutlineInputBorder_EjN1 = new A.OutlineInputBorder(4, B.BorderRadius_tLn1, D.BorderSide_PLF2);
    D.BorderSide_A4L = new A.BorderSide(B.Color_4294112245, 1, B.BorderStyle_1, -1);
    D.OutlineInputBorder_LNn = new A.OutlineInputBorder(4, B.BorderRadius_tLn1, D.BorderSide_A4L);
    ...
    D.BoxShadow_SSw = new A.BoxShadow(2, B.BlurStyle_0, D.Color_1035779260, B.Offset_0_2, 40);
    D.List_ECL = A._setArrayType(makeConstList([D.BoxShadow_SSw]), A.findType("JSArray<BoxShadow>"));
    D.ShapeDecoration_MLv = new A.ShapeDecoration(B.Color_4294967295, null, null, D.List_ECL, B.RoundedRectangleBorder_27D10);
...
})($__dart_deferred_initializers__, "SPuQE7/R4FHTAHsLnMu5sZFEnC4=");
;