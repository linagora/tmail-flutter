...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B.UserSettingPopupMenuMixin.prototype = {
    popupMenuUserSettingActionTile$4$onLogoutAction$onSettingAction(context, userName, onLogoutAction, onSettingAction) {
      ...
      if (userName != null)
        t2.push(A.PopupMenuItem$(new A.SizedBox(300, _null, A.ListTile$(C.EdgeInsets_20_0_20_0, _null, _null, _null, A.SelectableText$(userName.value, 1, C.TextStyle_chs3), _null), _null), false, 48, _null, C.EdgeInsets_0_0_0_0, _null, type$.dynamic));
...
})($__dart_deferred_initializers__, "EdXqo3SEUL4+TcCA2ITzUUrGJpw=");
;