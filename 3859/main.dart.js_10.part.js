...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C = {FadingEdgeScrollView: function FadingEdgeScrollView(t0, t1, t2, t3, t4, t5, t6) {
    ...
    TMailDropDownWidget$(backgroundColor, dropDownIcon, onTap, text) {
      return new C.TMailDropDownWidget(text, dropDownIcon, onTap, backgroundColor, null);
    },
    ...
    SettingsUtils_getBoxDecorationForContent(context, responsiveUtils, backgroundColor) {
      ...
      if (t1.size._dx >= 1200)
        return new A.BoxDecoration(backgroundColor, _null, _null, B.BorderRadius_ww817, _null, _null, _null, B.BoxShape_0);
      else
        return _null;
    },
  ...
  C.TMailDropDownWidget.prototype = {
    build$1(context) {
      ...
      if (t1 == null)
        t1 = B.Color_0;
      t2 = A.ThemeUtils_textStyleBodyBody3(B.Color_4278190080);
      return A.TMailButtonWidget$(_null, t1, A.Border_Border$all(B.Color_4293321189, 1), 10, _null, false, 40, _null, _this.dropDownIcon, B.TextDirection_0, B.Color_4290298316, 20, 8, true, _null, B.MainAxisSize_1, _null, 1 / 0, _null, 1 / 0, 0, _null, _null, _this.onTap, B.EdgeInsetsDirectional_12_8_8_8, _this.text, _null, _null, t2, _null, _null, _null, _null, false, _null);
    }
  };
  ...
  C.LanguageAndRegionView.prototype = {
    build$1(context) {
      ...
      if (t6.size._dx >= 1200)
        t8.push(new C.SettingHeaderWidget(B.AccountMenuItem_1, B.EdgeInsets_0_0_0_0, E.ThemeUtils_textStyleInter600().copyWith$1$color(A.Color$fromARGB(B.JSNumber_methods.round$0(229.5), 0, 0, 0)), _null));
      else
      ...
      return E.Portal$(new C.SettingDetailViewBuilder(t3, A.Container$(_null, A.Column$(t8, B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1), B.Clip_0, t4, _null, t5, _null, _null, _null, _null, t7, _null, _null, 1 / 0), _null, B.Color_4294967295, _null, _null));
    }
  };
  ...
  C._ChangeLanguageButtonWidgetState.prototype = {
    ...
    _buildTitleLanguageWidget$1(context) {
      var _null = null;
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, type$.AppLocalizations).toString;
      return A.Text$(A.Intl__message("Language", _null, "language", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_2No.copyWith$4$color$fontSize$height$letterSpacing(A.Color$fromARGB(163, 66, 66, 68), 14, 1.500714285714286, -0.15), _null, _null, _null, _null, _null);
    },
    ...
    _getMobileTitlePadding$1(context) {
      ...
      if (A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, t1).data.size.get$shortestSide() < 600 && A.InheritedModel_inheritFrom(context, null, t1).data.get$orientation(0) === B.Orientation_0)
        ...
        return D.EdgeInsetsDirectional_40_0_40_0;
      else
  ...
  C.LanguageRegionOverlay.prototype = {
    build$1(context) {
      var _null = null,
        t1 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, type$.MediaQuery).data,
        t2 = A._setArrayType([new A.BoxShadow(0, B.BlurStyle_0, A.Color$fromARGB(B.JSNumber_methods.round$0(76.5), 0, 0, 0), B.Offset_0_1, 2), new A.BoxShadow(2, B.BlurStyle_0, A.Color$fromARGB(38, 0, 0, 0), B.Offset_0_2, 6)], type$.JSArray_BoxShadow);
      return A.Container$(_null, A.ListView$builder(_null, new C.LanguageRegionOverlay_build_closure(this), J.get$length$asx(this.listSupportedLanguages.get$value(0)), _null, _null, D.EdgeInsets_7_7_7_7, _null, _null, B.Axis_1, true), B.Clip_0, _null, new A.BoxConstraints(0, 1 / 0, 0, t1.size._dy - 80 - 200 - 16), new A.BoxDecoration(B.Color_4294967295, _null, _null, B.BorderRadius_ww87, t2, _null, _null, B.BoxShape_0), _null, _null, _null, D.EdgeInsets_0_4_0_24, B.EdgeInsets_8_8_8_8, _null, _null, this.maxWidth);
    }
  };
  C.LanguageItemWidget.prototype = {
    build$1(context) {
      var _null = null,
        t1 = A.Color$fromARGB(153, 235, 237, 240),
        t2 = this.localeCurrent,
        t3 = A.Localizations_of(context, B.Type_AppLocalizations_CTL, type$.AppLocalizations);
      t3.toString;
      t3 = A._setArrayType([A.Expanded$(A.Text$(A.LocaleExtension_getLanguageNameByCurrentLocale(t2, t3) + " - " + A.LocaleExtension_getSourceLanguageName(t2), _null, _null, 1, B.TextOverflow_2, _null, _null, _null, _null, B.TextStyle_2No.copyWith$4$color$fontSize$height$letterSpacing(A.Color$fromARGB(B.JSNumber_methods.round$0(229.5), 66, 66, 68), 16, 1.313125, -0.15), _null, _null, _null, _null, _null), 1)], type$.JSArray_Widget);
      ...
      return A.Material$(B.Duration_200000, true, _null, A.InkWell$(false, B.BorderRadius_ww81, true, A.Container$(_null, A.Row$(t3, B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), B.Clip_0, _null, _null, _null, _null, 51, _null, _null, D.EdgeInsets_17_0_17_0, _null, _null, _null), _null, true, _null, _null, _null, t1, _null, _null, _null, _null, _null, _null, _null, new C.LanguageItemWidget_build_closure(this), _null, _null, _null, _null, _null, _null, _null), B.Clip_0, B.Color_0, 0, _null, _null, _null, _null, _null, B.MaterialType_0);
    }
  };
  ...
  C.ProfilesView.prototype = {
    build$1(context) {
      var _null = null,
        ...
        t3 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, type$.MediaQuery).data;
      if (t3.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t2, A._setArrayType([D.SettingHeaderWidget_IgH, D.Divider_XW90], t1));
  ...
  C.SettingExplanationWidget.prototype = {
    build$1(context) {
      var child, _null = null,
        t1 = A.Localizations_of(context, B.Type_AppLocalizations_CTL, type$.AppLocalizations);
      t1.toString;
      child = A.Text$(this.menuItem.getExplanation$1(t1), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_YCw.copyWith$1$color(A.Color$fromARGB(163, 66, 66, 68)), _null, _null, _null, _null, _null);
      if (this.isCenter)
  ...
  C.SettingHeaderWidget.prototype = {
    build$1(context) {
      ...
      t3 = t2.getName$1(t1);
      t4 = this.textStyle;
      t3 = A._setArrayType([A.Text$(t3, _null, _null, _null, _null, _null, _null, _null, _null, t4 == null ? E.ThemeUtils_textStyleInter600().copyWith$1$color(B.Color_4278190080) : t4, _null, _null, _null, _null, _null)], type$.JSArray_Widget);
      if (t2.getExplanation$1(t1).length !== 0)
        t3.push(new A.Padding(D.EdgeInsets_0_13_0_0, A.Text$(t2.getExplanation$1(t1), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_2No.copyWith$4$color$fontSize$height$letterSpacing(A.Color$fromARGB(163, 66, 66, 68), 16, 1.313125, -0.15), _null, _null, _null, _null, _null), _null));
  ...
  C._ChangeLanguageButtonWidgetState__buildLanguageMenu_closure.prototype = {
    call$3(context, isVisible, child) {
      ...
      t4 = isVisible ? A.Color$fromARGB(153, 235, 237, 240) : _null;
      return A.PortalTarget$(B.C_Filled, A.PortalTarget$(F.Aligned_wEo, C.TMailDropDownWidget$(t4, "assets/images/ic_dropdown.svg", new C._ChangeLanguageButtonWidgetState__buildLanguageMenu__closure0(t1), t6), new C.LanguageRegionOverlay(t1._change_language_button_widget$_imagePaths, t1._change_language_button_widget$_responsiveUtils, t3.listSupportedLanguages, t5, this.maxWidth, new C._ChangeLanguageButtonWidgetState__buildLanguageMenu__closure1(t1), _null), isVisible), t2, isVisible);
    },
    $signature: 368
  };
  ...
  C._ChangeLanguageButtonWidgetState__buildMobileLanguageMenu_closure.prototype = {
    call$0() {
      ...
      t4.toString;
      return C.TMailDropDownWidget$(null, "assets/images/ic_dropdown.svg", new C._ChangeLanguageButtonWidgetState__buildMobileLanguageMenu__closure(t1, t3), A.LocaleExtension_getLanguageNameByCurrentLocale(t2, t4));
    },
  ...
  (function constants() {
    ...
    D.EdgeInsetsDirectional_40_0_40_0 = new A.EdgeInsetsDirectional(40, 0, 40, 0);
...
})($__dart_deferred_initializers__, "AfTSmfEkxYbs2HjNuzscWJn5yqI=");
;