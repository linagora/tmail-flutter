...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, C,
  B = {
    HtmlContentViewerOnWeb$(allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, mailtoDelegate, onClickHyperLinkAction, scrollController, useDefaultFont, widthContent) {
      return new B.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, mailtoDelegate, onClickHyperLinkAction, allowResizeToDocumentSize, scrollController, null);
    },
  ...
  B._HtmlContentViewerOnWebState.prototype = {
    ...
    _handleContentHeightEvent$1(height) {
      ...
      if (t1 != null) {
        scrollHeightWithBuffer = J.$add$ansx(docHeight, 24);
...
})($__dart_deferred_initializers__, "00AaOnfM+CEtj2dv+lkGowejLYs=");
;