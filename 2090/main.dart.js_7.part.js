...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var A = {
    ...
    TMailContainerWidget: function TMailContainerWidget(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13) {
      var _ = this;
      _.onTapActionCallback = t0;
      _.onTapActionAtPositionCallback = t1;
      _.child = t2;
  ...
  A.TMailButtonWidget.prototype = {
    build$1(context) {
      ...
      return new A.TMailContainerWidget(_this.onTapActionCallback, _this.onTapActionAtPositionCallback, childWidget, _this.borderRadius, _this.width, _this.maxWidth, _this.maxHeight, _this.minWidth, _this.tooltipMessage, _this.backgroundColor, _this.padding, _this.margin, _this.boxShadow, _null);
    }
  };
  A.TMailContainerWidget.prototype = {
    build$1(context) {
      ...
      t4 = B.Container$(C.Alignment_0_0, _this.child, C.Clip_0, _null, new B.BoxConstraints(_this.minWidth, _this.maxWidth, 0, _this.maxHeight), new B.BoxDecoration(t3, _null, _null, t1, _this.boxShadow, _null, _null, C.BoxShape_0), _null, _null, _null, _null, t4, _null, _null, _this.width);
      t1 = t4;
  ...
  (function inheritance() {
    ...
    _inheritMany(B.StatelessWidget, [A.TMailButtonWidget, A.TMailContainerWidget, A.PopupMenuItemWidget, A.Chip, A.Drawer, A.ListTile, A.MaterialTextButton, A.UserInformationWidgetBuilder, A.VacationNotificationMessageWidget]);
...
$__dart_deferred_initializers__["dwc2h32CCF0UwiklrVjRPChWGJA="] = $__dart_deferred_initializers__.current
