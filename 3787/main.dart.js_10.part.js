...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.MailboxVisibilityView__buildMailboxCategory_closure.prototype = {
    call$0() {
      ...
      return A.MailboxCategoryWidget$(t1, A.MailboxCategoriessExtension_getExpandMode(t1, A._instanceType(t2)._eval$1("GetWidget.S")._as(t3._jsWeakMap.get(t2)).mailboxCategoriesExpandMode.get$value(0)), true, new C.MailboxVisibilityView__buildMailboxCategory__closure(t2), B.EdgeInsetsDirectional_0_8_0_8, false);
    },
    $signature: 371
  };
    ...
    call$0() {
      ...
      switch (t3._as(t2.get(t1)).accountMenuItemSelected.get$value(0)) {
        ...
        case B.AccountMenuItem_1:
          A.Expando__checkType(t1);
          if (t3._as(t2.get(t1)).get$isLanguageSupported())
  ...
  C.SettingsFirstLevelView_build_closure6.prototype = {
    call$0() {
      ...
      t2 = t2._jsWeakMap;
      t3 = A._instanceType(t1)._eval$1("GetWidget.S");
      if (!t3._as(t2.get(t1)).manageAccountDashboardController.get$isLanguageSupported())
        return B.SizedBox_0_0_null_null;
      t4 = this.context;
      A.Expando__checkType(t1);
...
})($__dart_deferred_initializers__, "QuB5Cio99dxmsGJQxFOmrzDLeOY=");
;