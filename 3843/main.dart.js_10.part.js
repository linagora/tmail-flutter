...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ManageAccountMenuView.prototype = {
    build$1(context) {
      ...
      if (!(t7.size._dx >= 1200))
        t6.push(new A.Padding(D.EdgeInsetsDirectional_16_16_0_16, A.Row$(A._setArrayType([H.ApplicationLogoWidthTextWidget$(_null, _null), G.ApplicationVersionWidget_Rm0], t5), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), _null));
      A.Expando__checkType(_this);
      t2._as(t1.get(_this)).toString;
      t7 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, t3).data;
      if (!(t7.size._dx >= 1200))
  ...
  C.SettingOptionItem.prototype = {
    build$1(context) {
      ...
      t5 = A.InkWell$(false, _null, true, A.SvgPicture$asset(t2.isEnabled$2(0, _this.settingOption, _this.localSettings) ? "assets/images/ic_switch_on.svg" : "assets/images/ic_switch_off.svg", B.Alignment_0_0, _null, B.BoxFit_0, 28, _null, _null, 44), _null, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new C.SettingOptionItem_build_closure(_this), _null, _null, _null, _null, _null, _null, _null);
  ...
  C.IdentityListTileBuilder.prototype = {
    build$1(context) {
      var t7, t8, t9, _this = this, _null = null,
        ...
        t5 = t4.name,
        t6 = type$.JSArray_Widget;
      t5 = A._setArrayType([new A.Padding(D.EdgeInsets_0_0_0_6, A.TextOverflowBuilder$(t5 == null ? "" : t5, 1, B.TextOverflow_2, B.TextStyle_69t7), _null)], t6);
      t7 = t4.email;
      ...
      if ((t8 ? _null : t7._collection$_length !== 0) === true) {
        ...
        t5.push(new A.Padding(F.EdgeInsets_0_0_0_4, A.Row$(A._setArrayType([t9, B.SizedBox_4_null_null_null, A.Expanded$(A.TextOverflowBuilder$(t7 == null ? "" : t7, 1, B.TextOverflow_2, B.TextStyle_8aB0), 1)], t6), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), _null));
      }
  ...
  C.SignatureBuilder.prototype = {
    ...
    _buildSignature$3(context, width, height) {
      ...
      if (t1.length !== 0) {
        ...
        return I.HtmlContentViewerOnWeb$(false, t1, _null, t2 == null ? B.TextDirection_1 : t2, false, height, _null, _null, _null, _null, false, width);
      } else
  ...
  C.PreferencesView_build_closure0.prototype = {
    call$0() {
      ...
      return A.ListView$separated(_null, new C.PreferencesView_build__closure1(t1, settingOption, localSettingOption, t3), t3.length, _null, B.ScrollViewKeyboardDismissBehavior_0, _null, _null, _null, false, B.Axis_1, new C.PreferencesView_build__closure2(), false);
    },
    $signature: 3
  };
...
})($__dart_deferred_initializers__, "Y8OB4VrpSrFEF5fFnRwPwMng4sw=");
;