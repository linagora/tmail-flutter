        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$returnValue = $.$get$UrlLauncherPlatform__instance().launchUrl$2(urlString, new A.LaunchOptions(A.convertLaunchMode(mode), new A.InAppWebViewConfiguration(true, true, B.Map_empty4), null));
              // goto return
              $async$goto = 1;
              break;
            case 1:
...
$__dart_deferred_initializers__["1uzVbdsC4cS+mO4RlWndNj9o6Ik="] = $__dart_deferred_initializers__.current
