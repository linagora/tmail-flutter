...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, C,
  B = {
    HtmlContentViewerOnWeb$(adjustHeight, allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, mailtoDelegate, maxHeight, minWidth, onClickHyperLinkAction, useDefaultFont, widthContent) {
      return new B.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, minWidth, maxHeight, adjustHeight, mailtoDelegate, onClickHyperLinkAction, allowResizeToDocumentSize, null);
    },
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) {
      ...
      _.adjustHeight = t8;
      _.mailtoDelegate = t9;
      _.onClickHyperLinkAction = t10;
      _.allowResizeToDocumentSize = t11;
      _.key = t12;
    },
    ...
    call$1($event) {
      ...
      if (t1.$index(data, _s4_) != null && J.contains$1$asx(t1.$index(data, _s4_), "toDart: htmlHeight")) {
        ...
        if (t2 != null) {
          ...
          if (J.$gt$n(scrollHeightWithBuffer, t3.minHeight) || t3._widget.adjustHeight)
  ...
  B._HtmlContentViewerOnWebState_build__closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (snapshot.data != null) {
        ...
        t3 === $ && A.throwUnnamedLateFieldNI();
        t4 = t1._widget;
        if (t4.adjustHeight && t4.maxHeight != null) {
          t4 = t4.maxHeight;
          t4.toString;
          t4 = new A.BoxConstraints(0, 1 / 0, 0, t4);
        } else
          t4 = _null;
        t5 = t1._html_content_viewer_on_web_widget$_htmlData;
        t1 = t1.___HtmlContentViewerOnWebState__createdViewId_A;
        t1 === $ && A.throwUnnamedLateFieldNI();
        return A.Container$(_null, new A.HtmlElementView(t1, _null, _null, new A.ValueKey(t5, type$.ValueKey_nullable_String)), C.Clip_0, _null, t4, _null, _null, t2, _null, _null, _null, _null, _null, t3);
      } else
...
})($__dart_deferred_initializers__, "cWMf2XkZm2gIxKJv5ZSBoVQbVA8=");
;