...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, C, E, F,
  B = {
    HtmlContentViewerOnWeb$(adjustHeight, allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, mailtoDelegate, maxHeight, minWidth, widthContent) {
      return new B.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, minWidth, maxHeight, contentPadding, adjustHeight, mailtoDelegate, allowResizeToDocumentSize, null);
    },
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      ...
      _.adjustHeight = t7;
      _.mailtoDelegate = t8;
      _.allowResizeToDocumentSize = t9;
      _.key = t10;
    },
    _HtmlContentViewerOnWebState: function _HtmlContentViewerOnWebState(t0) {
      var _ = this;
      _.___HtmlContentViewerOnWebState__minWidth_A = _.___HtmlContentViewerOnWebState__actualWidth_A = _.___HtmlContentViewerOnWebState__actualHeight_A = _.___HtmlContentViewerOnWebState__createdViewId_A = $;
    ...
    AppGridDashboardIcon$(appGridController, onShowAppDashboardAction) {
      ...
      return new B.AppGridDashboardIcon(t1.find$1$1$tag(0, null, type$.ImagePaths), appGridController, onShowAppDashboardAction, null);
    },
    ...
    NavigationBarWidget$(appGridController, avatarUserName, onShowAppDashboardAction, onTapApplicationLogoAction, onTapAvatarAction, searchForm) {
      return new B.NavigationBarWidget(avatarUserName, searchForm, appGridController, onTapApplicationLogoAction, onShowAppDashboardAction, onTapAvatarAction, null);
    },
  ...
  B._HtmlContentViewerOnWebState.prototype = {
    initState$0() {
      ...
      t1 = t1.minWidth;
      _this.___HtmlContentViewerOnWebState__minWidth_A = t1 == null ? 300 : t1;
    ...
    build$1(context) {
      var _this = this,
        ...
        t2 = _this._htmlData;
      if ((t2 == null ? null : t2.length !== 0) === false)
        t1.push(C.SizedBox_0_0_null_null);
      else
        t1.push(A.FutureBuilder$(new B._HtmlContentViewerOnWebState_build_closure(_this), _this._webInit, type$.bool));
      if (_this._html_content_viewer_on_web_widget$_isLoading)
        t1.push(D.Align_ChN);
      return new A.Stack(C.AlignmentDirectional_m1_m1, null, C.StackFit_0, C.Clip_1, t1, null);
    },
    dispose$0() {
      this._htmlData = null;
  ...
  B.AppGridDashboardIcon.prototype = {
    build$1(context) {
      return new A.Obx(new B.AppGridDashboardIcon_build_closure(this, context), null);
    }
  };
  B.AppGridDashboardItem.prototype = {
    build$1(context) {
      ...
      if ((t3 == null ? _null : t3.length !== 0) === true) {
        ...
        t2.push(C.JSString_methods.endsWith$1(t3, "svg") ? A.SvgPicture$asset(t4, C.Alignment_0_0, _null, C.BoxFit_0, 42, _null, _null, 42) : A.Image$asset(t4, C.BoxFit_0, 42, _null, 42));
      } else {
        t3 = t1.publicIconUri;
        if (t3 != null)
          t2.push(A.Image$network(t3.toString$0(0), new B.AppGridDashboardItem_build_closure(), C.BoxFit_0, 42, 42));
      }
      t3 = A.Theme_of(context).textTheme.bodySmall;
      t3 = t3 == null ? _null : t3.copyWith$3$color$fontSize$fontWeight(C.Color_4278190080, 12, C.FontWeight_3_400);
      t2.push(new A.Padding(C.EdgeInsets_0_8_0_0, A.Text$(t1.appName, _null, _null, 1, C.TextOverflow_2, _null, _null, _null, _null, t3, C.TextAlign_2, _null, _null, _null, _null), _null));
      return new B.LinkBrowserWidget(t1.appUri, A.Material$(C.Duration_200000, true, _null, A.InkWell$(false, C.BorderRadius_ww80, true, A.Container$(_null, A.Column$(t2, C.CrossAxisAlignment_2, C.MainAxisAlignment_0, C.MainAxisSize_1, C.VerticalDirection_1), C.Clip_0, _null, _null, _null, _null, _null, _null, _null, C.EdgeInsets_0_8_0_8, _null, _null, 80), _null, true, _null, _null, _null, C.Color_2581915884, _null, _null, _null, _null, _null, _null, _null, new B.AppGridDashboardItem_build_closure0(this), _null, _null, _null, _null, _null, _null, _null), C.Clip_0, C.Color_0, 0, _null, _null, _null, _null, _null, C.MaterialType_0), _null);
    }
  };
  B.AppDashboardOverlay.prototype = {
    build$1(context) {
      ...
      return A.GestureDetector$(_null, A.Container$(_null, A.Wrap$(C.WrapAlignment_0, A.List_List$of(new A.MappedListIterable(t4, new B.AppDashboardOverlay_build_closure(), t5), true, t5._eval$1("ListIterable.E")), C.WrapCrossAlignment_0, C.WrapAlignment_0, 0, 0), C.Clip_0, _null, _null, new A.BoxDecoration(C.Color_4294967295, _null, _null, t2, t3, _null, _null, C.BoxShape_0), _null, _null, _null, _null, D.EdgeInsetsDirectional_10_14_10_14, _null, _null, t1), C.DragStartBehavior_1, false, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new B.AppDashboardOverlay_build_closure0(), _null, _null, _null, _null, _null, _null, _null, false, C.Offset_7BT);
    },
    get$_widthAppGrid() {
  ...
  B.NavigationBarWidget.prototype = {
    build$1(context) {
      ...
      if (_this.searchForm != null)
        ...
        if (B.AppConfig_appGridDashboardAvailable() && _this.appGridController != null) {
          t3 = _this.appGridController;
          t3.toString;
          t1.push(B.AppGridDashboardIcon$(t3, _this.onShowAppDashboardAction));
        }
  ...
  B.VacationNotificationMessageWidget.prototype = {
    ...
    _buildBodyForDesktop$1(context) {
      ...
      if (t2 != null) {
        ...
        A.Localizations_of(context, C.Type_AppLocalizations_CTL, t3).toString;
        t1.push(A.TMailButtonWidget_TMailButtonWidget$fromText(C.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t2, D.EdgeInsets_8_5_8_5, t4, _null, C.TextStyle_yT32, A.Intl__message("End now", _null, "endNow", _null, _null), _null));
      }
      ...
      if (t2 != null) {
        ...
        A.Localizations_of(context, C.Type_AppLocalizations_CTL, t3).toString;
        t1.push(A.TMailButtonWidget_TMailButtonWidget$fromText(C.Color_0, 10, _null, _null, 1 / 0, 1, 310, 0, _null, t2, D.EdgeInsets_8_5_8_5, t4, _null, C.TextStyle_yT32, A.Intl__message(_s16_, _null, _s15_, _null, _null), _null));
      }
    ...
    _buildBodyForMobile$1(context) {
      ...
      if (t3 != null) {
        ...
        A.Localizations_of(context, C.Type_AppLocalizations_CTL, t4).toString;
        t1.push(new A.Flexible(1, C.FlexFit_1, A.TMailButtonWidget_TMailButtonWidget$fromText(C.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t3, D.EdgeInsets_8_5_8_5, t5, _null, C.TextStyle_yT32, A.Intl__message("End now", _null, "endNow", _null, _null), _null), _null));
      }
      ...
      if (t3 != null) {
        ...
        A.Localizations_of(context, C.Type_AppLocalizations_CTL, t4).toString;
        t1.push(new A.Flexible(1, C.FlexFit_1, A.TMailButtonWidget_TMailButtonWidget$fromText(C.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t3, D.EdgeInsets_8_5_8_5, t5, _null, C.TextStyle_yT32, A.Intl__message(_s16_, _null, _s15_, _null, _null), _null), _null));
      }
  ...
  B._HtmlContentViewerOnWebState_initState_closure.prototype = {
    call$1($event) {
      ...
      if (t1.$index(data, _s4_) != null && J.contains$1$asx(t1.$index(data, _s4_), "toDart: htmlHeight")) {
        ...
        if (t2 != null) {
          scrollHeightWithBuffer = J.$add$ansx(docHeight, t3._widget.adjustHeight ? 0 : 30);
          if (J.$gt$n(scrollHeightWithBuffer, 100) || t3._widget.adjustHeight)
      ...
      if (t1.$index(data, _s4_) != null && J.contains$1$asx(t1.$index(data, _s4_), "toDart: htmlWidth")) {
        ...
        t2 = t3._framework$_element;
        if (t2 != null) {
          t2 = t3.___HtmlContentViewerOnWebState__minWidth_A;
          t2 === $ && A.throwUnnamedLateFieldNI();
          if (J.$gt$n(docWidth, t2) && t3._widget.allowResizeToDocumentSize)
  ...
  B._HtmlContentViewerOnWebState_build_closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (t2.adjustHeight) {
        ...
        t3 === $ && A.throwUnnamedLateFieldNI();
        t4 = t1.___HtmlContentViewerOnWebState__actualWidth_A;
        t4 === $ && A.throwUnnamedLateFieldNI();
        t2 = t2.maxHeight;
        t2 = t2 != null ? new A.BoxConstraints(0, 1 / 0, 0, t2) : _null;
        t5 = t1._htmlData;
        t1 = t1.___HtmlContentViewerOnWebState__createdViewId_A;
        t1 === $ && A.throwUnnamedLateFieldNI();
        return A.Container$(_null, new A.HtmlElementView(t1, _null, _null, new A.ValueKey(t5, type$.ValueKey_nullable_String)), C.Clip_0, _null, t2, _null, _null, t3, _null, _null, _null, _null, _null, t4);
      }
      ...
      t1 = t1.___HtmlContentViewerOnWebState__createdViewId_A;
      t1 === $ && A.throwUnnamedLateFieldNI();
      return new A.SizedBox(t3, t2, new A.HtmlElementView(t1, _null, _null, new A.ValueKey(t4, type$.ValueKey_nullable_String)), _null);
    },
    $signature: 580
  };
  ...
  B.AppGridDashboardIcon_build_closure.prototype = {
    call$0() {
      var t3, t4, t5, _null = null,
        t1 = this.$this,
        t2 = t1.appGridController,
        isAppGridOpen = t2.isAppGridDashboardOverlayOpen.get$value(0);
      t2 = A.GestureDetector$(C.HitTestBehavior_1, _null, C.DragStartBehavior_1, false, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t2.get$toggleAppGridDashboard(), _null, _null, _null, _null, _null, _null, _null, false, C.Offset_7BT);
      t3 = this.context;
      t4 = type$._LocalizationsScope;
      t5 = A.Bidi_isRtlLanguage(t3.dependOnInheritedWidgetOfExactType$1$0(t4).localizationsState._localizations$_locale.get$languageCode(0)) ? C.Alignment_m1_m1 : C.Alignment_1_m1;
      t3 = A.Bidi_isRtlLanguage(t3.dependOnInheritedWidgetOfExactType$1$0(t4).localizationsState._localizations$_locale.get$languageCode(0)) ? C.Alignment_m1_1 : D.Alignment_1_1;
      return A.PortalTarget$(C.C_Filled, A.PortalTarget$(new A.Aligned(_null, _null, t5, t3, C.Alignment_0_0, C.C_AxisFlag, C.C_AxisFlag, C.Offset_0_0, _null), A.TMailButtonWidget_TMailButtonWidget$fromIcon(C.Color_0, 20, _null, "assets/images/ic_app_dashboard.svg", _null, 30, _null, _null, 1 / 0, _null, t1.onShowAppDashboardAction, C.EdgeInsets_6_6_6_6, _null), new A.Obx(new B.AppGridDashboardIcon_build__closure(t1), _null), isAppGridOpen), t2, isAppGridOpen);
    },
    $signature: 353
  };
  B.AppGridDashboardIcon_build__closure.prototype = {
    call$0() {
      ...
      if ((listApps == null ? null : listApps.apps.length !== 0) === true) {
        listApps.toString;
        return new B.AppDashboardOverlay(listApps, null);
      }
      return C.SizedBox_0_0_null_null;
    },
    $signature: 3
  };
  B.AppGridDashboardItem_build_closure0.prototype = {
    call$0() {
  ...
  B.AppGridDashboardItem_build_closure.prototype = {
    call$3(_, error, stackTrace) {
      var _null = null;
      return A.Container$(_null, _null, C.Clip_0, C.Color_4285887861, _null, _null, _null, 42, _null, _null, _null, _null, _null, 42);
    },
    $signature: 392
  };
  ...
  B.NavigationBarWidget_build_closure.prototype = {
    call$2(context, constraint) {
      var t3,
        t1 = this.$this,
        t2 = A._setArrayType([new A.SizedBox(constraint.maxWidth / 2, 52, t1.searchForm, null), C.Spacer_null], type$.JSArray_Widget);
      if (B.AppConfig_appGridDashboardAvailable() && t1.appGridController != null) {
        t3 = t1.appGridController;
        t3.toString;
        t2.push(B.AppGridDashboardIcon$(t3, t1.onShowAppDashboardAction));
      }
      ...
      t3._boxShadows = A._setArrayType([D.BoxShadow_NMc], type$.JSArray_BoxShadow);
      t2.push(t3.build$0());
      return A.Row$(t2, C.CrossAxisAlignment_2, null, C.MainAxisAlignment_0, C.MainAxisSize_1, null);
    },
    $signature: 356
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(B, "link_DefaultLinkDelegate_create$closure", "DefaultLinkDelegate_create", 2);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.State0, [B._HtmlContentViewerOnWebState, B._PortalState]);
    _inheritMany(A.Closure, [B._HtmlContentViewerOnWebState_initState_closure, B._HtmlContentViewerOnWebState__setUpWeb_closure, B.AppGridDashboardItem_build_closure, B.AppDashboardOverlay_build_closure]);
    _inheritMany(A.Closure0Args, [B._HtmlContentViewerOnWebState_initState__closure, B._HtmlContentViewerOnWebState_initState__closure0, B._HtmlContentViewerOnWebState_initState__closure1, B._HtmlContentViewerOnWebState__setUpWeb_closure0, B.AppGridDashboardIcon_build_closure, B.AppGridDashboardIcon_build__closure, B.AppGridDashboardItem_build_closure0, B.AppDashboardOverlay_build_closure0, B.DefaultLinkDelegate_build_closure]);
    _inheritMany(A.Closure2Args, [B._HtmlContentViewerOnWebState_build_closure, B.LinkBrowserWidget_build_closure, B.NavigationBarWidget_build_closure]);
    _inherit(B._ElevatedButtonWithIcon, A.ElevatedButton);
    _inheritMany(A.StatelessWidget, [B._ElevatedButtonWithIconChild, B.LinkBrowserWidget, B.MaterialTextButton, B.UserInformationWidget, B.AppGridDashboardIcon, B.AppGridDashboardItem, B.AppDashboardOverlay, B.NavigationBarWidget, B.VacationNotificationMessageWidget, B.Link, B.DefaultLinkDelegate]);
    _inheritMany(A.Object, [B.PortalLink, B._SuggestionEmailAddress_Object_EquatableMixin0]);
  ...
  (function constants() {
    ...
    D.TextStyle_69t9 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 17, C.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t12 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 20, C.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "jHm5QQQdpkrELPa0uam+lg9P3+M=");
;