...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, C,
  B = {
    HtmlContentViewerOnWeb$(allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, htmlContentMinHeight, htmlContentMinWidth, keepAlive, mailtoDelegate, maxHeight, offsetHtmlContentHeight, onClickHyperLinkAction, scrollController, useDefaultFont, widthContent) {
      return new B.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, maxHeight, htmlContentMinWidth, htmlContentMinHeight, offsetHtmlContentHeight, keepAlive, mailtoDelegate, onClickHyperLinkAction, allowResizeToDocumentSize, scrollController, null);
    },
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15) {
      var _ = this;
      _.contentHtml = t0;
      _.widthContent = t1;
      _.heightContent = t2;
      ...
      _.useDefaultFont = t5;
      _.maxHeight = t6;
      _.htmlContentMinWidth = t7;
      _.htmlContentMinHeight = t8;
      _.offsetHtmlContentHeight = t9;
      _.keepAlive = t10;
      _.mailtoDelegate = t11;
      _.onClickHyperLinkAction = t12;
      _.allowResizeToDocumentSize = t13;
      _.scrollController = t14;
      _.key = t15;
    },
  ...
  B._HtmlContentViewerOnWebState.prototype = {
    ...
    _handleContentHeightEvent$1(height) {
      ...
      if (t1 != null) {
        ...
        if (J.$gt$n(scrollHeightWithBuffer, _this._widget.htmlContentMinHeight))
  ...
  B._HtmlContentViewerOnWebState_build_closure.prototype = {
    call$2(context, constraint) {
      var t1 = A._setArrayType([], type$.JSArray_Widget),
        t2 = this.$this,
        t3 = t2._html_content_viewer_on_web_widget$_htmlData;
      if ((t3 == null ? null : t3.length !== 0) === false)
        t1.push(C.SizedBox_0_0_null_null);
      else
        t1.push(A.FutureBuilder$(new B._HtmlContentViewerOnWebState_build__closure(t2), t2._webInit, type$.bool));
      if (t2._html_content_viewer_on_web_widget$_isLoading)
        t1.push(D.Align_ChN);
      t2._widget.toString;
  ...
  B._HtmlContentViewerOnWebState_build__closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (snapshot.data != null) {
        ...
        t4 = t1._widget;
        t5 = t4.maxHeight;
        t5 = t5 != null ? new A.BoxConstraints(0, 1 / 0, 0, t5) : _null;
        t6 = t1._html_content_viewer_on_web_widget$_htmlData;
        t4 = A.S(t4.key);
        t1 = t1.___HtmlContentViewerOnWebState__createdViewId_A;
        t1 === $ && A.throwUnnamedLateFieldNI();
        return A.Container$(_null, new A.HtmlElementView(t1, _null, _null, new A.ValueKey(A.S(t6) + "-" + t4, type$.ValueKey_String)), C.Clip_0, _null, t5, _null, _null, t2, _null, _null, _null, _null, _null, t3);
      } else
...
})($__dart_deferred_initializers__, "b4GtD3Xxw6NrKMkia1P0Lv0LF9Q=");
;