...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      ...
      t2 = t1.emailAddress;
      t3 = G.GradientCircleAvatarIcon$(A.List_ebS[B.EmailAddressExtension__generateIndex(t2)], 40, C.EmailAddressExtension_get_labelAvatar(t2), 24);
      ...
      if (t1 === D.SuggestionEmailState_1)
        t2.push(new B.Padding(F.EdgeInsets_12_0_0_0, B.SvgPicture$asset("assets/images/ic_filter_selected.svg", A.Alignment_0_0, _null, A.BoxFit_0, 24, _null, 24), _null));
  ...
  (function constants() {
    E.EdgeInsets_16_10_16_10 = new B.EdgeInsets(16, 10, 16, 10);
  })();
};

$__dart_deferred_initializers__["gGuv0uOMxsfhfzxNYqWhBBrpmpQ="] = $__dart_deferred_initializers__.current
