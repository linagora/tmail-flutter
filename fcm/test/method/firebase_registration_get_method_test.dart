...
void main() {
  group('test to json firebase registration get method', () {
    final expectFirebaseRegistration1 = FirebaseRegistration(
      ...
      expires: FirebaseRegistrationExpiredTime(UTCDate(DateTime.parse('2018-07-31T00:13:21Z'))),
    ...
    final expectFirebaseRegistration2 = FirebaseRegistration(
      ...
      expires: FirebaseRegistrationExpiredTime(UTCDate(DateTime.parse('2018-07-12T05:55:00Z'))),
