...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      ...
      t2 = B._setArrayType([new G.GradientCircleAvatarIcon(t3, 40, 24, t4, _null), A.SizedBox_12_null_null_null, B.Expanded$(B.Column$(t6, A.CrossAxisAlignment_0, A.MainAxisAlignment_0, A.MainAxisSize_0, A.VerticalDirection_1), 1)], t5);
      t1 = t1.state;
...
$__dart_deferred_initializers__["daH2gmrp0BAi2H/60QNqXfH48YE="] = $__dart_deferred_initializers__.current
