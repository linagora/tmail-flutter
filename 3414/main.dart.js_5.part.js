...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, B, E, F,
  C = {
    HtmlContentViewerOnWeb$(allowResizeToDocumentSize, contentHtml, contentPadding, direction, heightContent, mailtoDelegate, useDefaultFont, widthContent) {
      return new C.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, mailtoDelegate, allowResizeToDocumentSize, null);
    },
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.contentHtml = t0;
      _.widthContent = t1;
      _.heightContent = t2;
      ...
      _.useDefaultFont = t5;
      _.mailtoDelegate = t6;
      _.allowResizeToDocumentSize = t7;
      _.key = t8;
    },
    ...
    NavigationBarWidget$(appGridController, avatarUserName, contactSupportCapability, imagePaths, onShowAppDashboardAction, onTapApplicationLogoAction, onTapAvatarAction, onTapContactSupportAction, searchForm) {
      return new C.NavigationBarWidget(imagePaths, avatarUserName, contactSupportCapability, searchForm, appGridController, onTapApplicationLogoAction, onShowAppDashboardAction, onTapAvatarAction, onTapContactSupportAction, null);
    },
    ...
    build$1(context) {
      ...
      if (_this.searchForm != null)
        ...
        if (C.AppConfig_appGridDashboardAvailable() && _this.appGridController != null) {
          ...
          t3.toString;
          t1.push(new A.Padding(B.EdgeInsetsDirectional_0_0_16_0, new C.AppGridDashboardIcon(_this.imagePaths, t3, _this.onShowAppDashboardAction, _null), _null));
        }
  ...
  C.VacationNotificationMessageWidget.prototype = {
    ...
    _buildBodyForDesktop$1(context) {
      ...
      if (t2 != null) {
        ...
        A.Localizations_of(context, B.Type_AppLocalizations_CTL, t3).toString;
        t1.push(A.TMailButtonWidget_TMailButtonWidget$fromText(B.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t2, D.EdgeInsets_8_5_8_5, t4, _null, B.TextStyle_yT31, A.Intl__message("End now", _null, "endNow", _null, _null), _null));
      }
      ...
      if (t2 != null) {
        ...
        A.Localizations_of(context, B.Type_AppLocalizations_CTL, t3).toString;
        t1.push(A.TMailButtonWidget_TMailButtonWidget$fromText(B.Color_0, 10, _null, _null, 1 / 0, 1, 310, 0, _null, t2, D.EdgeInsets_8_5_8_5, t4, _null, B.TextStyle_yT31, A.Intl__message(_s16_, _null, _s15_, _null, _null), _null));
      }
    ...
    _buildBodyForMobile$1(context) {
      ...
      if (t3 != null) {
        ...
        A.Localizations_of(context, B.Type_AppLocalizations_CTL, t4).toString;
        t1.push(new A.Flexible(1, B.FlexFit_1, A.TMailButtonWidget_TMailButtonWidget$fromText(B.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t3, D.EdgeInsets_8_5_8_5, t5, _null, B.TextStyle_yT31, A.Intl__message("End now", _null, "endNow", _null, _null), _null), _null));
      }
      ...
      if (t3 != null) {
        ...
        A.Localizations_of(context, B.Type_AppLocalizations_CTL, t4).toString;
        t1.push(new A.Flexible(1, B.FlexFit_1, A.TMailButtonWidget_TMailButtonWidget$fromText(B.Color_0, 10, _null, _null, 1 / 0, 1, 180, 0, _null, t3, D.EdgeInsets_8_5_8_5, t5, _null, B.TextStyle_yT31, A.Intl__message(_s16_, _null, _s15_, _null, _null), _null), _null));
      }
  ...
  C.NavigationBarWidget_build_closure.prototype = {
    call$2(context, constraint) {
      ...
      if (C.AppConfig_appGridDashboardAvailable() && t1.appGridController != null) {
        ...
        t3.toString;
        t2.push(new A.Padding(B.EdgeInsetsDirectional_0_0_16_0, new C.AppGridDashboardIcon(t1.imagePaths, t3, t1.onShowAppDashboardAction, _null), _null));
      }
      t3 = new A.AvatarBuilder();
  ...
  (function constants() {
    ...
    D.TextStyle_69t13 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 17, B.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t15 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 20, B.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "4d53StiOQJaFQPaJbG/3hrEhIw4=");
;