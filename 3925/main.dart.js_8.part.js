...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    ...
    _HtmlContentViewerOnWebState_build___closure: function _HtmlContentViewerOnWebState_build___closure(t0) {
      this.$this = t0;
    },
  ...
  B._HtmlContentViewerOnWebState_build__closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (snapshot.data != null) {
        ...
        t3 === $ && A.throwUnnamedLateFieldNI();
        return new A.SizedBox(t3, t2, A.HtmlElementViewImpl_createFromTagName(true, new A.ValueKey(A.S(t1._html_content_viewer_on_web_widget$_htmlData) + "-" + A.S(t1._widget.key), type$.ValueKey_String), new B._HtmlContentViewerOnWebState_build___closure(t1), "iframe"), null);
      } else
        return C.SizedBox_0_0_null_null;
    },
    $signature: 1907
  };
  B._HtmlContentViewerOnWebState_build___closure.prototype = {
    call$1(element) {
      var t1, t2;
  ...
  (function inheritance() {
    ...
    _inherit(B._HtmlContentViewerOnWebState_build___closure, A.Closure);
  })();
...
})($__dart_deferred_initializers__, "ZfvPniOoVLc/dzaV2+tiVwLsO7A=");
;