...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.MaterialTextIconButton.prototype = {
    build$1(context) {
      ...
      if (t4 == null)
        t4 = B.Color_ioO0;
      return E.ElevatedButton_ElevatedButton$icon(t1, t3, _this.onTap, A.ElevatedButton_styleFrom(_null, _null, t4, _null, _null, _null, 0, _null, _null, t2, _null, _this.minimumSize, _null, _null, new A.RoundedRectangleBorder(A.BorderRadius$circular(12), B.BorderSide_KY7), _null, _null, _null, _null));
    }
  };
  ...
  C.ContactInputTagItem.prototype = {
    build$1(context) {
      ...
      t1 = A.Text$(A.EmailAddressExtension_asString(t1), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_IVQ10, _null, _null, _null, _null, _null);
      ...
      return new A.Padding(D.EdgeInsets_0_10_0_0, A.Chip$(t2, _this._contact_input_tag_item$_getTagBackgroundColor$0(), t4, t1, B.EdgeInsets_8_0_8_0, B.TextStyle_IVQ10, B.MaterialTapTargetSize_1, new C.ContactInputTagItem_build_closure(_this), t3, new A.RoundedRectangleBorder(A.BorderRadius$circular(20), _this._contact_input_tag_item$_getTagBorderSide$0()), _null), _null);
    },
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      var itemChild, _null = null,
        ...
        t8 = A._setArrayType([A.Text$(A.EmailAddressExtension_asString(t2), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_IVQ8, _null, _null, _null, _null, _null)], t7);
      t2 = t2.name;
      if ((t2 == null ? "" : t2).length !== 0)
        t8.push(new A.Padding(B.EdgeInsets_0_2_0_0, A.Text$(t4 ? "" : t3, _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_z0X3, _null, _null, _null, _null, _null), _null));
  ...
  C.UserInformationWidget.prototype = {
    build$1(context) {
      ...
      t1._bgColor = B.Color_9Sx0;
      t1._textColor = B.Color_9Sx1;
      t1._boxShadows = A._setArrayType([F.BoxShadow_vU6], type$.JSArray_BoxShadow);
      t1._avatar_builder$_size = 48;
      t1 = t1.build$0();
      t3 = type$.JSArray_Widget;
      t2 = A._setArrayType([A.SelectableText$(t2, 1, D.TextStyle_IVQ18, _null)], t3);
  ...
  C.ForwardView.prototype = {
    build$1(context) {
      ...
      if (t7.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t5, A._setArrayType([D.SettingHeaderWidget_AccountMenuItem_4_null, D.Divider_YT1], t4));
      A.Expando__checkType(_this);
  ...
  C._AutocompleteContactTextFieldWithTagsState.prototype = {
    ...
    _buildAddRecipientButton$2$maxWidth(context, maxWidth) {
      ...
      return C.MaterialTextIconButton$(B.Color_0ND, "assets/images/ic_add_identity.svg", B.Color_9Sx0, 24, D.ValueKey_button_add_recipient, t1, B.Color_9Sx0, new A.Size(maxWidth == null ? 167 : maxWidth, 54), new C._AutocompleteContactTextFieldWithTagsState__buildAddRecipientButton_closure(this, context));
    },
  ...
  C.LanguageAndRegionView.prototype = {
    build$1(context) {
      ...
      t1 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, type$.MediaQuery).data;
      if (t1.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t5, A._setArrayType([D.SettingHeaderWidget_AccountMenuItem_1_null, D.Divider_YT1], t4));
      else
  ...
  C.MailboxVisibilityView.prototype = {
    build$1(context) {
      ...
      if (t6.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t5, A._setArrayType([D.SettingHeaderWidget_AccountMenuItem_6_null, D.Divider_YT1], t4));
  ...
  C._MailBoxVisibilityFolderTileBuilderState.prototype = {
    build$1(context) {
      ...
      if (!(t4 == null || t4.$eq(0, new A.Namespace(_s8_))) && !A.PresentationMailboxExtension_hasParentId(t2))
        t3.push(A.Text$(A.PresentationMailboxExtension_get_emailTeamMailBoxes(_this._widget._mailboxNode.item), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_z0X0, _null, _null, _null, _null, _null));
  ...
  C.ManageAccountMenuView.prototype = {
    build$1(context) {
      ...
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t8).toString;
      t6.push(A.Container$(t1, E.ApplicationVersionWidget$(_null, A.Intl__message("Version", _null, "version", _null, _null).toLowerCase() + " "), B.Clip_0, B.Color_UsI, _null, _null, _null, _null, _null, _null, B.EdgeInsets_16_16_16_16, _null, _null, 1 / 0));
  ...
  C.SettingsView.prototype = {
    build$1(context) {
      var _this = this,
        t1 = $.$get$GetWidget__cache();
      A.Expando__checkType(_this);
      return A.Column$(A._setArrayType([A.SizedBox$fromSize(new A.Padding(C.SettingsUtils_getPaddingAppBar(context, A._instanceType(_this)._eval$1("GetWidget.S")._as(t1._jsWeakMap.get(_this)).responsiveUtils), _this._buildAppbar$1(context), null), D.Size_HFk), F.Divider_IG2, new A.Obx(new C.SettingsView_build_closure(_this), null), A.Expanded$(_this._bodySettingsScreen$0(), 1)], type$.JSArray_Widget), B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1);
    },
  ...
  C.IdentitiesHeaderWidget.prototype = {
    build$1(context) {
      ...
      t1 = type$.AppLocalizations;
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
      t2 = A.Text$(A.Intl__message("Identities", _null, "identities", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_IVQ19, _null, _null, _null, _null, _null);
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
  ...
  C.IdentityListTileBuilder.prototype = {
    build$1(context) {
      ...
      if ((t8 ? _null : t7._collection$_length !== 0) === true) {
        ...
        t5.push(new A.Padding(F.EdgeInsets_0_0_0_4, A.Row$(A._setArrayType([t9, B.SizedBox_4_null_null_null, A.Expanded$(A.TextOverflowBuilder$(t7 == null ? "" : t7, B.TextStyle_z0X0), 1)], t6), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), _null));
      }
  ...
  C.ProfilesView.prototype = {
    build$1(context) {
      var _null = null,
        ...
        t3 = A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, type$.MediaQuery).data;
      if (t3.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t2, A._setArrayType([D.SettingHeaderWidget_AccountMenuItem_0_null, D.Divider_YT1], t1));
  ...
  C.VacationView.prototype = {
    build$1(context) {
      ...
      if (t1.size._dx >= 1200)
        B.JSArray_methods.addAll$1(t4, A._setArrayType([D.SettingHeaderWidget_AccountMenuItem_5_null, D.Divider_YT1], t5));
  ...
  C.SettingsView__buildAppbar_closure.prototype = {
    call$0() {
      ...
      if (t3._as(t2.get(t1)).manageAccountDashboardController.settingsPageLevel.get$value(0) === B.SettingsPageLevel_0)
        ...
        t5 = A.Material$(B.Duration_200000, true, _null, A.InkWell$(false, _null, true, A.Tooltip$(A.Container$(_null, A.Row$(A._setArrayType([t8, A.Container$(_null, A.Text$(A.Intl__message("Settings", _null, "settings", _null, _null), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_4SO, _null, _null, _null, _null, _null), B.Clip_0, _null, D.BoxConstraints_oA83, _null, _null, _null, _null, B.EdgeInsetsDirectional_4_0_0_0, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_0, _null), B.Clip_0, B.Color_9Sx, _null, _null, _null, 40, _null, _null, B.EdgeInsets_4_0_4_0, _null, _null, _null), _null, t7), D.RoundedRectangleBorder_RoN13, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t5, _null, _null, _null, _null, _null, _null, _null), B.Clip_0, B.Color_9Sx, 0, _null, _null, _null, _null, _null, B.MaterialType_0);
        A.Expando__checkType(t1);
        ...
        t6.toString;
        return A.Row$(A._setArrayType([t5, A.Expanded$(A.Text$(t1.getName$1(t6), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_IVQ1, B.TextAlign_2, _null, _null, _null, _null), 1), A.Container$(_null, _null, B.Clip_0, _null, D.BoxConstraints_oA83, _null, _null, _null, _null, _null, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
      }
    },
    $signature: 4
  };
  ...
  (function constants() {
    ...
    D.BoxShadow_vU65 = new A.BoxShadow(0, B.BlurStyle_0, B.Color_cO5, B.Offset_0_8, 24);
    D.List_W7N = A._setArrayType(makeConstList([D.BoxShadow_vU65, B.BoxShadow_vU61]), type$.JSArray_BoxShadow);
    ...
    D.RoundedRectangleBorder_RoN12 = new A.RoundedRectangleBorder(B.BorderRadius_ww819, B.BorderSide_KY7);
    ...
    D.RoundedRectangleBorder_RoN13 = new A.RoundedRectangleBorder(D.BorderRadius_ww829, B.BorderSide_KY7);
    ...
    D.TextStyle_IVQ19 = new A.TextStyle(true, B.Color_9Sx1, null, null, null, null, 17, B.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_IVQ18 = new A.TextStyle(true, B.Color_9Sx1, null, null, null, null, 17, B.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "rtIcht+bMhCNVACdtYYqcM1NWmc=");
;