...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var C = {
    RuleFilterCreatorView$() {
      ...
      t3 = t3.find$1$1$tag(0, _null, type$.RulesFilterCreatorController);
      t3.$arguments = $.$get$GetNavigation__getxController().routing.args;
      return new A.RuleFilterCreatorView(t1, t2, t3, _null);
    }
  },
  A, B;
  ...
  var type$ = {
    ...
    RulesFilterCreatorController: A.findType("RulesFilterCreatorController")
  };
};

$__dart_deferred_initializers__["UuIP7i9Y36tMDcK0nlFkTYViUUY="] = $__dart_deferred_initializers__.current
