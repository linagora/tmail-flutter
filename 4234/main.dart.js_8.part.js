...
bUB(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){return new C.MZ(f,a2,l,h,g,x,k,r,t,v,u,d,w,j,i,p,m,n,s,a1,e,a0,o,q)},
MZ:function MZ(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){var _=this
_.c=d
_.d=e
_.e=f
_.f=g
...
this.c=f},
baW:function baW(){},
bXn(d){return new C.bXm(d)},
bXm:function bXm(d){this.e=d},
aKR:function aKR(d){this.a=null
this.b=d},
...
_.c=f
_.d=g},
bXq:function bXq(d,e,f,g,h,i){var _=this
_.a=d
_.b=e
_.c=f
_.d=g
...
dVA(d){var x,w,v,u,t,s,r,q,p="text/html"
...
v=w.querySelectorAll(".quote-toggle-container"+B.d.b_(" > div",s)+" > blockquote")
v.toString
t=new A.a4J(v,u);++s}r=t.$ti.c.a(B.v0.gY(t.a))
...
v=w.documentElement
v=v==null?null:J.dNz(v)
return v==null?d:v},
aiz(){if(!B.d.t(window.navigator.userAgent.toLowerCase(),"iphone"))var x=B.d.t(window.navigator.userAgent.toLowerCase(),"android")&&B.d.t(window.navigator.userAgent.toLowerCase(),"mobile")
else x=!0
return x},
aiA(){if(!B.d.t(window.navigator.userAgent.toLowerCase(),"ipad"))var x=B.d.t(window.navigator.userAgent.toLowerCase(),"android")&&!B.d.t(window.navigator.userAgent.toLowerCase(),"mobile")
else x=!0
return x}},D
J=c[1]
A=c[0]
...
w.f=x.d
w.y=x.cy
if(!C.aiz()&&!C.aiA()){x=w.a.fy
w.as=new C.aKR(x)}w.asB()
x=window
x.toString
x=A.jt(x,"message",w.gbdw(),!1,y._)
w.z!==$&&A.cE()
w.z=x},
bdx(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{x=B.aD.hh(0,new A.RN([],[]).NR(d.data,!0))
w=J.ah(x,"view")
t=n.d
t===$&&A.d()
if(!J.t(w,t))return
...
t.toString
n.bd0(x,t)
return}else{if(n.gatf()){t=v
t=(t==null?m:B.d.t(t,"toDart: onScrollEnd"))===!0}else t=!1
if(t){t=n.a.ay
t.toString
s=J.ah(x,"velocity")
r=J.dpl(s==null?0:s,800)
q=t.f
p=B.c.gbn(q).at
p.toString
t.iN(B.j.fc(p+r,B.c.gbn(q).geR(),B.c.gbn(q).geb()),B.fu,B.hJ)
return}else{t=v
q=n.a
...
if(t){n.beb(x)
return}else{t=v
if((t==null?m:B.d.t(t,"toDart: iframeLinkHover"))===!0){n.bed(x)
return}else{t=v
if((t==null?m:B.d.t(t,"toDart: iframeLinkOut"))===!0){n.bee(x)
return}}}}}}if(J.t(J.ah(x,"message"),"iframeHasBeenLoaded"))n.Q=!0
if(!n.Q)return
t=v
if((t==null?m:B.d.t(t,"toDart: htmlHeight"))===!0)n.bbd(J.ah(x,"height"))
else{t=v
t=(t==null?m:B.d.t(t,"toDart: htmlWidth"))===!0
if(t)n.a.toString
if(t)n.bbe(J.ah(x,"width"))
else{t=v
...
gatf(){var x=this.a.ay
if(x!=null)x=x.f.length!==0===!0
else x=!1
return x},
bd0(d,e){var x,w,v,u,t,s,r,q
try{t=J.ah(d,"deltaY")
x=t==null?0:t
s=e.f
r=B.c.gbn(s).at
...
w=r+x
r=C.aiz()||C.aiA()
if(r){v=J.a6Z(w,B.c.gbn(s).geR(),B.c.gbn(s).geb())
e.iN(v,B.af,B.on)}else if(w<B.c.gbn(s).geR())e.ie(B.c.gbn(s).geR())
...
bbd(d){var x,w,v,u,t,s,r=this
if(d==null){x=r.e
x===$&&A.d()
w=x}else w=d
x=r.c
if(x!=null){v=J.ayh(w,r.a.dx)
...
s=u.nj(v,t)}if(s)r.W(new C.cX7(r,v))}if(r.c!=null&&r.x)r.W(new C.cX8(r))},
bbe(d){var x,w,v=this
if(d==null){x=v.f
x===$&&A.d()
w=x}else w=d
if(v.c!=null&&J.dpk(w,v.a.db)&&v.a.at)v.W(new C.cX9(v,w))},
bec(d){var x,w,v,u
try{v=J.al(d)
x=new C.Z_(A.aJ(v.j(d,"key")),A.aJ(v.j(d,"code")),J.t(v.j(d,"shift"),!0))
...
bed(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
...
t=n.c
if(t!=null){r=n.as
if(r!=null)r.akj(0,t,x,v)}}}catch(o){u=A.N(o)
...
u(d){var x=this
x.w5(d)
if(x.a.fr)return x.anl()
else return A.eM(new C.cXa(x))},
anl(){var x,w=this,v=null,u=A.E(w).l(0),t=w.e
t===$&&A.d()
A.x(u+"::_buildHtmlElementView: ActualHeight: "+A.e(t),B.f)
t=A.c([],y.p)
u=w.w
if((u==null?v:B.d.aC(u).length!==0)===!0)t.push(A.Xb(new C.cX6(w),w.r,y.y))
if(w.x)t.push(D.a41)
...
x===$&&A.d()
x.al(0)
if(!C.aiz()&&!C.aiA()){x=w.as
if(x!=null)x.f8()
w.as=null}w.av()},
grG(){return this.a.cx}}
C.awA.prototype={
an(){this.aE()
if(this.a.cx)this.uG()},
iD(){var x=this.ed$
if(x!=null){x.aP()
x.i5()
this.ed$=null}this.oT()}}
C.Z_.prototype={
aHk(d,e,f){return this.a.toLowerCase()===e.toLowerCase()&&this.c===f},
zO(d,e){return this.aHk(0,e,!1)},
gv(){return[this.a,this.b,this.c]}}
C.baW.prototype={}
C.bXm.prototype={}
C.aKR.prototype={
akj(d,e,f,g){var x,w,v,u,t,s,r,q,p,o,n=this,m={}
if(n.a!=null){n.f8()
A.ad5(new C.bXp(n,e,f,g),y.P)
return}x=A.p5(e,y.u)
if(x==null)return
w=e.gaj()
v=g.hq(w instanceof A.a5?A.dd(w.ck(0,null),B.r):B.r)
u=y.w
t=A.M(e,B.v,u).w.a.a
u=A.M(e,B.v,u).w
s=t<400?t-24:400
...
m=A.lZ(new C.bXq(m,n,q,p,s,f),!1,!1,!1)
n.a=m
x.nR(0,m)},
f8(){var x=this.a
if(x!=null)x.ev(0)
this.a=null}}
var z=a.updateTypes(["~(vS)","~()"])
C.cX7.prototype={
$0(){var x=this.a
x.e=this.b
x.x=!1},
...
w=A.dtI(!0,new A.b8(A.e(x.w)+"-"+A.e(x.a.a),y.O),new C.cX5(x),"iframe")
v=x.a.dy
u=x.e
x=x.f
if(v!=null){u===$&&A.d()
...
C.bXp.prototype={
$0(){var x=this,w=x.b
if(w.e!=null)x.a.akj(0,w,x.c,x.d)},
$S:8}
C.bXq.prototype={
$1(d){var x=this,w=null,v=x.b,u=A.iM(0,A.cJ(B.bR,w,B.M,!1,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,v.gxi(),w,w,w,w,w,w,w,w,!1,B.a3),w),t=x.a.a,s=A.c([new A.bY(0,B.V,B.n.au(0.15),B.r,20)],y.V)
v=v.b.e
if(v==null)v=D.aY3
return A.dkY(new C.bXo(x.c),new A.ct(B.a5,w,B.a0,B.F,A.c([u,A.kr(w,A.cR(A.ch(B.D,!0,B.lw,A.a7(w,A.ac(x.f,w,1,B.C,w,w,v,w,w,w),B.k,w,new A.ar(0,x.e,28,1/0),new A.b7(B.n,w,w,B.lw,s,w,w,B.A),w,w,w,w,B.mc,w,w,w),B.k,w,0,w,w,w,w,w,B.az)),w,t,x.d,w)],y.p),w),B.hF,B.y9,new A.bD(0,1,y.t),y.i)},
$S:405}
C.bXo.prototype={
$3(d,e,f){var x=this.a?-1:1
return A.mC(A.b03(f,new A.H(0,x*(1-e)*8)),null,e)},
$S:436};(function aliases(){var x=C.awA.prototype
x.aYl=x.an})();(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
x(C.arN.prototype,"gbdw","bdx",0)
w(C.aKR.prototype,"gxi","f8",1)})();(function inheritance(){var x=a.mixinHard,w=a.mixin,v=a.inherit,u=a.inheritMany
v(C.MZ,A.ae)
v(C.awA,A.ab)
v(C.arN,C.awA)
u(A.vf,[C.cX7,C.cX8,C.cX9,C.bXp])
u(A.vg,[C.cXa,C.cX6])
u(A.oP,[C.cX5,C.bXq,C.bXo])
u(A.a6,[C.baW,C.bXm,C.aKR])
v(C.Z_,C.baW)
x(C.awA,A.r1)
w(C.baW,A.j)})()
A.DW(b.typeUniverse,JSON.parse('{"MZ":{"ae":[],"i":[]},"arN":{"ab":["MZ"]},"Z_":{"j":[]}}'))
var y=(function rtii(){var x=A.as
return{v:x("FE"),V:x("O<bY>"),s:x("O<h>"),p:x("O<i>"),w:x("no"),_:x("vS"),P:x("b4"),u:x("GE"),t:x("bD<aq>"),O:x("b8<h>"),N:x("a4J<lf>"),y:x("C"),i:x("aq")}})();(function constants(){D.aTm=new A.b_(30,30,B.rx,null)
D.aLk=new A.X(B.ck,D.aTm,null)
D.a41=new A.dH(B.cS,null,null,D.aLk,null)
D.aY3=new A.ai(!0,B.m,null,null,null,null,13,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_8",e:"endPart",h:b})})($__dart_deferred_initializers__,"rJhbjFLZRiyoCpMRBdGCtBtgbYU=");