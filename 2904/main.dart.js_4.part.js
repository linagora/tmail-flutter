...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    ...
    NavigationBarWidget$(appGridController, onShowAppDashboardAction, onTapApplicationLogoAction, onTapAvatarAction, searchForm, userProfile) {
      return new B.NavigationBarWidget(userProfile, searchForm, appGridController, onTapApplicationLogoAction, onShowAppDashboardAction, onTapAvatarAction, null);
    },
  ...
  B._ApplicationVersionWidgetState.prototype = {
    initState$0() {
      ...
      this._versionStream = this._applicationManager.getVersion$0();
    },
    build$1(context) {
  ...
  B.UserInformationWidget.prototype = {
    build$1(context) {
      ...
      if (_this.subtitle != null) {
        ...
        A.Localizations_of(context, C.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t3.push(new A.Padding(D.EdgeInsetsDirectional_0_10_0_0, A.Transform$(_null, B.MaterialTextButton$(20, F.TextStyle_kmC0, A.Intl__message("Manage account", _null, "manage_account", _null, _null), _null, 15, _null, _null, _this.onSubtitleClick, _null, C.EdgeInsetsDirectional_8_8_8_8, _null), _null, t5, true), _null));
      }
    ...
    build$1(context) {
      ...
      if ((t3 == null ? _null : t3.length !== 0) === true) {
        ...
        if (C.JSString_methods.endsWith$1(t3, "svg"))
          t3 = A.SvgPicture$asset(t4, C.Alignment_0_0, _null, C.BoxFit_0, 42, _null, 42);
        else
  ...
  B.AppDashboardOverlay.prototype = {
    build$1(context) {
      ...
      return A.GestureDetector$(_null, A.Container$(_null, A.Wrap$(C.WrapAlignment_0, A.List_List$of(new A.MappedListIterable(t4, new B.AppDashboardOverlay_build_closure(), t5), true, t5._eval$1("ListIterable.E")), C.WrapCrossAlignment_0, C.WrapAlignment_0, 0, 0), C.Clip_0, _null, _null, new A.BoxDecoration(C.Color_4294967295, _null, _null, t2, t3, _null, _null, C.BoxShape_0), _null, _null, _null, _null, D.EdgeInsetsDirectional_10_14_10_14, _null, _null, t1), C.DragStartBehavior_1, false, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new B.AppDashboardOverlay_build_closure0(), _null, _null, _null, _null, _null, _null, _null, false, C.Offset_O5r);
    },
    get$_widthAppGrid() {
  ...
  B.NavigationBarWidget.prototype = {
    build$1(context) {
      var t3, t4, _this = this, _null = null,
        ...
        t2 = A._setArrayType([new A.SizedBox(226, _null, A.Row$(A._setArrayType([E.ApplicationLogoWidthTextWidget$(_this.onTapApplicationLogoAction), D.ApplicationVersionWidget_null_null], t1), C.CrossAxisAlignment_2, _null, C.MainAxisAlignment_0, C.MainAxisSize_0, _null), _null)], t1);
      if (_this.searchForm != null)
        ...
        t4 = _this.userProfile;
        t4 = t4 == null ? _null : t4.email[0].toUpperCase();
        t3._avatar_builder$_text = t4 == null ? "" : t4;
        ...
        t3._boxShadows = A._setArrayType([D.BoxShadow_oyn], type$.JSArray_BoxShadow);
        t1.push(t3.build$0());
  ...
  B._ApplicationVersionWidgetState_build_closure.prototype = {
    call$2(context, snapshot) {
      ...
      if (t1 != null) {
        ...
        if (t3 == null)
          t3 = D.EdgeInsetsDirectional_2_12_0_0;
        t1 = A.S(t1);
        t2._widget.toString;
        t2 = A.Theme_of(context).textTheme.labelMedium;
        t2 = t2 == null ? _null : t2.copyWith$3$color$fontSize$fontWeight(C.Color_4285364357, 12, C.FontWeight_4_500);
        return new A.Padding(t3, A.Text$("v." + t1, _null, _null, 1, C.TextOverflow_2, _null, _null, _null, _null, t2, _null, _null, _null, _null, _null), _null);
      } else
        return C.SizedBox_0_0_null_null;
    },
    $signature: 1693
  ...
  B.AppGridDashboardIcon_build_closure.prototype = {
    call$0() {
      var t4, t5, _null = null,
        ...
        t3 = t2.isAppGridDashboardOverlayOpen,
        isAppGridOpen = t3.get$value(t3);
      t2 = A.GestureDetector$(C.HitTestBehavior_1, _null, C.DragStartBehavior_1, false, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t2.get$toggleAppGridDashboard(), _null, _null, _null, _null, _null, _null, _null, false, C.Offset_O5r);
      t3 = this.context;
      t4 = type$._LocalizationsScope;
      t5 = t3.dependOnInheritedWidgetOfExactType$1$0(t4).localizationsState._localizations$_locale;
      t5 = A.Bidi_isRtlLanguage(t5.get$languageCode(t5)) ? C.Alignment_m1_m1 : C.Alignment_1_m1;
      t3 = t3.dependOnInheritedWidgetOfExactType$1$0(t4).localizationsState._localizations$_locale;
      t3 = A.Bidi_isRtlLanguage(t3.get$languageCode(t3)) ? C.Alignment_m1_1 : D.Alignment_1_1;
  ...
  B.AppGridDashboardIcon_build__closure.prototype = {
    call$0() {
      var t1 = this.$this.appGridController.linagoraApplications,
        listApps = t1.get$value(t1);
  ...
  (function constants() {
    ...
    D.ApplicationVersionWidget_null_null = new B.ApplicationVersionWidget(null, null);
    ...
    D.EdgeInsetsDirectional_2_12_0_0 = new A.EdgeInsetsDirectional(2, 12, 0, 0);
...
})($__dart_deferred_initializers__, "/uTbhhnHtR7W3p3piFrAyav/puw=");
;