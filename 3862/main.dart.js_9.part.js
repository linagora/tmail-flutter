...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.BorderButtonField.prototype = {
    build$1(context) {
      ...
      t1 = A.Column$(A._setArrayType([A.Text$(_this.label, _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null), B.SizedBox_null_8_null_null, buttonField], t4), B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1);
      return t1;
    },
    _getTextStyle$1(value) {
      var t1;
      if (value == null)
        return B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4289311938, 16, B.FontWeight_3_400);
      t1 = B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 16, B.FontWeight_3_400);
      return t1;
    },
  ...
  C.MaterialTextIconButton.prototype = {
    build$1(context) {
      ...
      t2 = _this.labelColor;
      t3 = B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(t2 == null ? B.Color_4278221567 : t2, 16, B.FontWeight_4_500);
  ...
  C.TextInputFieldBuilder.prototype = {
    build$1(context) {
      ...
      B.JSArray_methods.addAll$1(t2, A._setArrayType([A.Text$(_this.label, _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null), B.SizedBox_null_8_null_null], t1));
      t1 = B.TextStyle_cJC.copyWith$2$color$fontSize(B.Color_4278190080, 16);
      ...
      t4 = B.TextStyle_cJC.copyWith$2$color$fontSize(B.Color_4278190080, 16);
      t5 = B.TextStyle_cJC.copyWith$2$color$fontSize(B.Color_4286680217, 16);
      t6 = B.TextStyle_cJC.copyWith$2$color$fontSize(B.Color_4293281350, 13);
  ...
  C.ContactInputTagItem.prototype = {
    build$1(context) {
      ...
      t1 = A.Text$(A.EmailAddressExtension_asString(t1), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null);
      ...
      t5 = B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 14, B.FontWeight_3_400);
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      var itemChild, _null = null,
        ...
        t8 = A._setArrayType([A.Text$(A.EmailAddressExtension_asString(t2), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 16, B.FontWeight_4_500), _null, _null, _null, _null, _null)], t7);
      t2 = t2.name;
      if ((t2 == null ? "" : t2).length !== 0) {
        t2 = t4 ? "" : t3;
        t8.push(new A.Padding(B.EdgeInsets_0_2_0_0, A.Text$(t2, _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4286680217, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null), _null));
      }
  ...
  C.UserInformationWidget.prototype = {
    build$1(context) {
      var _null = null,
        t1 = this.userName,
        t2 = B.TextStyle_C3G.copyWith$4$color$fontSize$height$letterSpacing(B.Color_4294967295, 25.5, 1.5019607843137255, 0.24),
        t3 = type$.JSArray_Widget,
        t4 = A._setArrayType([A.SelectableText$(t1, 1, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 17, B.FontWeight_5_600), _null)], t3);
      return A.Container$(_null, A.Row$(A._setArrayType([new A.UserAvatarBuilder(t1, 51, t2, _null, _null, _null), B.SizedBox_16_null_null_null, A.Expanded$(A.Column$(t4, B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1), 1), B.SizedBox_16_null_null_null], t3), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), B.Clip_0, _null, _null, new A.BoxDecoration(_null, _null, _null, _null, _null, _null, _null, B.BoxShape_0), _null, _null, _null, _null, this.padding, _null, _null, _null);
    }
  };
  ...
  C.EmailRulesItemWidget.prototype = {
    build$1(context) {
      var _this = this, _null = null,
        ...
        t4 = A._setArrayType([A.Text$(_this.rule.name, _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 16, B.FontWeight_3_400), _null, _null, _null, _null, _null), B.Spacer_null], type$.JSArray_Widget);
      if (!(A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, t1).data.size._dx < 600))
  ...
  C.EmailForwardItemWidget.prototype = {
    build$1(context) {
      ...
      if ((t2 == null ? "" : t2).length !== 0) {
        t2 = t8 ? "" : t7;
        t6.push(new A.Padding(B.EdgeInsets_0_4_0_0, A.Text$(t2, _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null), _null));
      }
    ...
    _buildAvatarIcon$1(imagePaths) {
      ...
      if (t1.selectMode === B.SelectMode_0)
        ...
        t2._avatar_builder$_textStyle = B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4294967295, 16, B.FontWeight_4_500);
        t1 = t1.email;
  ...
  C.ChangeLanguageButtonWidget.prototype = {
    ...
    _buildTitleLanguageWidget$1(context) {
      var _null = null;
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, type$.AppLocalizations).toString;
      return A.Text$(A.Intl__message("Language", _null, "language", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null);
    },
  ...
  C._MailBoxVisibilityFolderTileBuilderState.prototype = {
    build$1(context) {
      ...
      if (!(t4 == null || t4.$eq(0, new A.Namespace(_s8_))) && !A.PresentationMailboxExtension_hasParentId(t2))
        t3.push(A.Text$(A.PresentationMailboxExtension_get_emailTeamMailBoxes(_this._widget._mailboxNode.item), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4286680217, 13, B.FontWeight_3_400), _null, _null, _null, _null, _null));
  ...
  C.SettingFirstLevelTileBuilder.prototype = {
    build$1(context) {
      ...
      if (t4 != null) {
        ...
        t4 = new A.Padding(new A.EdgeInsets(t6, 12, t7, 0), A.Text$(t4, _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 13, B.FontWeight_3_400), _null, _null, _null, _null, _null), _null);
      } else
  ...
  C.IdentitiesHeaderWidget.prototype = {
    build$1(context) {
      ...
      t1 = type$.AppLocalizations;
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
      t2 = A.Text$(A.Intl__message("Identities", _null, "identities", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 17, B.FontWeight_4_500), _null, _null, _null, _null, _null);
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
      t3 = A.Text$(A.Intl__message("Select the identity or email address you want to use to send an emails", _null, "identitiesSettingExplanation", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4286680217, 15, B.FontWeight_3_400), _null, _null, _null, _null, _null);
      A.Localizations_of(context, B.Type_AppLocalizations_CTL, t1).toString;
  ...
  C.IdentityListTileBuilder.prototype = {
    build$1(context) {
      ...
      t5 = A._setArrayType([new A.Padding(D.EdgeInsets_0_0_0_6, A.TextOverflowBuilder$(t5, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 16, B.FontWeight_4_500)), _null)], t6);
      t7 = t4.email;
  ...
  C.VacationView.prototype = {
    ...
    _buildListButtonAction$1(context) {
      ...
      if (t4.size._dx >= 1200) {
        A.Localizations_of(context, B.Type_AppLocalizations_CTL, type$.AppLocalizations).toString;
        return new A.Align(B.Alignment_1_0, _null, _null, A.buildTextButton(A.Intl__message(_s12_, _null, _s11_, _null, _null), _null, 44, new C.VacationView__buildListButtonAction_closure(_this, context), 10, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4294967295, 16, B.FontWeight_3_400), 156), _null);
      } else {
        A.Expando__checkType(_this);
        t2._as(t1.get(_this)).toString;
        ...
        if (t1) {
          A.Localizations_of(context, B.Type_AppLocalizations_CTL, t2).toString;
          t1 = A.Expanded$(A.buildTextButton(A.Intl__message("Cancel", _null, "cancel", _null, _null), B.Color_218111037, 44, new C.VacationView__buildListButtonAction_closure0(_this, context), 10, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278221567, 17, B.FontWeight_4_500), 156), 1);
          A.Localizations_of(context, B.Type_AppLocalizations_CTL, t2).toString;
          ...
          A.Localizations_of(context, B.Type_AppLocalizations_CTL, t2).toString;
          t1 = A.buildTextButton(A.Intl__message("Cancel", _null, "cancel", _null, _null), B.Color_218111037, 44, new C.VacationView__buildListButtonAction_closure2(_this, context), 10, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278221567, 17, B.FontWeight_4_500), 156);
          A.Localizations_of(context, B.Type_AppLocalizations_CTL, t2).toString;
  ...
  C.ListEmailForwardsWidget__buildTitleHeader_closure.prototype = {
    call$0() {
      ...
      if (t5._as(t4.get(t3)).selectionMode.get$value(0) === B.SelectMode_0) {
        ...
        t2.push(new A.Padding(B.EdgeInsets_0_0_8_0, A.Row$(A._setArrayType([t9, A.Text$(t6, _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278221567, 15, B.FontWeight_3_400), _null, _null, _null, _null, _null)], t1), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_0, _null), _null));
      }
      A.Expando__checkType(t3);
      if (!t5._as(t4.get(t3)).get$isAllSelected()) {
        A.Expando__checkType(t3);
  ...
  C.SettingsView__buildAppbar_closure.prototype = {
    call$0() {
      ...
      if (t3._as(t2.get(t1)).manageAccountDashboardController.settingsPageLevel.get$value(0) === B.SettingsPageLevel_0)
        ...
        A.Localizations_of(t4, B.Type_AppLocalizations_CTL, t6).toString;
        t9 = type$.JSArray_Widget;
        t5 = A.Material$(B.Duration_200000, true, _null, A.InkWell$(false, _null, true, A.Tooltip$(A.Container$(_null, A.Row$(A._setArrayType([t8, A.Container$(_null, A.Text$(A.Intl__message("Settings", _null, "settings", _null, _null), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$2$color$fontSize(B.Color_4278221567, 17), _null, _null, _null, _null, _null), B.Clip_0, _null, D.BoxConstraints_oA83, _null, _null, _null, _null, B.EdgeInsetsDirectional_4_0_0_0, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_0, _null), B.Clip_0, B.Color_0, _null, _null, _null, 40, _null, _null, B.EdgeInsets_4_0_4_0, _null, _null, _null), _null, t7), D.RoundedRectangleBorder_NYu13, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t5, _null, _null, _null, _null, _null, _null, _null), B.Clip_0, B.Color_0, 0, _null, _null, _null, _null, _null, B.MaterialType_0);
        A.Expando__checkType(t1);
        ...
        t6.toString;
        return A.Row$(A._setArrayType([t5, A.Expanded$(A.Text$(t1.getName$1(t6), _null, _null, 1, B.TextOverflow_2, _null, _null, true, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4278190080, 20, B.FontWeight_6_700), B.TextAlign_2, _null, _null, _null, _null), 1), A.Container$(_null, _null, B.Clip_0, _null, D.BoxConstraints_oA83, _null, _null, _null, _null, _null, _null, _null, _null, _null)], t9), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
      }
    },
    $signature: 4
  };
  ...
  C.NotificationView_build_closure.prototype = {
    call$0() {
      ...
      t5 = type$.AppLocalizations;
      A.Localizations_of(t4, B.Type_AppLocalizations_CTL, t5).toString;
      t6 = A.Text$(A.Intl__message("Show Notifications", _null, "showNotifications", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$4$color$fontSize$fontWeight$height(B.Color_4278190080, 17, B.FontWeight_4_500, 1.2941176470588236), _null, _null, _null, _null, _null);
      A.Localizations_of(t4, B.Type_AppLocalizations_CTL, t5).toString;
      t5 = type$.JSArray_Widget;
      t6 = A.Expanded$(A.Column$(A._setArrayType([B.SizedBox_null_10_null_null, t6, B.SizedBox_null_12_null_null, A.Text$(A.Intl__message("Allows Twake Mail to notify you when a new message arrives on your phone", _null, "allowsTwakeMailToNotifyYouWhenANewMessageArrivesOnYourPhone", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$height(B.Color_4286680217, 15, 1.3333333333333333), _null, _null, _null, _null, _null)], t5), B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1), 1);
      A.Expando__checkType(t1);
  ...
  C.VacationView_build_closure4.prototype = {
    call$0() {
      ...
      t7 = A.Text$(A.Intl__message("Message", _null, "message", _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, B.TextStyle_cJC.copyWith$3$color$fontSize$fontWeight(B.Color_4285364357, 14, B.FontWeight_3_400), _null, _null, _null, _null, _null);
  ...
  (function constants() {
    ...
    D.List_B6x3 = A._setArrayType(makeConstList([D.BoxShadow_NMc39, B.BoxShadow_NMc2]), A.findType("JSArray<BoxShadow>"));
...
})($__dart_deferred_initializers__, "OGV/hGCDJebxq4I5qLpNeqwBfQg=");
;