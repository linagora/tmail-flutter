  ...
  group('capability_validator_test', () {
    test('when session missing one capability exception should throw', () {
      final session = Session(
          {
            CapabilityIdentifier.jmapSubmission:
                SubmissionCapability(UnsignedInt(0), Set()),
            ...
            CapabilityIdentifier(
                ...
                DefaultCapability(Map<String, dynamic>()),
            CapabilityIdentifier(
      ...
      expect(
        ...
        throwsA(TypeMatcher<SessionMissingCapability>()));
    });

    test('when session have all required capabilities exception should throw', () {
      final session = Session(
          {
            CapabilityIdentifier.jmapSubmission:
            SubmissionCapability(UnsignedInt(0), Set()),
