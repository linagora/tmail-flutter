...
c_k(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){return new C.Oo(f,a2,l,h,g,x,k,r,t,v,u,d,w,j,i,p,m,n,s,a1,e,a0,o,q)},
Oo:function Oo(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){var _=this
_.c=d
_.d=e
_.e=f
_.f=g
...
this.c=f},
bfe:function bfe(){},
c29(d){return new C.c28(d)},
c28:function c28(d){this.e=d},
aNU:function aNU(d){this.a=null
this.b=d},
...
_.c=f
_.d=g},
c2c:function c2c(d,e,f,g,h,i){var _=this
_.a=d
_.b=e
_.c=f
_.d=g
...
e6C(d){var x,w,v,u,t,s,r,q,p="text/html"
if(!(B.d.q(d,$.dSR())&&B.d.q(d,$.dSQ())))return d
...
v=w.querySelectorAll(".quote-toggle-container"+B.d.b7(" > div",s)+" > blockquote")
v.toString
t=new A.a6I(v,u);++s}r=t.$ti.c.a(B.vi.gY(t.a))
...
w.f=x.d
w.y=x.cy
if(!A.a1x()&&!A.a1y()){x=w.a.fy
w.as=new C.aNU(x)}w.av1()
x=window
x.toString
x=A.jc(x,"message",w.gbhz(),!1,y._)
w.z!==$&&A.cN()
w.z=x},
bhA(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{x=B.aE.h3(0,new A.Tq([],[]).P5(d.data,!0))
w=J.ad(x,"view")
t=n.d
t===$&&A.d()
if(!J.u(w,t))return
...
t.toString
n.bh5(x,t)
return}else{if(n.gavK()){t=v
t=(t==null?m:B.d.q(t,"toDart: onScrollEnd"))===!0}else t=!1
if(t){t=n.a.ay
t.toString
s=J.ad(x,"velocity")
r=J.dz9(s==null?0:s,800)
q=t.f
p=B.c.gbs(q).at
p.toString
t.iW(B.j.eY(p+r,B.c.gbs(q).geW(),B.c.gbs(q).gel()),B.fw,B.hP)
return}else{t=v
q=n.a
...
if(t){n.bie(x)
return}else{t=v
if((t==null?m:B.d.q(t,"toDart: iframeLinkHover"))===!0){n.bih(x)
return}else{t=v
if((t==null?m:B.d.q(t,"toDart: iframeLinkOut"))===!0){n.bii(x)
return}}}}}}if(J.u(J.ad(x,"message"),"iframeHasBeenLoaded"))n.Q=!0
if(!n.Q)return
t=v
if((t==null?m:B.d.q(t,"toDart: htmlHeight"))===!0)n.bfh(J.ad(x,"height"))
else{t=v
t=(t==null?m:B.d.q(t,"toDart: htmlWidth"))===!0
if(t)n.a.toString
if(t)n.bfi(J.ad(x,"width"))
else{t=v
...
gavK(){var x=this.a.ay
if(x!=null)x=x.f.length!==0===!0
else x=!1
return x},
bh5(d,e){var x,w,v,u,t,s,r,q
try{t=J.ad(d,"deltaY")
x=t==null?0:t
s=e.f
r=B.c.gbs(s).at
...
w=r+x
r=A.a1x()||A.a1y()
if(r){v=J.a95(w,B.c.gbs(s).geW(),B.c.gbs(s).gel())
e.iW(v,B.af,B.oI)}else if(w<B.c.gbs(s).geW())e.ir(B.c.gbs(s).geW())
else if(w>B.c.gbs(s).gel())e.ir(B.c.gbs(s).gel())
else e.ir(w)}catch(q){u=A.N(q)
A.y(A.I(this).l(0)+"::_handleIframeOnScrollChangedListener:Exception = "+A.e(u),null,null,B.w,null,!1)}},
bfh(d){var x,w,v,u,t,s,r=this
if(d==null){x=r.e
x===$&&A.d()
w=x}else w=d
x=r.c
if(x!=null){v=J.aAE(w,r.a.dx)
...
s=u.nI(v,t)}if(s)r.W(new C.d4w(r,v))}if(r.c!=null&&r.x)r.W(new C.d4x(r))},
bfi(d){var x,w,v=this
if(d==null){x=v.f
x===$&&A.d()
w=x}else w=d
if(v.c!=null&&J.dz8(w,v.a.db)&&v.a.at)v.W(new C.d4y(v,w))},
bif(d){var x,w,v,u,t=null
try{v=J.an(d)
x=new C.a_M(A.aM(v.j(d,"key")),A.aM(v.j(d,"code")),J.u(v.j(d,"shift"),!0))
...
bih(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
...
t=n.c
if(t!=null){r=n.as
if(r!=null)r.amF(0,t,x,v)}}}catch(o){u=A.N(o)
...
t(d){var x=this
x.wN(d)
if(x.a.fr)return x.apK()
else return A.eN(new C.d4z(x))},
apK(){var x,w=this,v=null,u=A.I(w).l(0),t=w.e
t===$&&A.d()
A.y(u+"::_buildHtmlElementView: ActualHeight: "+A.e(t),v,v,B.f,v,!1)
t=A.c([],y.p)
u=w.w
if((u==null?v:B.d.ak(u).length!==0)===!0)t.push(A.YS(new C.d4v(w),w.r,y.y))
if(w.x)t.push(D.a4Q)
...
C.a_M.prototype={
aK3(d,e,f){return this.a.toLowerCase()===e.toLowerCase()&&this.c===f},
AI(d,e){return this.aK3(0,e,!1)},
gA(){return[this.a,this.b,this.c]}}
C.bfe.prototype={}
C.c28.prototype={}
C.aNU.prototype={
amF(d,e,f,g){var x,w,v,u,t,s,r,q,p,o,n=this,m={}
if(n.a!=null){n.eB()
A.afa(new C.c2b(n,e,f,g),y.P)
return}x=A.pA(e,y.u)
if(x==null)return
w=e.gaj()
v=g.hA(w instanceof A.a7?A.df(w.cq(0,null),B.r):B.r)
u=y.w
t=A.O(e,B.v,u).w.a.a
u=A.O(e,B.v,u).w
s=t<400?t-24:400
...
m=A.lJ(new C.c2c(m,n,q,p,s,f),!1,!1,!1)
n.a=m
x.nu(0,m)},
eB(){var x=this.a
if(x!=null)x.ea(0)
this.a=null}}
var z=a.updateTypes(["~(wp)","~()"])
C.d4w.prototype={
$0(){var x=this.a
x.e=this.b
x.x=!1},
...
w=A.dDx(!0,new A.ba(A.e(x.w)+"-"+A.e(x.a.a),y.O),new C.d4u(x),"iframe")
v=x.a.dy
u=x.e
x=x.f
if(v!=null){u===$&&A.d()
...
C.c2b.prototype={
$0(){var x=this,w=x.b
if(w.e!=null)x.a.amF(0,w,x.c,x.d)},
$S:8}
C.c2c.prototype={
$1(d){var x=this,w=null,v=x.b,u=A.j3(0,A.cS(B.bO,w,B.M,!1,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,v.gqK(),w,w,w,w,w,w,w,w,!1,B.a3),w),t=x.a.a,s=A.c([new A.c1(0,B.U,B.n.aC(0.15),B.r,20)],y.V)
v=v.b.e
if(v==null)v=D.aZF
return A.dur(new C.c2a(x.c),new A.ct(B.a5,w,B.a0,B.F,A.c([u,A.k0(w,A.cP(A.cf(B.C,!0,B.lH,A.a8(w,A.ag(x.f,w,1,B.A,w,w,v,w,w,w),B.k,w,new A.as(0,x.e,28,1/0),new A.b7(B.n,w,w,B.lH,s,w,w,B.B),w,w,w,w,B.mm,w,w,w),B.k,w,0,w,w,w,w,w,B.aw)),w,t,x.d,w)],y.p),w),B.hL,B.yx,new A.bJ(0,1,y.t),y.i)},
$S:408}
C.c2a.prototype={
$3(d,e,f){var x=this.a?-1:1
return A.mW(A.b45(f,new A.K(0,x*(1-e)*8)),null,e)},
$S:410};(function aliases(){var x=C.ayU.prototype
x.b0S=x.av})();(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
x(C.atZ.prototype,"gbhz","bhA",0)
w(C.aNU.prototype,"gqK","eB",1)})();(function inheritance(){var x=a.mixinHard,w=a.mixin,v=a.inherit,u=a.inheritMany
v(C.Oo,A.ah)
v(C.ayU,A.ae)
v(C.atZ,C.ayU)
u(A.vP,[C.d4w,C.d4x,C.d4y,C.c2b])
u(A.vQ,[C.d4z,C.d4v])
u(A.pg,[C.d4u,C.c2c,C.c2a])
u(A.a3,[C.bfe,C.c28,C.aNU])
v(C.a_M,C.bfe)
x(C.ayU,A.rv)
w(C.bfe,A.p)})()
A.EQ(b.typeUniverse,JSON.parse('{"Oo":{"ah":[],"j":[],"k":[]},"atZ":{"ae":["Oo"]},"a_M":{"p":[]}}'))
var y=(function rtii(){var x=A.at
return{v:x("GA"),V:x("P<c1>"),s:x("P<f>"),p:x("P<j>"),w:x("nN"),_:x("wp"),P:x("b2"),u:x("HH"),t:x("bJ<ar>"),O:x("ba<f>"),N:x("a6I<ih>"),y:x("B"),i:x("ar")}})();(function constants(){D.aUY=new A.b1(30,30,B.rN,null)
D.aML=new A.a_(B.cn,D.aUY,null)
D.a4Q=new A.dU(B.cX,null,null,D.aML,null)
D.aZF=new A.am(!0,B.m,null,null,null,null,13,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"eVn","dSR",()=>A.b6("<[a-zA-Z][^>\\s]*[^>]*>",!0,!1,!1,!1))
x($,"eVm","dSQ",()=>A.b6("</[a-zA-Z][^>]{0,128}>",!0,!1,!1,!1))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_8",e:"endPart",h:b})})($__dart_deferred_initializers__,"iYbBsYUbAyK2se1PXv9zmQXiGhM=");