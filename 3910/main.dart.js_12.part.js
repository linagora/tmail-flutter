...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B.DownloadAttachmentLoadingBar.prototype = {
    build$1(context) {
      ...
      if (t1 instanceof A.StartDownloadAttachmentForWeb)
        return D.LinearProgressIndicator_EyN;
      if (t1 instanceof A.DownloadingAttachmentForWeb)
        return A.LinearPercentIndicator$(C.Color_wPs, C.Radius_1_1, 5, C.EdgeInsets_0_0_0_0, t1.progress / 100, C.Color_0ND);
      else
  ...
  B.EmailPreviewerView.prototype = {
    ...
    _buildEMLPreviewerWidget$2(context, emlPreviewer) {
      ...
      return F.HtmlContentViewerOnWeb$(true, false, emlPreviewer.content, _null, t3, false, false, t1.size._dy, 150, 300, false, _null, _null, 30, A._instanceType(this)._eval$1("GetWidget.S")._as(t4._jsWeakMap.get(this)).get$onClickHyperLink(), _null, _null, false, _null, t2.size._dx);
    }
  };
...
})($__dart_deferred_initializers__, "yAYRbg+JO25FIfj/1ONOK/v5RK4=");
;