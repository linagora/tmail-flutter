...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    ...
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19) {
      ...
      _.onIFrameKeyboardShortcutAction = t8;
      _.allowResizeToDocumentSize = t9;
      _.scrollController = t10;
      _.enableQuoteToggle = t11;
      _.disableScrolling = t12;
      _.keepAlive = t13;
      _.htmlContentMinHeight = t14;
      _.htmlContentMinWidth = t15;
      _.offsetHtmlContentHeight = t16;
      _.viewMaxHeight = t17;
      _.autoAdjustHeight = t18;
      _.key = t19;
    },
    ...
    KeyShortcut: function KeyShortcut(t0, t1, t2) {
      this.key = t0;
      this.code = t1;
      this.shift = t2;
    },
    _KeyShortcut_Object_EquatableMixin: function _KeyShortcut_Object_EquatableMixin() {
    },
  ...
  B._HtmlContentViewerOnWebState.prototype = {
    ...
    _handleMessageEvent$1($event) {
      var data, viewId, type, e, t1, t2, t3, t4, exception, _this = this, _null = null;
      try {
        ...
        t4 = false;
        if (t3 != null)
          if (t3._positions.length !== 0 === true)
            t1 = (t1 == null ? _null : C.JSString_methods.contains$1(t1, "toDart: iframeScrolling")) === true;
          else
            t1 = t4;
        else
          t1 = t4;
        if (t1) {
          t3.toString;
          _this._handleIframeOnScrollChangedListener$2(data, t3);
          return;
        } else {
          t1 = type;
          if (t2.onIFrameKeyboardShortcutAction != null)
            t1 = (t1 == null ? _null : C.JSString_methods.contains$1(t1, "toDart: iframeKeydown")) === true;
          else
            t1 = false;
          if (t1) {
            _this._handleOnIFrameKeyboardEvent$1(data);
            return;
          }
        }
        ...
        A.log(A.getRuntimeTypeOfDartObject(_this).toString$0(0) + "::_handleMessageEvent:Exception = " + A.S(e), C.Level_1);
      }
    },
    _handleIframeOnScrollChangedListener$2(data, controller) {
      var deltaY, newOffset, e, deltaY0, t1, t2, exception;
      try {
        deltaY0 = J.$index$asx(data, "deltaY");
        deltaY = deltaY0 == null ? 0 : deltaY0;
        t1 = controller._positions;
        t2 = C.JSArray_methods.get$single(t1)._pixels;
        t2.toString;
        newOffset = t2 + deltaY;
        A.log(A.getRuntimeTypeOfDartObject(this).toString$0(0) + "::_handleIframeOnScrollChangedListener:deltaY = " + A.S(deltaY) + " | newOffset = " + A.S(newOffset), C.Level_3);
        if (newOffset < C.JSArray_methods.get$single(t1).get$minScrollExtent())
          controller.jumpTo$1(C.JSArray_methods.get$single(t1).get$minScrollExtent());
        else if (newOffset > C.JSArray_methods.get$single(t1).get$maxScrollExtent())
          controller.jumpTo$1(C.JSArray_methods.get$single(t1).get$maxScrollExtent());
        else
          controller.jumpTo$1(newOffset);
      } catch (exception) {
        e = A.unwrapException(exception);
        A.log(A.getRuntimeTypeOfDartObject(this).toString$0(0) + "::_handleIframeOnScrollChangedListener:Exception = " + A.S(e), C.Level_1);
      }
    },
    ...
    _handleOnIFrameKeyboardEvent$1(data) {
      var shortcut, e, t1, exception;
      try {
        t1 = J.getInterceptor$asx(data);
        shortcut = new B.KeyShortcut(A._asString(t1.$index(data, "key")), A._asString(t1.$index(data, "code")), J.$eq$(t1.$index(data, "shift"), true));
        A.log(A.getRuntimeTypeOfDartObject(this).toString$0(0) + "::_handleOnIFrameKeyboardEvent:\ud83d\udce5 Shortcut pressed: " + A.S(shortcut), C.Level_3);
        t1 = this._widget.onIFrameKeyboardShortcutAction;
        if (t1 != null)
          t1.call$1(shortcut);
      } catch (exception) {
        e = A.unwrapException(exception);
        A.log(A.getRuntimeTypeOfDartObject(this).toString$0(0) + "::_handleOnIFrameKeyboardEvent: Exception = " + A.S(e), C.Level_1);
      }
    },
    didUpdateWidget$1(oldWidget) {
      ...
      A.log(A.getRuntimeTypeOfDartObject(_this).toString$0(0) + "::didUpdateWidget():Old-Direction: " + t1.toString$0(0) + " | Current-Direction: " + _this._widget.direction.toString$0(0), C.Level_3);
      t2 = _this._widget;
    ...
    _html_content_viewer_on_web_widget$_setUpWeb$0() {
      var t9, combinedCss, combinedScripts, _this = this,
        _s22_ = "\n          \n          ",
      ...
      t9 = A._setArrayType(["    .tmail-tooltip .tooltiptext {\n      visibility: hidden;\n      max-width: 400px;\n      background-color: black;\n      color: #fff;\n      text-align: center;\n      border-radius: 6px;\n      padding: 5px 8px 5px 8px;\n      white-space: nowrap; \n      overflow: hidden;\n      text-overflow: ellipsis;\n      position: absolute;\n      z-index: 1;\n    }\n    .tmail-tooltip:hover .tooltiptext {\n      visibility: visible;\n    }\n  "], t2);
      ...
      combinedCss = C.JSArray_methods.join$0(t9);
      ...
      if (_this._widget.scrollController != null)
        t1.push("    <script type=\"text/javascript\">\n      window.addEventListener('wheel', handleIframeScrolling);\n      \n      window.addEventListener('pagehide', (event) => {\n        window.removeEventListener('wheel', handleIframeScrolling);\n      });\n      \n      function handleIframeScrolling(event) {\n        const payload = {\n          view: '" + _this.___HtmlContentViewerOnWebState__createdViewId_A + "',\n          type: 'toDart: iframeScrolling',\n          deltaY: event.deltaY,\n        };\n        window.parent.postMessage(JSON.stringify(payload), \"*\");\n      }\n    </script>\n  ");
      if (_this._widget.onIFrameKeyboardShortcutAction != null)
  ...
  B.KeyShortcut.prototype = {
    matches$2$shift(_, expectedKey, shift) {
      return this.key.toLowerCase() === expectedKey.toLowerCase() && this.shift === shift;
    },
    matches$1(_, expectedKey) {
      return this.matches$2$shift(0, expectedKey, false);
    },
    get$props() {
      return [this.key, this.code, this.shift];
    }
  };
  B._KeyShortcut_Object_EquatableMixin.prototype = {};
  ...
  (function inheritance() {
    ...
    _inherit(B._KeyShortcut_Object_EquatableMixin, A.Object);
    _inherit(B.KeyShortcut, B._KeyShortcut_Object_EquatableMixin);
    _mixinHard(B.__HtmlContentViewerOnWebState_State_AutomaticKeepAliveClientMixin, A.AutomaticKeepAliveClientMixin);
    _mixin(B._KeyShortcut_Object_EquatableMixin, A.EquatableMixin);
  })();
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"HtmlContentViewerOnWeb":{"StatefulWidget":[],"Widget":[],"DiagnosticableTree":[]},"_HtmlContentViewerOnWebState":{"State0":["HtmlContentViewerOnWeb"]},"KeyShortcut":{"EquatableMixin":[]}}'));
  var type$ = {
...
})($__dart_deferred_initializers__, "GSKqQHmpiYiJkDTxkxQiAc6mJrQ=");
;