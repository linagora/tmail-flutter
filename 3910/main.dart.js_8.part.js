...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var J, A, C,
  B = {
    HtmlContentViewerOnWeb$(allowResizeToDocumentSize, contentHtml, contentPadding, direction, enableQuoteToggle, heightContent, key, mailtoDelegate, onClickHyperLinkAction, onIFrameKeyboardShortcutAction, scrollController, useDefaultFont, widthContent) {
      return new B.HtmlContentViewerOnWeb(contentHtml, widthContent, heightContent, direction, contentPadding, useDefaultFont, mailtoDelegate, onClickHyperLinkAction, onIFrameKeyboardShortcutAction, allowResizeToDocumentSize, scrollController, enableQuoteToggle, key);
    },
    HtmlContentViewerOnWeb: function HtmlContentViewerOnWeb(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) {
      var _ = this;
      _.contentHtml = t0;
      _.widthContent = t1;
      _.heightContent = t2;
  ...
  B._HtmlContentViewerOnWebState.prototype = {
    ...
    _handleMessageEvent$1($event) {
      var data, viewId, type, e, t1, t2, t3, deltaY, newOffset, shortcut, exception, _this = this, _null = null;
      try {
        ...
        if (t1) {
          ...
          if (newOffset < C.JSArray_methods.get$single(t1).get$minScrollExtent())
            t3.jumpTo$1(C.JSArray_methods.get$single(t1).get$minScrollExtent());
          else if (newOffset > C.JSArray_methods.get$single(t1).get$maxScrollExtent())
            t3.jumpTo$1(C.JSArray_methods.get$single(t1).get$maxScrollExtent());
          else
            t3.jumpTo$1(newOffset);
          return;
        } else {
          t1 = type;
          ...
          if (t1) {
            ...
            shortcut = new B.KeyShortcut(A._asString(t2.$index(t1, "key")), A._asString(t2.$index(t1, "code")), J.$eq$(t2.$index(t1, "shift"), true));
            A.log("_HtmlContentViewerOnWebState::_handleOnIFrameKeyboardEvent:\ud83d\udce5 Shortcut pressed: " + shortcut.toString$0(0), C.Level_3);
            t1 = _this._widget.onIFrameKeyboardShortcutAction;
            if (t1 != null)
              t1.call$1(shortcut);
            return;
          }
    ...
    _html_content_viewer_on_web_widget$_setUpWeb$0() {
      var t3, t4, t5, t6, t7, t8, combinedCss, combinedScripts, _this = this,
        t1 = _this._widget,
        processedContent = t1.contentHtml,
        t2 = _this.___HtmlContentViewerOnWebState__createdViewId_A;
      t2 === $ && A.throwUnnamedLateFieldNI();
      t3 = t1.mailtoDelegate != null;
      t4 = t3 ? '                function handleOnClickEmailLink(e) {\n                   var href = this.href;\n                   window.parent.postMessage(JSON.stringify({"view": "' + t2 + '", "type": "toDart: OpenLink", "url": "" + href}), "*");\n                   e.preventDefault();\n                }\n              ' : "";
      t5 = t1.onClickHyperLinkAction != null;
      t6 = t5 ? '                function onClickHyperLink(e) {\n                   var href = this.href;\n                   window.parent.postMessage(JSON.stringify({"view": "' + t2 + '", "type": "toDart: onClickHyperLink", "url": "" + href}), "*");\n                   e.preventDefault();\n                }\n              ' : "";
      t5 = t5 ? "                  var hyperLinks = document.querySelectorAll('a');\n                  for (var i=0; i < hyperLinks.length; i++){\n                      hyperLinks[i].addEventListener('click', onClickHyperLink);\n                  }\n                " : "";
      t3 = t3 ? "                  var emailLinks = document.querySelectorAll('a[href^=\"mailto:\"]');\n                  for (var i=0; i < emailLinks.length; i++){\n                      emailLinks[i].addEventListener('click', handleOnClickEmailLink);\n                  }\n                " : "";
      t7 = t1.scrollController != null ? '          window.addEventListener(\'wheel\', function (event) {\n            const deltaY = event.deltaY;\n            window.parent.postMessage(JSON.stringify({\n              "view": "' + t2 + '",\n              "type": "toDart: onScrollChanged",\n              "deltaY": deltaY\n            }), "*");\n          });\n        ' : "";
      if (t1.enableQuoteToggle)
        processedContent = B.HtmlUtils_addQuoteToggle(processedContent);
      t1 = type$.JSArray_String;
      t8 = A._setArrayType(["    .tmail-tooltip .tooltiptext {\n      visibility: hidden;\n      max-width: 400px;\n      background-color: black;\n      color: #fff;\n      text-align: center;\n      border-radius: 6px;\n      padding: 5px 8px 5px 8px;\n      white-space: nowrap; \n      overflow: hidden;\n      text-overflow: ellipsis;\n      position: absolute;\n      z-index: 1;\n    }\n    .tmail-tooltip:hover .tooltiptext {\n      visibility: visible;\n    }\n  "], t1);
...
})($__dart_deferred_initializers__, "W/UO771FxrXRuC6lDiBqbWM9AIs=");
;