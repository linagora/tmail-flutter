...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B.ApplicationVersionWidget.prototype = {
    createState$0() {
      ...
      if (t1 == null)
        t1 = $.GetInstance__getInstance = C.C_GetInstance;
      return new B._ApplicationVersionWidgetState(t1.find$1$1$tag(0, null, type$.ApplicationManager), C._StateLifecycle_0);
    }
  };
  ...
  B.AppGridDashboardItem.prototype = {
    build$1(context) {
      ...
      if ((t3 == null ? _null : t3.length !== 0) === true) {
        ...
        if (C.JSString_methods.endsWith$1(t3, "svg"))
          t3 = A.SvgPicture$asset(t4, C.Alignment_0_0, _null, C.BoxFit_0, 42, _null, _null, 42);
        else
          t3 = new A.Image(A.ResizeImage_resizeIfNeeded(_null, _null, new A.AssetImage(t4, _null, _null)), _null, 42, 42, C.BoxFit_0, _null);
        t2.push(t3);
      } else {
        t3 = t1.publicIconUri;
        if (t3 != null)
  ...
  B.NavigationBarWidget.prototype = {
    build$1(context) {
      var t3, _this = this, _null = null,
        ...
        t2 = A._setArrayType([new A.SizedBox(226, _null, A.Row$(A._setArrayType([E.ApplicationLogoWidthTextWidget$(_this.onTapApplicationLogoAction), D.ApplicationVersionWidget_null], t1), C.CrossAxisAlignment_2, _null, C.MainAxisAlignment_0, C.MainAxisSize_0, _null), _null)], t1);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.State0, [B._HtmlContentViewerOnWebState, B._PortalState, B._ApplicationVersionWidgetState]);
    ...
    _inheritMany(A.Closure2Args, [B._HtmlContentViewerOnWebState_build_closure, B._HtmlContentViewerOnWebState_build__closure, B._ApplicationVersionWidgetState_build_closure, B.LinkBrowserWidget_build_closure, B.NavigationBarWidget_build_closure]);
    ...
    _inheritMany(A.Object, [B.PortalLink, B.PopupMenuWidgetMixin, B._SuggestionEmailAddress_Object_EquatableMixin0]);
  ...
  (function constants() {
    ...
    D.TextStyle_69t8 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 17, C.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_69t11 = new A.TextStyle(true, C.Color_4278190080, null, null, null, null, 20, C.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
})($__dart_deferred_initializers__, "kX+duceaSd2lQHH5fYxgiuzlgkI=");
;