...
if(x.aJB(d)&&C.d.fv(d,"svg"))return new B.apL(e,e,C.O,C.t,new A.apK(d,w,w,w,w),new A.c3_(),new A.c30(x,e),w,w)
else if(x.aJB(d))return new B.GI(B.dud(w,w,new A.a1h(d,1,w,D.b5v)),new A.c31(),new A.c32(x,e),e,e,C.O,w)
