...
x=window
x.toString
x=A.jA(x,"message",w.gbq_(),!1,y._)
w.z!==$&&A.cB()
w.z=x},
bq0(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{x=B.at.h9(0,new A.VO([],[]).RE(d.data,!0))
w=J.af(x,"view")
t=n.d
t===$&&A.d()
if(!J.v(w,t))return
...
if(!n.Q)return
t=v
if((t==null?m:B.d.q(t,"toDart: htmlHeight"))===!0)n.bnx(J.af(x,"height"))
else{t=v
t=(t==null?m:B.d.q(t,"toDart: htmlWidth"))===!0
if(t)n.a.toString
if(t)n.bny(J.af(x,"width"))
else{t=v
...
(a=>{a["PwrSDK2Mg7vldI5CSBIyPN+ops0="]=a.current})($__dart_deferred_initializers__);