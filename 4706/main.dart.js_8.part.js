...
cff(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){return new C.Sa(f,a2,l,h,g,x,k,r,t,v,u,d,w,j,i,p,m,n,s,a1,e,a0,o,q)},
ewQ(d,e,f,g){if(g===e)return!1
return d?g>=f:g>f},
Sa:function Sa(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,a0,a1,a2){var _=this
_.c=d
_.d=e
_.e=f
_.f=g
...
this.c=f},
bqk:function bqk(){},
ci0(d){return new C.ci_(d)},
ci_:function ci_(d){this.e=d},
aWb:function aWb(d){this.a=null
this.b=d},
ci2:function ci2(d,e,f,g){var _=this
_.a=d
_.b=e
_.c=f
_.d=g},
ci3:function ci3(d,e,f,g,h,i){var _=this
_.a=d
_.b=e
_.c=f
_.d=g
...
ewY(d){var x,w,v,u,t,s,r,q,p="text/html"
if(!(B.d.q(d,$.egv())&&B.d.q(d,$.egu())))return d
...
v=w.querySelectorAll(".quote-toggle-container"+B.d.aX(" > div",s)+" > blockquote")
v.toString
t=new A.abf(v,u);++s}r=t.$ti.c.a(B.wc.ga0(t.a))
...
w.f=x.d
w.y=x.cy
if(!A.Gf()&&!A.Gg()){x=w.a.fy
w.as=new C.aWb(x)}w.aHF()
x=window
x.toString
x=A.k3(x,"message",w.gbuq(),!1,y._)
w.z!==$&&A.cC()
w.z=x},
bur(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{x=B.ao.hd(0,new A.De([],[]).Cf(d.data,!0))
w=J.aa(x,"view")
t=n.d
t===$&&A.d()
if(!J.v(w,t))return
...
t.toString
n.btQ(x,t)
return}else{if(n.gaD3()){t=v
t=(t==null?m:B.d.q(t,"toDart: onScrollEnd"))===!0}else t=!1
if(t){t=n.a.ay
t.toString
s=J.aa(x,"velocity")
r=J.dVK(s==null?0:s,800)
q=t.f
p=B.c.gbA(q).at
p.toString
t.jH(B.i.ed(p+r,B.c.gbA(q).gfi(),B.c.gbA(q).geA()),B.fJ,B.i9)
return}else{t=v
q=n.a
...
if(t){n.bv6(x)
return}else{t=v
if((t==null?m:B.d.q(t,"toDart: iframeLinkHover"))===!0){n.bv8(x)
return}else{t=v
if((t==null?m:B.d.q(t,"toDart: iframeLinkOut"))===!0){n.bv9(x)
return}}}}}}if(J.v(J.aa(x,"message"),"iframeHasBeenLoaded"))n.Q=!0
if(!n.Q)return
t=v
if((t==null?m:B.d.q(t,"toDart: htmlHeight"))===!0)n.brW(J.aa(x,"height"))
else{t=v
t=(t==null?m:B.d.q(t,"toDart: htmlWidth"))===!0
if(t)n.a.toString
if(t)n.brX(J.aa(x,"width"))
else{t=v
if((t==null?m:B.d.q(t,"toDart: OpenLink"))===!0){t=J.aa(x,"url")
if(t!=null&&n.c!=null&&typeof t=="string"&&B.d.aJ(t,"mailto:")){q=n.a.y
if(q!=null)q.$1(A.iP(t))}}else{t=v
if((t==null?m:B.d.q(t,"toDart: onClickHyperLink"))===!0){t=J.aa(x,"url")
if(t!=null&&n.c!=null&&typeof t=="string"){q=n.a.z
if(q!=null)q.$1(A.iP(t))}}}}}}catch(o){u=A.L(o)
A.x(A.K(n).l(0)+"::_handleMessageEvent:Exception = "+A.e(u),m,m,B.q,m,!1)}},
gaD3(){var x=this.a.ay
if(x!=null)x=x.f.length!==0===!0
else x=!1
return x},
btQ(d,e){var x,w,v,u,t,s,r,q
try{t=J.aa(d,"deltaY")
x=t==null?0:t
s=e.f
r=B.c.gbA(s).at
...
w=r+x
r=A.Gf()||A.Gg()
if(r){v=J.adO(w,B.c.gbA(s).gfi(),B.c.gbA(s).geA())
e.jH(v,B.a7,B.pv)}else if(w<B.c.gbA(s).gfi())e.iU(B.c.gbA(s).gfi())
else if(w>B.c.gbA(s).geA())e.iU(B.c.gbA(s).geA())
else e.iU(w)}catch(q){u=A.L(q)
A.x(A.K(this).l(0)+"::_handleIframeOnScrollChangedListener:Exception = "+A.e(u),null,null,B.q,null,!1)}},
brW(d){var x,w,v,u,t=this
if(d==null){x=t.e
x===$&&A.d()
w=x}else w=d
x=t.c
if(x!=null){v=A.hk(w)+t.a.dx
A.x(A.K(t).l(0)+"::_handleContentHeightEvent: ScrollHeightWithBuffer = "+A.e(v),null,null,B.h,null,!1)
x=t.e
x===$&&A.d()
u=t.y
u===$&&A.d()
if(C.ewQ(t.a.fr,x,u,v))t.X(new C.do_(t,v))}if(t.c!=null&&t.x)t.X(new C.do0(t))},
brX(d){var x,w,v=this
if(d==null){x=v.f
x===$&&A.d()
w=x}else w=d
if(v.c!=null&&J.dVJ(w,v.a.db)&&v.a.at)v.X(new C.do1(v,w))},
bv7(d){var x,w,v,u,t=null
try{v=J.aj(d)
x=new C.a44(A.aB(v.i(d,"key")),A.aB(v.i(d,"code")),J.v(v.i(d,"shift"),!0))
A.x(A.K(this).l(0)+"::_handleOnIFrameKeyboardEvent:\ud83d\udce5 Shortcut pressed: "+A.e(x),t,t,B.h,t,!1)
v=this.a.Q
if(v!=null)v.$1(x)}catch(u){w=A.L(u)
A.x(A.K(this).l(0)+"::_handleOnIFrameKeyboardEvent: Exception = "+A.e(w),t,t,B.q,t,!1)}},
bv6(d){var x,w,v,u=null
try{A.x(A.K(this).l(0)+"::_handleOnIFrameClickEvent: "+A.e(d),u,u,B.h,u,!1)
w=this.a.as
if(w!=null)w.$0()}catch(v){x=A.L(v)
A.x(A.K(this).l(0)+"::_handleOnIFrameClickEvent: Exception = "+A.e(x),u,u,B.q,u,!1)}},
bv8(d){var x,w,v,u,t,s,r,q,p,o,n=this,m=null
try{A.x(A.K(n).l(0)+"::_handleOnIFrameLinkHoverEvent: "+A.e(d),m,m,B.h,m,!1)
t=J.aj(d)
s=t.i(d,"url")
x=s==null?"":s
w=t.i(d,"rect")
...
t(d){var x=this
x.yL(d)
if(x.a.fr)return x.awy()
else return A.eV(new C.do2(x))},
awy(){var x,w=this,v=null,u=A.K(w).l(0),t=w.e
t===$&&A.d()
A.x(u+"::_buildHtmlElementView: ActualHeight: "+A.e(t),v,v,B.h,v,!1)
t=A.c([],y.p)
u=w.w
if((u==null?v:B.d.ac(u).length!==0)===!0)t.push(A.RA(new C.dnZ(w),w.r,y.y))
if(w.x)t.push(D.a7O)
x=new A.cy(B.a3,v,B.Z,B.F,t,v)
w.a.toString
u=w.f
u===$&&A.d()
...
C.aFO.prototype={
ar(){this.aK()
if(this.a.cx)this.wN()},
jf(){var x=this.jx$
if(x!=null){x.b3()
x.ip()
this.jx$=null}this.qo()}}
C.a44.prototype={
aT0(d,e,f){return this.a.toLowerCase()===e.toLowerCase()&&this.c===f},
De(d,e){return this.aT0(0,e,!1)},
gv(){return[this.a,this.b,this.c]}}
C.bqk.prototype={}
C.ci_.prototype={}
C.aWb.prototype={
at0(d,e,f,g){var x,w,v,u,t,s,r,q,p,o,n=this,m={}
if(n.a!=null){n.ew()
A.akn(new C.ci2(n,e,f,g),y.P)
return}x=A.mw(e,!1)
if(x==null)return
w=e.gaq()
v=g.iH(w instanceof A.a7?A.d0(w.cc(0,null),B.r):B.r)
u=y.w
t=A.Q(e,B.w,u).w.a.a
u=A.Q(e,B.w,u).w
s=t<400?t-24:400
...
m=A.n5(new C.ci3(m,n,q,p,s,f),!1,!1,!1)
n.a=m
x.lP(0,m)},
ew(){var x=this.a
if(x!=null)x.e6(0)
...
r=x.e
r===$&&A.d()
q=new A.alS(p,s,B.i.l(r),p,u,new A.aT(A.e(w)+"-"+v,y.O))
x=x.a.dy
...
C.ci2.prototype={
$0(){var x=this,w=x.b
if(w.e!=null)x.a.at0(0,w,x.c,x.d)},
$S:7}
C.ci3.prototype={
$1(d){var x=this,w=null,v=x.b,u=A.jY(0,A.cY(B.c0,w,B.N,!1,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,w,v.gqY(),w,w,w,w,w,w,w,w,!1,B.a1),w),t=x.a.a,s=A.c([new A.c8(0,B.U,B.n.av(0.15),B.r,20)],y.V)
v=v.b.e
if(v==null)v=D.b3M
return A.dQk(new C.ci1(x.c),new A.cy(B.a3,w,B.Z,B.F,A.c([u,A.kW(w,A.cZ(A.cv(!1,B.D,!0,B.ky,A.a8(w,A.ai(x.f,w,1,B.A,w,w,v,w,w,w),B.k,w,new A.at(0,x.e,28,1/0),new A.bb(B.n,w,w,B.ky,s,w,w,B.B),w,w,w,w,B.mU,w,w,w),B.k,w,0,w,w,w,w,w,B.aJ)),w,t,x.d,w)],y.p),w),B.fP,B.zI,new A.bE(0,1,y.t),y.i)},
$S:344}
C.ci1.prototype={
$3(d,e,f){var x=this.a?-1:1
return A.nG(A.awL(f,new A.D(0,x*(1-e)*8)),null,e)},
$S:345};(function aliases(){var x=C.aFO.prototype
x.bb6=x.ar})();(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
x(C.aAs.prototype,"gbuq","bur",0)
w(C.aWb.prototype,"gqY","ew",1)})();(function inheritance(){var x=a.mixinHard,w=a.mixin,v=a.inherit,u=a.inheritMany
v(C.Sa,A.ad)
v(C.aFO,A.ag)
v(C.aAs,C.aFO)
u(A.y9,[C.do_,C.do0,C.do1,C.ci2])
u(A.ya,[C.do2,C.dnZ])
u(A.U,[C.bqk,C.ci_,C.aWb])
v(C.a44,C.bqk)
u(A.qP,[C.ci3,C.ci1])
x(C.aFO,A.uh)
w(C.bqk,A.k)})()
A.Ib(b.typeUniverse,JSON.parse('{"Sa":{"ad":[],"j":[],"p":[]},"aAs":{"ag":["Sa"]},"a44":{"k":[]}}'))
var y=(function rtii(){var x=A.an
return{V:x("N<c8>"),s:x("N<f>"),p:x("N<j>"),w:x("p9"),_:x("yO"),P:x("b1"),t:x("bE<aq>"),O:x("aT<f>"),N:x("abf<j_>"),y:x("B"),i:x("aq")}})();(function constants(){D.b_1=new A.b4(30,30,B.zk,null)
D.aRn=new A.Y(B.cp,D.b_1,null)
D.a7O=new A.ee(B.d5,null,null,D.aRn,null)
D.b3M=new A.ao(!0,B.m,null,null,null,null,13,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"fs2","egv",()=>A.aY("<[a-zA-Z][^>\\s]*[^>]*>",!0,!1,!1,!1))
x($,"fs1","egu",()=>A.aY("</[a-zA-Z][^>]{0,128}>",!0,!1,!1,!1))})()};
(a=>{a["iRZe6yW7ITrA4IHssvyyPqjZyyk="]=a.current})($__dart_deferred_initializers__);