...
class NonScrollEmailView extends GetWidget<SingleEmailController> {

  const NonScrollEmailView({Key? key, this.presentationEmail}) : super(key: key);

  final PresentationEmail? presentationEmail;

  @override
  SingleEmailController get controller => Get.find<SingleEmailController>(
                      ...
                      return Stack(
                        children: [
                          HtmlContentViewerOnWeb(
                            ...
                            heightContent: min(constraints.maxHeight, 300),
