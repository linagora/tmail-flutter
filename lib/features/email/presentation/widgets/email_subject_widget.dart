...
class _EmailSubjectWidgetState extends State<EmailSubjectWidget> {
  ...
  void initState() {
    ...
    print('>> dab >> initState email subject: $_currentLabels');
  }

  @override
  void didUpdateWidget(covariant EmailSubjectWidget oldWidget) {
    super.didUpdateWidget(oldWidget);
    print('>> dab >> initState email subject oldWidget:  ${oldWidget.labels}');
    print('>> dab >> initState email subject: newWidget ${widget.labels}');
    _currentLabels = widget.labels;
  }
