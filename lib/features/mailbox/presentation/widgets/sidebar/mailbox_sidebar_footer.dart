...
class MailboxSidebarFooter extends StatelessWidget {
  ...
  QuotasController get controller => Get.find<QuotasController>();
            ...
            children: [
              ...
              if (_isIncreaseSpaceDisplayed(
                ...
                LinagoraSidebarUpsellButton(
                  ...
                  expanded: !isDesktop,
                  onPressed: () => _handleIncreaseSpacePressed(
                    dashboardController,
                    ref,
                  ),
                ),
  ...
  bool _isIncreaseSpaceDisplayed(
    ...
    return premiumState is PremiumCtaAvailable;
  }
  ...
  void _handleIncreaseSpacePressed(
    ...
    ref.openPremiumCta(dashboardController.currentPremiumCtaContext);
  }
}
