...
typedef OnFocusEmailAddressChangeAction = void Function(AdvancedSearchFilterField field, bool isFocus);
            ...
            children: [
              ...
              Expanded(
                child: FocusScope(
                  child: Focus(
                    onFocusChange: (focus) {
                      widget.onFocusEmailAddressChangeAction?.call(widget.field, focus);
                    },
