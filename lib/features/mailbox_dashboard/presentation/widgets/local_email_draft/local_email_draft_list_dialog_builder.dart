            ...
            Expanded(
              child: ScrollbarListView(
                ...
                child: ListView.builder(
                  itemCount: widget.presentationLocalEmailDrafts.length,
                  shrinkWrap: true,
                  controller: _scrollController,
                  primary: false,
                  itemBuilder: (_, index) {
                    final draftLocal =
                        widget.presentationLocalEmailDrafts[index];
                    return LocalEmailDraftItemWidget(
                      draftLocal: draftLocal,
                      isOldest: index == widget.presentationLocalEmailDrafts.length - 1,
                      imagePaths: _imagePaths,
                      onSelectLocalEmailDraftAction: (draftLocal) {},
                    );
                  },
                ),
              ),
