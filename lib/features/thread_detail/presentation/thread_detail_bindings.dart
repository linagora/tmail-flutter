...
class ThreadDetailBindings extends BaseBindings {
  ...
  void bindingsController() {
    Get.put(ThreadDetailController(
      ...
      Get.find<GetEmailIdsByThreadIdInteractor>(),
  ...
  void bindingsInteractor() {
    Get.lazyPut<GetEmailIdsByThreadIdInteractor>(() => GetEmailIdsByThreadIdInteractor(Get.find<ThreadDetailRepository>()));
    Get.lazyPut<GetEmailsByIdsInteractor>(() => GetEmailsByIdsInteractor(Get.find<ThreadDetailRepository>()));
  }
}
