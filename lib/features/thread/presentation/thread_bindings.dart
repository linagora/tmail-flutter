...
import 'package:tmail_ui_user/features/thread/data/datasource_impl/hive_recent_search_datasource.dart';
...
import 'package:tmail_ui_user/features/thread/data/repository/recent_search_repository_impl.dart';
...
class ThreadBindings extends BaseBindings {
  ...
  void bindingsController() {
    Get.put(ThreadController(
      ...
      Get.find<GetRecentSearchInteractor>(),
      Get.find<StoreRecentSearchInteractor>(),
    ));
  }
  ...
  void bindingsDataSource() {
    ...
    Get.lazyPut<RecentSearchDataSource>(
        () => Get.find<HiveRecentSearchDataSource>());
  }
  ...
  void bindingsDataSourceImpl() {
    ...
    Get.lazyPut(
        () => HiveRecentSearchDataSource(Get.find<RecentSearchClient>()));
  ...
  void bindingsInteractor() {
    ...
    Get.lazyPut(
        () => MarkAsMultipleEmailReadInteractor(Get.find<EmailRepository>()));
    Get.lazyPut(() => MoveToMailboxInteractor(Get.find<EmailRepository>()));
    Get.lazyPut(() =>
        MoveMultipleEmailToMailboxInteractor(Get.find<EmailRepository>()));
    ...
    Get.lazyPut(
        () => StoreRecentSearchInteractor(Get.find<RecentSearchRepository>()));
    Get.lazyPut(
        () => GetRecentSearchInteractor(Get.find<RecentSearchRepository>()));
    Get.lazyPut(() => SearchMoreEmailInteractor(Get.find<ThreadRepository>()));
    Get.lazyPut(() =>
        DeleteMultipleEmailsPermanentlyInteractor(Get.find<EmailRepository>()));
  ...
  void bindingsRepository() {
    ...
    Get.lazyPut<RecentSearchRepository>(
        () => Get.find<RecentSearchRepositoryImpl>());
  }
  ...
  void bindingsRepositoryImpl() {
    ...
    Get.lazyPut(() => EmailRepositoryImpl(
        Get.find<EmailDataSource>(), Get.find<HtmlDataSource>()));
    
    Get.lazyPut(() => RecentSearchRepositoryImpl(
        Get.find<RecentSearchDataSource>()));
  }
}
