//NOTICE: THERE ARE MANY CLASS ARE USING "SearchAppBarWidget" 
                ...
                child: Row(
                  children: [
                      ...
                      Expanded(child: Transform(
                        ...
                        child: Container(child: _buildSearchInputForm(),),
                      )),
 ...
 Widget _buildClearTextSearchButton() {
  ...
  Widget _buildSearchInputForm() {
    return (TextFieldBuilder()
        ...
        ..onTapInput(() => _onOpenSearchViewAction?.call())
