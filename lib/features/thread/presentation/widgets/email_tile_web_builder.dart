...
class EmailTileBuilder {
        ...
        title: Row(children: [
          if (!_presentationEmail.hasRead)
            Padding(
                ...
                child: SvgPicture.asset(_imagePaths.icUnreadStatus,
                        ...
                        if (_searchStatus == SearchStatus.ACTIVE &&
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color:
                                      AppColor.backgroundCounterMailboxColor),
                              child: Text(
          ...
          Row(children: [
            Container(
                ...
                child: !_presentationEmail.hasRead
                    ? SvgPicture.asset(_imagePaths.icUnreadStatus,
                        width: 9, height: 9, fit: BoxFit.fill)
                    : SizedBox(width: 9)),
            buildIconWeb(
  ...
  Widget _buildListActionButtonWhenHover() {
    return Row(children: [
      ...
      if (_mailboxRole != PresentationMailbox.roleDrafts)
        buildIconWeb(
            icon: SvgPicture.asset(_imagePaths.icMove,
                width: 16,
                height: 16,
                color: AppColor.colorActionButtonHover,
                fit: BoxFit.fill),
            ...
            onTap: () => _emailActionClick?.call(
                EmailActionType.moveToMailbox, _presentationEmail)),
      buildIconWeb(
          icon: SvgPicture.asset(_imagePaths.icDelete,
              width: 16,
              height: 16,
              color: AppColor.colorActionButtonHover,
              fit: BoxFit.fill),
          ...
          onTap: () => _emailActionClick?.call(
              ...
              _presentationEmail)),
      if (_mailboxRole != PresentationMailbox.roleDrafts)
        buildIconWebHasPosition(_context,
            icon: SvgPicture.asset(_imagePaths.icMore,
                width: 16,
                height: 16,
                color: AppColor.colorActionButtonHover,
                fit: BoxFit.fill),
            tooltip: AppLocalizations.of(_context).more, onTap: () {
  ...
  Widget _buildAvatarIcon(
      {double? iconSize, EdgeInsets? paddingIconSelect, TextStyle? textStyle}) {
    if (_selectModeAll == SelectMode.ACTIVE) {
      return Tooltip(
          child: Padding(
  ...
  bool get _isSearchEnabled =>
      _searchStatus == SearchStatus.ACTIVE &&
      _searchQuery != null &&
      _searchQuery!.value.isNotEmpty;
}
