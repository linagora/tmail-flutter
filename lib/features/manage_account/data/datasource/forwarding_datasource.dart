...
abstract class ForwardingDataSource {
  ...
  Future<(TMailForward, SetMethodException?)> deleteRecipientInForwarding(AccountId accountId, DeleteRecipientInForwardingRequest deleteRequest);

  Future<(TMailForward, SetMethodException?)> addRecipientsInForwarding(AccountId accountId, AddRecipientInForwardingRequest addRequest);

  Future<(TMailForward, SetMethodException?)> editLocalCopyInForwarding(AccountId accountId, EditLocalCopyInForwardingRequest editRequest);
}