...
class ComposerController extends BaseController
  ...
  Future<CreateEmailRequest?> _generateCreateEmailRequestToSaveAsCache() async {
    ...
    if (currentEmailActionType == EmailActionType.compose) {
      emailContent = await removeCollapsibleSignatureButton(emailContent);
    }
    ...
    return CreateEmailRequest(
      ...
      draftHash: arguments.draftHash ?? _savedEmailDraftHash,
    );
  }
  ...
  Future<void> initEmailDraftHash() async {
    ...
    final firstDraftHash = composerArguments.value?.draftHash;
    ...
    if (currentEmailActionType == EmailActionType.compose ||
      ...
      _savedEmailDraftHash = firstDraftHash;
    }
    log('ComposerController::initEmailDraftHash:firstDraftHash = $firstDraftHash | draftEmailHash = $draftEmailHash | _savedEmailDraftHash = $_savedEmailDraftHash');

    isEmailChanged.value = draftEmailHash != _savedEmailDraftHash;
  }
