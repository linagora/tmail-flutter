...
# WARNING: USE IT ONLY TO GENERATE A NEW BACKUP DATA IF NECESSARY!
# Then do a backup with webadmin: curl -XPOST http://ip:port/users/{usernameToBeUsed}/mailboxes?task=export
