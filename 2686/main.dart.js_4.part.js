...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    ...
    EmailAddressExtension_asFullString(_this) {
      ...
      if ((t2 ? "" : t1).length !== 0) {
        ...
        t4 = t3 == null;
        if ((t4 ? "" : t3).length !== 0) {
          t1 = A.CapitalizeExtension_get_capitalizeFirstEach(t2 ? "" : t1);
          t2 = t4 ? "" : t3;
          return t1 + " <" + t2 + ">";
        }
        return A.CapitalizeExtension_get_capitalizeFirstEach(t2 ? "" : t1);
      } else {
        t1 = _this.email;
        t2 = t1 == null;
        if ((t2 ? "" : t1).length !== 0)
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [B._HtmlContentViewerOnWebState__setUpWeb_closure, B._HtmlContentViewerOnWebState__setUpWeb__closure, B._HtmlContentViewerOnWebState__setUpWeb_closure0, B.ListEmailAddressExtension_emailAddressToListString_closure, B.ListEmailAddressExtension_emailAddressToListString_closure0]);
...
})($__dart_deferred_initializers__, "bIFYp7ur9C+jEhqe1V0edoXT8/M=");
;