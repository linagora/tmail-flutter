...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C = {
    ...
    PopupMenuItemWidget$(height, icon, iconColor, $name, onCallbackAction, padding, space, textStyle) {
      return new C.PopupMenuItemWidget($name, icon, iconColor, textStyle, padding, space, height, onCallbackAction, null);
    },
    PopupMenuItemWidget: function PopupMenuItemWidget(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.name = t0;
      _.icon = t1;
      _.iconColor = t2;
    ...
    UserInformationWidget$(border, onSubtitleClick, padding, subtitle, titlePadding, userProfile) {
      return new C.UserInformationWidget(userProfile, subtitle, onSubtitleClick, padding, border, null);
    },
  ...
  C._HtmlContentViewerOnWebState.prototype = {
    ...
    _setUpWeb$0() {
      ...
      t2 = t1.style;
      t2.height = "100%";
      A._EventStreamSubscription$(t1, "load", new C._HtmlContentViewerOnWebState__setUpWeb_closure(_this), false, type$._ElementEventStreamImpl_Event._precomputed1);
      $.$get$platformViewRegistry();
      t2 = _this.___HtmlContentViewerOnWebState__createdViewId_A;
      $.$get$PlatformViewManager_instance().registerFactory$3$isVisible(t2, new C._HtmlContentViewerOnWebState__setUpWeb_closure0(t1), true);
      if (_this._framework$_element != null)
        _this.setState$1(new C._HtmlContentViewerOnWebState__setUpWeb_closure1(_this));
    },
    build$1(context) {
      return new A.LayoutBuilder(new C._HtmlContentViewerOnWebState_build_closure(this), null);
    }
  };
  C.PopupMenuItemWidget.prototype = {
    build$1(context) {
      var t2, t3, t4, _this = this, _null = null,
        t1 = _this.padding;
      if (t1 == null)
        t1 = B.EdgeInsets_12_0_12_0;
      t2 = A._setArrayType([], type$.JSArray_Widget);
      t3 = _this.space;
      if (t3 == null)
        t3 = 8;
      t4 = _this.iconColor;
      t4 = t4 == null ? _null : A.ColorNullableExtension_asFilter(t4);
      t2.push(new A.Padding(new A.EdgeInsetsDirectional(0, 0, t3, 0), A.SvgPicture$asset(_this.icon, B.Alignment_0_0, t4, B.BoxFit_0, 20, _null, 20), _null));
      t3 = _this.textStyle;
      if (t3 == null) {
        t3 = A.Theme_of(context).textTheme.labelSmall;
        t3 = t3 == null ? _null : t3.copyWith$2$color$fontSize(B.Color_3707764736, 15);
      }
      t2.push(A.Expanded$(A.Text$(_this.name, _null, _null, _null, _null, _null, _null, _null, _null, t3, _null, _null, _null, _null, _null), 1));
      return A.PointerInterceptor$(A.InkWell$(false, _null, true, A.Container$(_null, A.Row$(t2, B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), B.Clip_0, _null, _null, _null, _null, _this.height, _null, _null, t1, _null, _null, _null), _null, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _this.onCallbackAction, _null, _null, _null, _null, _null, _null, _null));
    }
  };
  C.PopupMenuDivider.prototype = {
    createState$0() {
      return new C._PopupMenuDividerState(B._StateLifecycle_0);
    }
  };
  C._PopupMenuDividerState.prototype = {
    build$1(context) {
  ...
  C.PortalTheater.prototype = {
    createRenderObject$1(context) {
      var t1 = new C.RenderPortalTheater(this.debugName, this._portal_theater$_portalLink, null, A.LayerHandle$(type$.ContainerLayer));
      t1.RenderObject$0();
      t1.set$child(null);
  ...
  C.PopupMenuWidgetMixin.prototype = {
    popupItem$5$colorIcon$onCallbackAction$styleName(iconAction, nameAction, colorIcon, onCallbackAction, styleName) {
      var _null = null,
        t1 = A.SvgPicture$asset(iconAction, B.Alignment_0_0, A.ColorNullableExtension_asFilter(colorIcon), B.BoxFit_0, 20, _null, 20);
      return A.InkWell$(false, _null, true, new A.Padding(D.EdgeInsets_20_16_20_16, new A.SizedBox(_null, _null, A.Row$(A._setArrayType([t1, B.SizedBox_12_null_null_null, A.Expanded$(A.Text$(nameAction, _null, _null, _null, _null, _null, _null, _null, _null, styleName, _null, _null, _null, _null, _null), 1)], type$.JSArray_Widget), B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), _null), _null), _null, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, onCallbackAction, _null, _null, _null, _null, _null, _null, _null);
    }
  };
  C.MaterialTextButton.prototype = {
    build$1(context) {
      ...
      if (t3 == null) {
        t3 = _this.labelColor;
        if (t3 == null)
          t3 = B.Color_4278221567;
        t4 = _this.labelWeight;
        if (t4 == null)
          t4 = B.FontWeight_3_400;
  ...
  C.UserInformationWidget.prototype = {
    build$1(context) {
      ...
      if (_this.subtitle != null) {
        ...
        A.Localizations_of(context, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t3.push(new A.Padding(D.EdgeInsetsDirectional_0_10_0_0, A.Transform$(_null, C.MaterialTextButton$(20, E.TextStyle_kmC0, A.Intl__message("Manage account", _null, "manage_account", _null, _null), _null, 15, _null, _null, _this.onSubtitleClick, _null, B.EdgeInsetsDirectional_8_8_8_8, _null), _null, t5, true), _null));
      }
      t2 = A._setArrayType([t2, B.SizedBox_16_null_null_null, A.Expanded$(A.Column$(t3, B.CrossAxisAlignment_0, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1), 1)], t4);
      t2.push(B.SizedBox_16_null_null_null);
      return A.Container$(_null, A.Row$(t2, B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), B.Clip_0, _null, _null, new A.BoxDecoration(_null, _null, _this.border, _null, _null, _null, _null, B.BoxShape_0), _null, _null, _null, _null, t1, _null, _null, _null);
    }
  };
  ...
  C.VacationNotificationMessageWidget.prototype = {
    build$1(context) {
      var t2, t3, t4, t5, t6, t7, t8, _this = this, _null = null,
        t1 = _this.padding;
      if (t1 == null)
        t1 = B.EdgeInsetsDirectional_12_0_0_0;
    ...
    _buildBodyForDesktop$1(context) {
      ...
      if (t2 != null)
        t1.push(t2);
      t2 = C.VacationResponseExtension_getNotificationMessage(_this.vacationResponse, context);
      t1.push(A.Expanded$(A.Text$(t2, _null, _null, _null, _null, _null, _null, _null, _null, A.TextStyle$(_null, _null, B.Color_4278190080, _null, _null, _null, _null, _null, _null, _null, _null, 16, _null, _null, B.FontWeight_3_400, _null, _null, true, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null), 1));
      if (_this.actionEndNow != null) {
        A.Localizations_of(context, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t1.push(A.buildTextButton(A.Intl__message("End now", _null, "endNow", _null, _null), B.Color_0, 44, new C.VacationNotificationMessageWidget__buildBodyForDesktop_closure(_this), 10, B.TextStyle_yzp2, 90));
      }
      if (_this.actionGotoVacationSetting != null) {
        A.Localizations_of(context, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t1.push(A.buildTextButton(A.Intl__message("Vacation setting", _null, "vacationSetting", _null, _null), B.Color_0, 44, new C.VacationNotificationMessageWidget__buildBodyForDesktop_closure0(_this), 10, B.TextStyle_yzp2, 150));
      }
      return A.Row$(t1, B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
    },
    _buildBodyForMobile$1(context) {
      ...
      if (t3 != null)
        t2.push(t3);
      t3 = C.VacationResponseExtension_getNotificationMessage(_this.vacationResponse, context);
      t2.push(A.Expanded$(new A.Padding(D.EdgeInsets_0_12_12_0, A.Center$(A.Text$(t3, _null, _null, _null, _null, _null, _null, _null, _null, A.TextStyle$(_null, _null, B.Color_4278190080, _null, _null, _null, _null, _null, _null, _null, _null, 16, _null, _null, B.FontWeight_3_400, _null, _null, true, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null), _null, _null), _null), 1));
      t2 = A.Row$(t2, B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
      t3 = A._setArrayType([B.Spacer_null], t1);
      if (_this.actionEndNow != null) {
        A.Localizations_of(context, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t3.push(A.buildTextButton(A.Intl__message("End now", _null, "endNow", _null, _null), B.Color_0, 36, new C.VacationNotificationMessageWidget__buildBodyForMobile_closure(_this), 10, B.TextStyle_yzp2, 90));
      }
      if (_this.actionGotoVacationSetting != null) {
        A.Localizations_of(context, B.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t3.push(A.buildTextButton(A.Intl__message("Vacation setting", _null, "vacationSetting", _null, _null), B.Color_0, 36, new C.VacationNotificationMessageWidget__buildBodyForMobile_closure0(_this), 10, B.TextStyle_yzp2, 150));
      }
      t3.push(B.Spacer_null);
      return A.Column$(A._setArrayType([t2, A.Row$(t3, B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, _null)], t1), B.CrossAxisAlignment_2, B.MainAxisAlignment_0, B.MainAxisSize_1, B.VerticalDirection_1);
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = window;
              t2.toString;
              B.Window_methods.postMessage$2(t2, jsonGetHeight, "*");
              ...
              t4 = window;
              t4.toString;
              B.Window_methods.postMessage$2(t4, jsonGetWidth, "*");
              t4 = window;
              t4.toString;
              A._EventStreamSubscription$(t4, "message", new C._HtmlContentViewerOnWebState__setUpWeb__closure(t1), false, type$.MessageEvent);
              // implicit return
  ...
  C._HtmlContentViewerOnWebState__setUpWeb__closure.prototype = {
    call$1($event) {
      ...
      if (t2) {
        ...
        if (t3 != null) {
          ...
          if (J.$gt$n(scrollHeightWithBuffer, t2.minHeight))
            t2.setState$1(new C._HtmlContentViewerOnWebState__setUpWeb___closure(t2, scrollHeightWithBuffer));
        }
        if (t2._framework$_element != null && t2._html_content_viewer_on_web_widget$_isLoading)
          t2.setState$1(new C._HtmlContentViewerOnWebState__setUpWeb___closure0(t2));
      }
      if (t1.$index(data, _s4_) != null)
      ...
      if (t2) {
        ...
        if (t3 != null)
          if (J.$gt$n(docWidth, 300) && t2._widget.allowResizeToDocumentSize)
            t2.setState$1(new C._HtmlContentViewerOnWebState__setUpWeb___closure1(t2, docWidth));
      }
      if (t1.$index(data, _s4_) != null)
  ...
  C._HtmlContentViewerOnWebState__setUpWeb___closure.prototype = {
    call$0() {
      var t1 = this.$this;
  ...
  C._HtmlContentViewerOnWebState__setUpWeb___closure0.prototype = {
    call$0() {
      this.$this._html_content_viewer_on_web_widget$_isLoading = false;
    },
    $signature: 0
  };
  C._HtmlContentViewerOnWebState__setUpWeb___closure1.prototype = {
    call$0() {
  ...
  C.VacationNotificationMessageWidget__buildBodyForDesktop_closure.prototype = {
    call$0() {
      return this.$this.actionEndNow.call$0();
    },
    $signature: 0
  };
  C.VacationNotificationMessageWidget__buildBodyForDesktop_closure0.prototype = {
    call$0() {
      return this.$this.actionGotoVacationSetting.call$0();
    },
    $signature: 0
  };
  C.VacationNotificationMessageWidget__buildBodyForMobile_closure.prototype = {
    call$0() {
      return this.$this.actionEndNow.call$0();
    },
    $signature: 0
  };
  C.VacationNotificationMessageWidget__buildBodyForMobile_closure0.prototype = {
    call$0() {
      return this.$this.actionGotoVacationSetting.call$0();
    },
    $signature: 0
  ...
  (function inheritance() {
    ...
    _inheritMany(A.State0, [C._HtmlContentViewerOnWebState, C._PopupMenuDividerState, C._PortalState]);
    _inheritMany(A.Closure, [C._HtmlContentViewerOnWebState__setUpWeb_closure, C._HtmlContentViewerOnWebState__setUpWeb__closure, C._HtmlContentViewerOnWebState__setUpWeb_closure0]);
    _inheritMany(A.Closure0Args, [C._HtmlContentViewerOnWebState__setUpWeb___closure, C._HtmlContentViewerOnWebState__setUpWeb___closure0, C._HtmlContentViewerOnWebState__setUpWeb___closure1, C._HtmlContentViewerOnWebState__setUpWeb_closure1, C.VacationNotificationMessageWidget__buildBodyForDesktop_closure, C.VacationNotificationMessageWidget__buildBodyForDesktop_closure0, C.VacationNotificationMessageWidget__buildBodyForMobile_closure, C.VacationNotificationMessageWidget__buildBodyForMobile_closure0]);
    _inheritMany(A.Closure2Args, [C._HtmlContentViewerOnWebState_build_closure, C._HtmlContentViewerOnWebState_build__closure]);
    _inheritMany(A.StatelessWidget, [C.PopupMenuItemWidget, C.MaterialTextButton, C.UserInformationWidget, C.VacationNotificationMessageWidget]);
    _inherit(C.PopupMenuDivider, A.PopupMenuEntry);
    _inheritMany(A.Object, [C.PortalLink, C.PopupMenuWidgetMixin, C.UserSettingPopupMenuMixin]);
  ...
  (function constants() {
    D.SizedBox_VEQ0 = new A.SizedBox(30, 30, B.CupertinoActivityIndicator_Color_697934509_null, null);
    D.Padding_kr3 = new A.Padding(B.EdgeInsets_16_16_16_16, D.SizedBox_VEQ0, null);
    D.Align_Ktb = new A.Align(B.Alignment_0_m1, null, null, D.Padding_kr3, null);
    D.Alignment_1_1 = new A.Alignment(1, 1);
    D.Aligned_HRf = new A.Aligned(1, null, B.Alignment_1_m1, D.Alignment_1_1, B.Alignment_0_0, B.C_AxisFlag, B.C_AxisFlag, B.Offset_0_0, null);
    D.Aligned_2Lz = new A.Aligned(1, null, B.Alignment_1_m1, D.Alignment_1_1, B.Alignment_0_0, B.C_AxisFlag, B.C_AxisFlag, B.Offset_0_0, D.Aligned_HRf);
    D.Color_4294914887 = new A.Color(4294914887);
    D.Color_4294964674 = new A.Color(4294964674);
    D.Offset_chs1 = new A.Offset(0, 0.5);
    D.BoxShadow_oyn = new A.BoxShadow(1, B.BlurStyle_0, B.Color_335544320, D.Offset_chs1, 1);
    ...
    D.TextStyle_oHY7 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 17, B.FontWeight_5_600, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    D.TextStyle_oHY10 = new A.TextStyle(true, B.Color_4278190080, null, null, null, null, 20, B.FontWeight_4_500, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  })();
};
;
((d, h) => {
