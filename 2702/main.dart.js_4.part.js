...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    ...
    PopupMenuItemWidget$(height, icon, iconColor, $name, onCallbackAction, padding, space, textStyle) {
      return new B.PopupMenuItemWidget($name, icon, iconColor, textStyle, padding, space, height, onCallbackAction, null);
    },
  ...
  B.PopupMenuItemWidget.prototype = {
    build$1(context) {
      ...
      t2.push(new A.Padding(new A.EdgeInsetsDirectional(0, 0, t3, 0), A.SvgPicture$asset(_this.icon, C.Alignment_0_0, t4, C.BoxFit_0, 20, _null, 20), _null));
      t3 = _this.textStyle;
      if (t3 == null) {
        t3 = A.Theme_of(context).textTheme.labelSmall;
        t3 = t3 == null ? _null : t3.copyWith$2$color$fontSize(C.Color_3707764736, 15);
      }
      t2.push(A.Expanded$(A.Text$(_this.name, _null, _null, _null, _null, _null, _null, _null, _null, t3, _null, _null, _null, _null, _null), 1));
      return A.PointerInterceptor$(A.InkWell$(false, _null, true, A.Container$(_null, A.Row$(t2, C.CrossAxisAlignment_2, _null, C.MainAxisAlignment_0, C.MainAxisSize_1, _null), C.Clip_0, _null, _null, _null, _null, _this.height, _null, _null, t1, _null, _null, _null), _null, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _this.onCallbackAction, _null, _null, _null, _null, _null, _null, _null));
    }
  };
  ...
  B.UserInformationWidget.prototype = {
    build$1(context) {
      ...
      t3 = A._setArrayType([A.TextOverflowBuilder$(t3 == null ? "" : t3, D.TextStyle_oHY7)], t4);
  ...
  B.UserSettingPopupMenuMixin.prototype = {
    popupMenuUserSettingActionTile$4$onLogoutAction$onSettingAction(context, userName, onLogoutAction, onSettingAction) {
      ...
      if (userName != null)
        t2.push(A.PopupMenuItem$(new A.SizedBox(300, _null, A.ListTile$(C.EdgeInsets_20_0_20_0, _null, _null, _null, A.Text$(userName.value, _null, _null, 1, _null, _null, _null, _null, _null, C.TextStyle_chs3, _null, _null, _null, _null, _null), _null), _null), false, 48, _null, C.EdgeInsets_0_0_0_0, _null, type$.dynamic));
      if (onSettingAction != null) {
        A.Localizations_of(context, C.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        C.JSArray_methods.addAll$1(t2, A._setArrayType([D.PopupMenuDivider_null, this._popupMenuAction$4$context$icon$onCallBack$title(context, "assets/images/ic_setting.svg", onSettingAction, A.Intl__message("Manage account", _null, "manage_account", _null, _null))], t1));
      }
      A.Localizations_of(context, C.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
      C.JSArray_methods.addAll$1(t2, A._setArrayType([D.PopupMenuDivider_null, this._popupMenuAction$4$context$icon$onCallBack$title(context, "assets/images/ic_logout.svg", onLogoutAction, A.Intl__message("Sign out", _null, "sign_out", _null, _null))], t1));
      return t2;
    },
    ...
    _popupMenuAction$4$context$icon$onCallBack$title(context, icon, onCallBack, title) {
      ...
      return A.PopupMenuItem$(B.PopupMenuItemWidget$(_null, icon, _null, title, onCallBack, D.EdgeInsets_20_16_20_16, 12, t1 == null ? _null : t1.copyWith$3$color$fontSize$fontWeight(C.Color_4278190080, 15, C.FontWeight_4_500)), true, 48, _null, C.EdgeInsets_0_0_0_0, _null, type$.dynamic);
    }
  };
...
})($__dart_deferred_initializers__, "aYXgNugz1g0qT6ZrDv8HQJh5xpQ=");
;