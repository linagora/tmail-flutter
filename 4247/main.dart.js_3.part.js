...
if(x.aGq(d)&&C.d.ft(d,"svg"))return new B.amW(e,e,C.O,C.t,new A.amV(d,w,w,w,w),new A.bWx(),new A.bWy(x,e),w,w)
else if(x.aGq(d))return new B.FG(B.dhJ(w,w,new A.ZS(d,1,w,D.b3l)),new A.bWz(),new A.bWA(x,e),e,e,C.O,w)
