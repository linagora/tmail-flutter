...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.RenderImage.prototype = {
    ...
    set$image(_, value) {
      ...
      t1 = _this._image$_image;
      t1 = t1 == null ? null : t1.get$width(t1);
      if (t1 == (t2 ? null : value.get$width(value))) {
        t1 = _this._image$_image;
        if (t1 != null)
          t1.get$height(t1);
        if (!t2)
    ...
    _sizeForConstraints$1(constraints) {
      ...
      t3 = _this._image$_image;
      return constraints.constrainSizeAndAttemptToPreserveAspectRatio$1(new B.Size(t1 / t2, t3.get$height(t3) / _this._image$_scale));
    },
    computeMinIntrinsicWidth$1(height) {
      return this._sizeForConstraints$1(B.BoxConstraints$tightForFinite(height, 1 / 0))._dx;
    },
    computeMaxIntrinsicWidth$1(height) {
      return this._sizeForConstraints$1(B.BoxConstraints$tightForFinite(height, 1 / 0))._dx;
    },
    computeMinIntrinsicHeight$1(width) {
      return this._sizeForConstraints$1(B.BoxConstraints$tightForFinite(1 / 0, width))._dy;
    },
    ...
    performLayout$0() {
      this._box$_size = this._sizeForConstraints$1(type$.BoxConstraints._as(B.RenderObject.prototype.get$constraints.call(this)));
    },
    attach$1(owner) {
    ...
    paint$2(context, offset) {
      ...
      t3 = offset._dx;
      t4 = offset._dy;
      t5 = _this._image$_image;
      t5.toString;
      t6 = _this.debugImageLabel;
      t7 = _this._image$_scale;
      t8 = _this._image$_colorFilter;
      ...
      B.paintImage(t10, C.BlendMode_3, t1, t11, t8, t6, _this._image$_filterQuality, t9, t13, t5, t14, false, 1, new B.Rect(t3, t4, t3 + t2._dx, t4 + t2._dy), t12, t7);
    },
    dispose$0() {
      var t1 = this._image$_image;
      if (t1 != null)
        t1.dispose$0();
      this._image$_image = null;
  ...
  A._ImageState.prototype = {
    ...
    build$1(context) {
      ...
      result = new A.RawImage(t3, t4, t6, t7, t1, _null, _null, C.FilterQuality_2, _null, t2, C.Alignment_0_0, C.ImageRepeat_3, _null, false, t8, false, _null);
  ...
  var typesOffset = hunkHelpers.updateTypes(["double(double)", "~(ImageInfo,bool)", "~(ImageChunkEvent)"]);
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = A.RenderImage.prototype, "get$computeMinIntrinsicWidth", "computeMinIntrinsicWidth$1", 0);
    ...
    _instance_2_u(_ = A._ImageState.prototype, "get$_handleImageFrame", "_handleImageFrame$2", 1);
  ...
  (function inheritance() {
    ...
    _inherit(A.RenderImage, B.RenderBox);
  ...
  B._Universe_addRules(init.typeUniverse, JSON.parse('{"NetworkImage":{"ImageProvider":["NetworkImage0"],"ImageProvider.T":"NetworkImage0"},"NetworkImage0":{"ImageProvider":["NetworkImage0"]},"NetworkImageLoadException":{"Exception":[]},"RenderImage":{"RenderBox":[],"RenderObject":[],"DiagnosticableTree":[],"HitTestTarget":[]},"RawImage":{"RenderObjectWidget":[],"Widget":[],"DiagnosticableTree":[]},"Image":{"StatefulWidget":[],"Widget":[],"DiagnosticableTree":[]},"_ImageState":{"State0":["Image"],"WidgetsBindingObserver":[]},"ScrollAwareImageProvider":{"ImageProvider":["1"],"ImageProvider.T":"1"},"SvgNetworkLoader":{"SvgLoader":["Uint8List"],"BytesLoader":[],"SvgLoader.T":"Uint8List"},"ApplicationLogoWidthTextWidget":{"StatelessWidget":[],"Widget":[],"DiagnosticableTree":[]},"ApplicationVersionWidget":{"StatefulWidget":[],"Widget":[],"DiagnosticableTree":[]},"_ApplicationVersionWidgetState":{"State0":["ApplicationVersionWidget"]}}'));
...
})($__dart_deferred_initializers__, "WreJRNvM9gu9gymMQQtM3hlAcYc=");
;