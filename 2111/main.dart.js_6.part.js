...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var A = {
    ...
    buildSVGIconButton(icon, iconColor, iconSize, onTap, onTapDown, padding, tooltip) {
      var _null = null,
        ...
        iconWidget = new B.Padding(t1, B.SvgPicture$asset(icon, C.Alignment_0_0, B.ColorNullableExtension_asFilter(iconColor), C.BoxFit_0, iconSize, _null, iconSize), _null);
  ...
  A.PopupMenuItemWidget.prototype = {
    build$1(context) {
      var _null = null,
        t1 = B._setArrayType([B.SvgPicture$asset(this.icon, C.Alignment_0_0, B.ColorNullableExtension_asFilter(_null), C.BoxFit_0, 20, _null, 20), C.SizedBox_12_null_null_null, B.Expanded$(B.Text$(this.name, _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_oHY11, _null, _null, _null, _null, _null), 1)], type$.JSArray_Widget);
  ...
  A.PopupMenuWidgetMixin.prototype = {
    popupItem$5$colorIcon$onCallbackAction$styleName(iconAction, nameAction, colorIcon, onCallbackAction, styleName) {
      var _null = null,
        t1 = B.SvgPicture$asset(iconAction, C.Alignment_0_0, B.ColorNullableExtension_asFilter(colorIcon), C.BoxFit_0, 20, _null, 20);
    ...
    call$1($event) {
      ...
      if (t2) {
        ...
        if (link != null && _this.$this._framework$_element != null) {
          B.log("_HtmlContentViewerOnWebState::_setUpWeb(): OpenLink: " + B.S(link), C.Level_3);
          B._asString(link);
...
$__dart_deferred_initializers__["UuC6i2j2lNSg33qnpXYZN6TxWu0="] = $__dart_deferred_initializers__.current
