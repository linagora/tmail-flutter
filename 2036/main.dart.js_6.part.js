...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var A = {ButtonBuilder: function ButtonBuilder(t0) {
      ...
      _._icon = t0;
      _._button_builder$_constraints = _._button_builder$_padding = _._button_builder$_maxWidth = _._radiusSplash = _._iconAction = _._button_builder$_decoration = _._button_builder$_textStyle = _._iconColor = _._button_builder$_key = _._isVertical = _._paddingIcon = _._button_builder$_size = _._button_builder$_text = null;
    ...
    UserInformationWidgetBuilder$(_imagePaths, _userProfile, onSubtitleClick, padding, subtitle, titlePadding) {
      return new A.UserInformationWidgetBuilder(_userProfile, subtitle, onSubtitleClick, padding, null);
    },
    UserInformationWidgetBuilder: function UserInformationWidgetBuilder(t0, t1, t2, t3, t4) {
      var _ = this;
      _._userProfile = t0;
      _.subtitle = t1;
  ...
  A.ButtonBuilder.prototype = {
    ...
    _buildBody$0() {
      ...
      if (_this._button_builder$_text != null) {
        ...
        if (t1) {
          t1 = B._setArrayType([_this._buildIcon$0(), _this._buildText$0()], t2);
          t2 = _this._iconAction;
          if (t2 != null)
            t1.push(t2);
          t1 = B.Column$(t1, C.CrossAxisAlignment_2, C.MainAxisAlignment_2, C.MainAxisSize_0, C.VerticalDirection_1);
        } else {
          t1 = B._setArrayType([_this._buildIcon$0(), _this._buildText$0()], t2);
          t2 = _this._iconAction;
          if (t2 != null)
        ...
        return _this._buildIcon$0();
    },
    _buildIcon$0() {
      var t2, t3, t4, t5, _this = this,
        t1 = _this._paddingIcon;
      if (t1 == null)
        t1 = D.EdgeInsets_10_10_10_10;
      t2 = _this._icon;
      if (t2 == null)
        t2 = "";
      ...
      if (t4)
        t3 = 24;
      return new B.Padding(t1, B.SvgPicture$asset(t2, B.ColorNullableExtension_asFilter(_this._iconColor), C.BoxFit_0, t3, null, t5), null);
    },
    _buildText$0() {
      var t2, _null = null,
      ...
      return B.Text$(t1, _null, _null, 1, C.TextOverflow_1, _null, _null, false, _null, t2 == null ? D.TextStyle_kmC1 : t2, _null, _null, _null, _null, _null);
    }
  };
  ...
  A._HtmlContentViewerOnWebState.prototype = {
    ...
    _setUpWeb$0() {
      ...
      t2 = document.createElement("iframe");
      t2.toString;
      t1 = _this.___HtmlContentViewerOnWebState_actualWidth_A;
      t1 === $ && B.throwUnnamedLateFieldNI();
      t2.width = C.JSNumber_methods.toString$0(t1);
      t1 = _this.___HtmlContentViewerOnWebState_actualHeight_A;
      t1 === $ && B.throwUnnamedLateFieldNI();
      t2.height = C.JSNumber_methods.toString$0(t1);
      t1 = _this._htmlData;
      t2.srcdoc = t1 == null ? "" : t1;
      t1 = t2.style;
      t1.border = "none";
      t1 = t2.style;
      t1.overflow = "hidden";
      ...
      t1 = t2.style;
      t1.height = "100%";
      B._EventStreamSubscription$(t2, "load", new A._HtmlContentViewerOnWebState__setUpWeb_closure(_this), false, type$._ElementEventStreamImpl_Event._precomputed1);
      $.$get$platformViewRegistry();
      t1 = _this.___HtmlContentViewerOnWebState_createdViewId_A;
      $.$get$platformViewManager().registerFactory$3$isVisible(t1, new A._HtmlContentViewerOnWebState__setUpWeb_closure0(t2), true);
  ...
  A.PopupMenuItemWidget.prototype = {
    build$1(context) {
      var _null = null,
        t1 = B._setArrayType([B.SvgPicture$asset(this.icon, B.ColorNullableExtension_asFilter(_null), C.BoxFit_0, 20, _null, 20), C.SizedBox_12_null_null_null, B.Expanded$(B.Text$(this.name, _null, _null, _null, _null, _null, _null, _null, _null, D.TextStyle_oHY12, _null, _null, _null, _null, _null), 1)], type$.JSArray_Widget);
  ...
  A.AnimatedSwitcher.prototype = {
    createState$0() {
      return new A._AnimatedSwitcherState(B.LinkedHashSet_LinkedHashSet$_empty(type$._ChildEntry), C.List_empty20, null, null, C._StateLifecycle_0);
    },
  ...
  A.UserInformationWidgetBuilder.prototype = {
    build$1(context) {
      ...
      t3 = B._setArrayType([B.TextOverflowBuilder$(t3, D.TextStyle_oHY2), C.SizedBox_null_10_null_null], t4);
      if (_this.subtitle != null) {
        t5 = B.Matrix4_Matrix4$translationValues(-8, 0, 0);
        B.Localizations_of(context, C.Type_AppLocalizations_swi, type$.AppLocalizations).toString;
        t3.push(B.Transform$(_null, A.MaterialTextButton$(20, E.TextStyle_kmC, B.Intl__message("Manage account", _null, "manage_account", _null, _null), _null, 15, _null, _null, _this.onSubtitleClick, _null, D.EdgeInsetsDirectional_8_8_8_8, _null), t5, true));
      }
      ...
      return new B.Padding(t1, B.Row$(t2, C.CrossAxisAlignment_2, C.MainAxisAlignment_0, C.MainAxisSize_1, _null), _null);
    }
  };
  A.UserSettingPopupMenuMixin.prototype = {
    ...
    _userInformation$2(context, userProfile) {
      var _null = null;
      if (userProfile != null)
        return new B.SizedBox(300, _null, A.ListTile$(C.EdgeInsets_20_0_20_0, _null, _null, _null, _null, _null, B.Text$(userProfile.email, _null, _null, 1, _null, _null, _null, _null, _null, D.TextStyle_chs3, _null, _null, _null, _null, _null), _null), _null);
  ...
  A.ButtonBuilder_build_closure.prototype = {
    call$1(detail) {
      var t2, screenSize, offset, t3,
        t1 = this.$this;
      if (t1._onPressActionWithPositionClick != null && t1._button_builder$_context != null) {
        t2 = t1._button_builder$_context;
        t2.toString;
        screenSize = B.InheritedModel_inheritFrom(t2, null, type$.MediaQuery).data.size;
  ...
  (function inheritance() {
    ...
    _inheritMany(B.StatelessWidget, [A.PopupMenuItemWidget, A.Chip, A.Drawer, A.ListTile, A.MaterialTextButton, A.UserInformationWidgetBuilder, A.VacationNotificationMessageWidget]);
  ...
  (function constants() {
    ...
    D.TextStyle_chs3 = new B.TextStyle(true, C.Color_4286680217, null, null, null, null, 15, C.FontWeight_3_400, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    D.TextStyle_kmC1 = new B.TextStyle(true, C.Color_4278221567, null, null, null, null, 12, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
$__dart_deferred_initializers__["ei1o3WpwE3zK1EHwiSMIHk7X0R8="] = $__dart_deferred_initializers__.current
