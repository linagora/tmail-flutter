...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ContactView.prototype = {
    build$1(context) {
      ...
      t11 = A.SvgPicture$asset("assets/images/ic_clear_text_search.svg", _null, B.BoxFit_0, 18, _null, 18);
  ...
  C.AppBarContactWidget.prototype = {
    build$1(context) {
      var _null = null,
        t1 = A.SvgPicture$asset("assets/images/ic_close_composer.svg", A.ColorNullableExtension_asFilter(B.Color_4286680217), B.BoxFit_0, 24, _null, 24),
  ...
  C.ContactView_build__closure.prototype = {
    call$2(context, index) {
      ...
      return new G.ContactSuggestionBoxItem(t1._toSuggestionEmailAddress$2(emailAddress, t2), new C.ContactView_build___closure(t1, context), E.EdgeInsets_16_10_16_10, null, null);
    },
...
$__dart_deferred_initializers__["ZhBh0t3Y7YDLlKU/ZOrpZlg0Xio="] = $__dart_deferred_initializers__.current
