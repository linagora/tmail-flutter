...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C.ContactSuggestionBoxItem.prototype = {
    build$1(context) {
      ...
      t2 = B._setArrayType([new F.GradientCircleAvatarIcon(t3, 40, 24, t4, _null), A.SizedBox_12_null_null_null, B.Expanded$(B.Column$(t6, A.CrossAxisAlignment_0, A.MainAxisAlignment_0, A.MainAxisSize_0, A.VerticalDirection_1), 1)], t5);
      t1 = t1.state;
      if (t1 === D.SuggestionEmailState_1)
        t2.push(new B.Padding(E.EdgeInsets_12_0_0_0, B.SvgPicture$asset("assets/images/ic_filter_selected.svg", A.Alignment_0_0, _null, A.BoxFit_0, 24, _null, 24), _null));
  ...
  (function constants() {
    G.EdgeInsets_16_10_16_10 = new B.EdgeInsets(16, 10, 16, 10);
  })();
};

$__dart_deferred_initializers__["FZP+yZoAUL8gt0KN7T3dNbTO810="] = $__dart_deferred_initializers__.current
