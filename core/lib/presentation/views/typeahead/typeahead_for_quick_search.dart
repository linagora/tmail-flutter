...
class TypeAheadFormFieldQuickSearch<T, R> extends FormField<String> {
  /// The configuration of the [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
  /// that the TypeAhead widget displays
  final QuickSearchTextFieldConfiguration textFieldConfiguration;

  /// Creates a [TypeAheadFormFieldQuickSearch]
  TypeAheadFormFieldQuickSearch(
      {Key? key,
      String? initialValue,
...
class _TypeAheadFormFieldState<T, R> extends FormFieldState<String> {
  ...
  @override
  TypeAheadFormFieldQuickSearch get widget => super.widget as TypeAheadFormFieldQuickSearch<dynamic, dynamic>;
  ...
  @override
  void didUpdateWidget(TypeAheadFormFieldQuickSearch oldWidget) {
...
/// See also:
///
/// * [TypeAheadFormFieldQuickSearch], a [FormField](https://docs.flutter.io/flutter/widgets/FormField-class.html)
/// implementation of [TypeAheadFieldQuickSearch] that allows the value to be saved,
/// validated, etc.
