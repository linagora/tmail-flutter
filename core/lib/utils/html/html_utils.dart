...
class HtmlUtils {
  ...
  static String buildFileLinkCard({
    ...
    return '<a href="$href" target="_blank" rel="noopener noreferrer" contenteditable="false" tabindex="-1" style="display:inline-block;vertical-align:top;width:${cardWidthPx}px;'
        ...
        'text-overflow:ellipsis;">$actionLabel ↗</div>'
        '</div>'
        '</a>';
  }
  ...
  static String buildFileCardIconZone({
    ...
    final content = '<img src="${imageUrl ?? ''}" width="$iconSizePx" height="$iconSizePx" '
