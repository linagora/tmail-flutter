...
class HtmlUtils {
  ...
  static String buildFileLinkCard({
    ...
    return '<a href="$href" style="display:inline-block;vertical-align:top;width:${cardWidthPx}px;'
  ...
  static String buildFileCardIconZone({
    ...
    final content = iconBase64Png != null
        ? '<img src="data:image/png;base64,$iconBase64Png" width="$iconSizePx" height="$iconSizePx" '
