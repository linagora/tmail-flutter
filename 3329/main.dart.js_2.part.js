...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A = {ImageLoaderMixin: function ImageLoaderMixin() {
    }, ImageLoaderMixin_buildImage_closure: function ImageLoaderMixin_buildImage_closure(t0) {
      this.imageSize = t0;
    },
    _httpClient() {
  ...
  A.ImageLoaderMixin.prototype = {
    buildImage$2$imagePath$imageSize(imagePath, imageSize) {
      var _null = null;
      if (C.JSString_methods.startsWith$1(imagePath, "http") || C.JSString_methods.startsWith$1(imagePath, "https"))
        return new B.Image(B.ResizeImage_resizeIfNeeded(_null, _null, new A.NetworkImage(imagePath, 1, _null)), new A.ImageLoaderMixin_buildImage_closure(imageSize), imageSize, imageSize, C.BoxFit_0, _null);
        ...
        return B.Image$asset(imagePath, C.BoxFit_0, imageSize, _null, imageSize);
    }
  };
  A.NetworkImage.prototype = {
    ...
    loadBuffer$2(key, decode) {
      ...
      return B.MultiFrameImageStreamCompleter$(new B._ControllerStream(chunkEvents, B._instanceType(chunkEvents)._eval$1("_ControllerStream<1>")), this._loadAsync$3(key, decode, chunkEvents), key.url, _null, key.scale);
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = self.window.flutterCanvasKit;
            ...
            case 3:
              ...
              request.addEventListener("load", t1._as(B.allowInterop(new A.NetworkImage__loadAsync_closure(request, completer, resolved))));
              request.addEventListener("error", t1._as(B.allowInterop(new A.NetworkImage__loadAsync_closure0(completer))));
              request.send();
              $async$goto = 6;
              return B._asyncAwait(t2, $async$_loadAsync$3);
            case 6:
              // returning from await.
              t2 = request.response;
              t2.toString;
              bytes = B.NativeUint8List_NativeUint8List$view(type$.NativeByteBuffer._as(t2), 0, null);
              if (bytes.byteLength === 0)
                throw B.wrapException(A.NetworkImageLoadException$(B.getProperty(request, "status"), resolved));
              $async$temp1 = decode;
              $async$goto = 7;
              return B._asyncAwait(B.ImmutableBuffer_fromUint8List(bytes), $async$_loadAsync$3);
            case 7:
              // returning from await.
  ...
  A.ImageLoaderMixin_buildImage_closure.prototype = {
    call$3(_, __, ___) {
      var _null = null,
        t1 = this.imageSize;
      return B.Container$(_null, _null, C.Clip_0, C.Color_4285887861, _null, _null, _null, t1, _null, _null, _null, _null, _null, t1);
    },
    $signature: 1764
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(B.Closure, [A.ImageLoaderMixin_buildImage_closure, A.NetworkImage__loadAsync_closure, A.NetworkImage__loadAsync_closure0]);
  ...
  B._Universe_addRules(init.typeUniverse, JSON.parse('{"NetworkImage":{"ImageProvider":["NetworkImage0"],"ImageProvider.T":"NetworkImage0"},"NetworkImage0":{"ImageProvider":["NetworkImage0"]},"NetworkImageLoadException":{"Exception":[]},"ApplicationLogoWidthTextWidget":{"StatelessWidget":[],"Widget":[],"DiagnosticableTree":[]},"ApplicationVersionWidget":{"StatefulWidget":[],"Widget":[],"DiagnosticableTree":[]},"_ApplicationVersionWidgetState":{"State0":["ApplicationVersionWidget"]}}'));
...
})($__dart_deferred_initializers__, "bUJkRBHHV9xA191n0BsZH58nAy4=");
;