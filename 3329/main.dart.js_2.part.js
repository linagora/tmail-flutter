...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return B._asyncAwait(B.HttpRequest_request0(url, null, null, null, headers, null, null, null), $async$httpGet);
            case 3:
  ...
  A._ImageState.prototype = {
    ...
    build$1(context) {
      ...
      result = B.RawImage$(C.Alignment_0_0, _null, _null, _null, t4, C.FilterQuality_1, t2, t7, t3, t8, false, false, _null, C.ImageRepeat_3, t1, t6);
      result = new B.Semantics(B.SemanticsProperties$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, true, _null, _null, _null, "", _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), false, false, false, false, result, _null);
...
})($__dart_deferred_initializers__, "pLueOYqQ5YXhUWjF5jK+xXv3Fbs=");
;