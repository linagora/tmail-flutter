...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  C = {
    ...
    _MailBoxVisibilityFolderTileBuilderState: function _MailBoxVisibilityFolderTileBuilderState(t0, t1, t2) {
      var _ = this;
      _._mailbox_visibility_folder_tile_builder$_imagePaths = t0;
      _._mailbox_visibility_folder_tile_builder$_responsiveUtils = t1;
      _._mailbox_visibility_folder_tile_builder$_key = t2;
      _._framework$_element = _._widget = null;
    },
  ...
  C.MaterialTextIconButton.prototype = {
    build$1(context) {
      ...
      return F.ElevatedButton_ElevatedButton$icon(t1, t3, _this.onTap, A.ElevatedButton_styleFrom(_null, _null, _this.backgroundColor, _null, _null, _null, 0, _null, _null, t2, _null, _this.minimumSize, _null, _null, new A.RoundedRectangleBorder(A.BorderRadius$circular(12), B.BorderSide_KY7), _null, _null, _null, _null));
    }
  };
  ...
  C.MailboxVisibilityView.prototype = {
    ...
    _mailbox_visibility_view$_buildListMailbox$1(context) {
      ...
      if (A.InheritedModel_inheritFrom(context, B._MediaQueryAspect_0, type$.MediaQuery).data.size.get$shortestSide() < 600)
        bodyListMailbox = new A.Padding(B.EdgeInsets_12_0_12_0, bodyListMailbox, _null);
      A.Expando__checkType(_this);
      return A.SingleChildScrollView$(bodyListMailbox, t2._as(t1.get(_this)).mailboxListScrollController, E.PageStorageKey_mailbox_list, _null, B.ClampingScrollPhysics_null, _null, B.Axis_1);
    },
  ...
  C.MailboxSubscribeButton.prototype = {
    build$1(context) {
      ...
      t3 = B.TextStyle_gw1.copyWith$4$color$fontSize$height$letterSpacing(B.Color_0ND, 12, 1.5, 0);
  ...
  C.MailBoxVisibilityFolderTileBuilder.prototype = {
    createState$0() {
      ...
      if (t2 == null)
        t2 = $.GetInstance__getInstance = B.C_GetInstance;
      return new C._MailBoxVisibilityFolderTileBuilderState(t1, t2.find$1$1$tag(0, null, type$.ResponsiveUtils), new A.LabeledGlobalKey(null, type$.LabeledGlobalKey_State_StatefulWidget));
    }
  };
  C._MailBoxVisibilityFolderTileBuilderState.prototype = {
    build$1(context) {
      var t5, t6, t7, t8, t9, bodyWidget, _this = this, _null = null,
        _s8_ = "Personal",
        ...
        t2 = isScreenWithShortestSide ? 1 / 0 : 315,
        t3 = _this._widget.mailboxNode.item,
        t4 = t3.namespace;
      t3 = !(t4 == null || t4.$eq(0, new A.Namespace(_s8_))) && !A.PresentationMailboxExtension_hasParentId(t3) ? 52 : 40;
      t4 = type$.JSArray_Widget;
      t5 = A._setArrayType([], t4);
      t6 = _this._widget.mailboxNode.item.namespace;
      if (t6 == null || t6.$eq(0, new A.Namespace(_s8_)) || A.PresentationMailboxExtension_hasParentId(_this._widget.mailboxNode.item)) {
        t6 = A.PresentationMailboxExtension_getMailboxIcon(_this._widget.mailboxNode.item, _this._mailbox_visibility_folder_tile_builder$_imagePaths);
        if (!A.PresentationMailboxExtension_get_isSubscribedMailbox(_this._widget.mailboxNode.item)) {
          t7 = _this._widget.mailboxNode.item.role;
          t7 = t7 != null && t7.value.length !== 0;
        } else
          t7 = true;
        t5.push(new A.MailboxIconWidget(t6, B.EdgeInsetsDirectional_0_0_8_0, t7 ? B.Color_4F4 : B.Color_wsa, _null));
      }
      t6 = _this._widget;
      t7 = _this._mailbox_visibility_folder_tile_builder$_imagePaths;
      t5.push(A.Expanded$(new C.LabelMailboxVisibilityItemWidget(t1, t7, t6.mailboxNode, t6.onClickExpandMailboxNodeAction, _null), 1));
      t6 = _this._widget;
      t8 = t6.mailboxNode;
      t9 = t8.item.role;
      if (!(t9 != null && t9.value.length !== 0))
        t5.push(new C.MailboxSubscribeButton(t7, t8, t6.onClickSubscribeMailboxAction, _null));
      bodyWidget = A.Material$(B.Duration_200000, true, _null, A.InkWell$(false, B.BorderRadius_ww82, true, A.Container$(_null, A.Row$(t5, B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null), B.Clip_0, _null, _null, _null, _null, t3, _null, _null, B.EdgeInsets_12_0_12_0, _null, _null, t2), _null, true, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new C._MailBoxVisibilityFolderTileBuilderState_build_closure(), _null, _null, _null, _null, _null, _null, _null), B.Clip_0, _null, 0, t1, _null, _null, _null, _null, B.MaterialType_4);
      if (isScreenWithShortestSide)
        return bodyWidget;
      else
        return A.Row$(A._setArrayType([new A.Flexible(1, B.FlexFit_1, bodyWidget, _null), B.Spacer_null], t4), B.CrossAxisAlignment_2, _null, B.MainAxisAlignment_0, B.MainAxisSize_1, _null);
    }
  };
...
})($__dart_deferred_initializers__, "5gDzEQUO1YQZEvaG5GAOF2bKUU4=");
;