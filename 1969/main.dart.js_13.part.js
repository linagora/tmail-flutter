...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var C = {
    MailboxCreatorView$() {
      ...
      t3 = t3.find$1$1$tag(0, _null, type$.MailboxCreatorController);
      t3.$arguments = $.$get$GetNavigation__getxController().routing.args;
      return new A.MailboxCreatorView(t1, t2, t3, _null);
    }
  },
  A, B;
  ...
  var type$ = {
    ...
    MailboxCreatorController: A.findType("MailboxCreatorController"),
    ResponsiveUtils: A.findType("ResponsiveUtils0")
  };
};

$__dart_deferred_initializers__["Uip9MesdHd2J2Y1wjwxorHzX91s="] = $__dart_deferred_initializers__.current
