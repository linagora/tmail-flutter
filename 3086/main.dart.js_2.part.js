  ...
  A.ImageLoaderMixin.prototype = {
    buildImage$2$imagePath$imageSize(imagePath, imageSize) {
      ...
      if (this.isImageNetworkLink$1(imagePath) && C.JSString_methods.endsWith$1(imagePath, "svg"))
        return new B.SvgPicture(imageSize, imageSize, C.BoxFit_0, C.Alignment_0_0, new A.SvgNetworkLoader(imagePath, _null, _null, _null), new A.ImageLoaderMixin_buildImage_closure(), false, _null, _null);
        ...
        return B.SvgPicture$asset(imagePath, C.Alignment_0_0, _null, false, C.BoxFit_1, imageSize, _null, _null, imageSize);
      else
...
})($__dart_deferred_initializers__, "Xr/TAMzI/uOopoveT1/v3ecYYHE=");
;